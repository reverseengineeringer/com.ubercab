...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcba;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcba;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcba;->c:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lcba;->a:Ljava/util/Map;
    ...
    const-string/jumbo v2, "Allow them to link and manage their loyalty card in your PayPal wallet."
    ...
    const-string/jumbo v2, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes."
    ...
    const-string/jumbo v2, "Sending SMS"
    ...
    const-string/jumbo v2, "Send SMS Again"
    ...
    sget-object v0, Lcba;->b:Ljava/util/Map;
    ...
    const-string/jumbo v2, "Pre-approve future payments made from your PayPal account without logging in to PayPal each time. <a href=\'%1$s\'>See additional terms</a>, including payment methods and how to cancel future payments."
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Agreement</strong></h1><p>To make sure your PayPal account can be charged in future, this app may simulate a small test transaction but no money will be transferred.</p><p>Your default payment method (your PayPal balance, linked bank account, credit or debit card, in that order) will be used to pay for PayPal purchases. Please note, if your default payment method doesn\u2019t have enough funds to cover the purchase, your bank or card provider may charge you a fee.</p><p>To cancel this agreement, log in to your PayPal account and go to <strong>Profile</strong> then click <strong>My settings</strong> and <strong>Change</strong> beside \u201cLog in with PayPal.\u201d</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment authorisation</strong></h1><p>To make sure your PayPal account can be charged in the future, this app may simulate a small test transaction but no payment will be transferred.</p><p>Your default payment method will be used to pay for PayPal purchases.</p><p>To cancel this authorisation, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My account settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>Please see the \u201cPre-approved Payments\u201d section of the <a href=\'%s\'>PayPal User Agreement</a> for more information.</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Agreement</strong></h1><p>PayPal will first use your PayPal balance to pay for your purchase. If that doesn\u2019t cover your total, your bank account, PayPal Credit, debit card, credit card, and/or eCheque will be used in that order.</p><p>To cancel this agreement, go to www.paypal.com.au <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>A small payment authorisation may be required to make sure your PayPal account can be charged in the future. The authorisation will be voided and you won\u2019t be charged.</p>"
    ...
    sget-object v0, Lcba;->c:Ljava/util/Map;

    const-string/jumbo v1, "AMOUNT_MISMATCH"

    const-string/jumbo v2, "Cart item amount total does not match sale amount."
    ...
    const-string/jumbo v2, "Transaction denied because of an invalid argument"
    ...
    const-string/jumbo v2, "Invalid suburb/state/postcode combination."
    ...
    const-string/jumbo v2, "The transaction was denied."
    ...
    const-string/jumbo v2, "The shipping address provided is not valid."
    ...
    const-string/jumbo v2, "There was a problem setting up this payment - account needs a valid payment method, such as a bank account or payment card. Please visit the PayPal website to check your account."
...
.method public final synthetic a(Ljava/lang/Enum;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lcba;->b:Ljava/util/Map;
