...
.method static constructor <clinit>()V
    ...
    sput-object v0, Laff;->e:[Ljava/lang/String;
...
.method public constructor <init>(Laey;)V
    ...
    iput-object v0, p0, Laff;->a:Ljava/lang/String;
    ...
    iput-object v0, p0, Laff;->d:[Ljava/lang/String;

    iput-object p1, p0, Laff;->f:Laey;
...
.method private a(Landroid/net/Uri;Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    ...
    :try_start_0
    invoke-direct {p0, p1}, Laff;->c(Landroid/net/Uri;)Z
    ...
    invoke-direct {v0, v1}, Lafg;-><init>(Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v1, p0, Laff;->f:Laey;

    invoke-interface {v1, p2, p3}, Laey;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p1, v0, v1}, Laff;->b(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p1, v0, v1}, Laff;->a(Landroid/net/Uri;Ljava/lang/String;Ljava/lang/String;)Landroid/net/Uri;
    :try_end_1
...
.method public final a(Landroid/net/Uri;Landroid/content/Context;)Landroid/net/Uri;
    ...
    invoke-direct {p0, p1, p2, v0}, Laff;->a(Landroid/net/Uri;Landroid/content/Context;Ljava/lang/String;)Landroid/net/Uri;
    :try_end_0
    .catch Ljava/lang/UnsupportedOperationException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final a(Landroid/net/Uri;)Z
    ...
    iget-object v3, p0, Laff;->d:[Ljava/lang/String;
...
.method public final b(Landroid/net/Uri;)Z
    ...
    invoke-virtual {p0, p1}, Laff;->a(Landroid/net/Uri;)Z

    move-result v1

    if-eqz v1, :cond_0

    sget-object v2, Laff;->e:[Ljava/lang/String;
