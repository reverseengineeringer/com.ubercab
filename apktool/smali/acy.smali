...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lacy;->c:Z

    sput-boolean v1, Lacy;->d:Z
    ...
    sput-object v0, Lacy;->a:Ljava/lang/Object;

    sput-object v2, Lacy;->g:Ljava/lang/String;

    sput-object v2, Lacy;->h:Ljava/lang/Integer;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lacy;->f:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lacy;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lacy;->i:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_1
    sget-object v1, Lacy;->a:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lacy;->g:Ljava/lang/String;
    ...
    sput-object v0, Lacy;->g:Ljava/lang/String;
    :try_end_0
    ...
    sput-object v0, Lacy;->h:Ljava/lang/Integer;
    :try_end_1
    ...
    :goto_0
    :try_start_2
    sget-object v0, Lacy;->h:Ljava/lang/Integer;
    ...
    sget-object v3, Lacy;->g:Ljava/lang/String;
...
.method private static a()Z
    ...
    sget-boolean v0, Lacy;->c:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Lacy;->d:Z
...
.method public static a(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1, v1}, Lacy;->a(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {v1, v0}, Lacz;->a(Landroid/content/pm/PackageManager;Landroid/content/pm/PackageInfo;)Z
...
.method static a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    :cond_1
    invoke-static {p0}, Lacy;->b(Landroid/content/Context;)Z
...
.method public static a(Landroid/content/pm/PackageManager;)Z
    ...
    invoke-static {p0}, Lacy;->b(Landroid/content/pm/PackageManager;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lacy;->a()Z
...
.method public static b(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lacy;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method private static b(Landroid/content/pm/PackageManager;)Z
    ...
    sget-object v2, Lacy;->a:Ljava/lang/Object;
    ...
    new-array v4, v4, [Lacu;

    const/4 v5, 0x0

    sget-object v6, Lacx;->a:[Lacu;
    ...
    invoke-static {v3, v4}, Lacz;->a(Landroid/content/pm/PackageInfo;[Lacu;)Lacu;
...
.method public static c(Landroid/content/Context;)I
    ...
    sget v5, Llw;->common_google_play_services_unknown_issue:I
    ...
    invoke-static {p0}, Lacy;->a(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Laum;->a(Landroid/content/Context;)Z

    move-result v5

    if-eqz v5, :cond_2

    sget-object v5, Lacx;->a:[Lacu;

    invoke-static {v4, v5}, Lacz;->a(Landroid/content/pm/PackageInfo;[Lacu;)Lacu;
    ...
    invoke-static {v5, v6}, Lacz;->a(Landroid/content/pm/PackageInfo;[Lacu;)Lacu;
    ...
    :try_start_3
    new-array v6, v6, [Lacu;

    const/4 v7, 0x0

    aput-object v5, v6, v7

    invoke-static {v4, v6}, Lacz;->a(Landroid/content/pm/PackageInfo;[Lacu;)Lacu;
    ...
    invoke-static {v0}, Lauo;->a(I)I

    move-result v0

    iget v5, v4, Landroid/content/pm/PackageInfo;->versionCode:I

    invoke-static {v5}, Lauo;->a(I)I
...
.method public static c(I)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v1, p0, v1}, Lacs;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static d(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p0}, Lacs;->a(Landroid/content/Context;)I
    ...
    invoke-virtual {v1, p0, v0, v2}, Lacs;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0}, Lwb;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lwc;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static e(Landroid/content/Context;)V
    ...
    sget-object v0, Lacy;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
