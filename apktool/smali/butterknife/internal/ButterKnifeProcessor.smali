...
.method private findAndParseListener(Ljavax/annotation/processing/RoundEnvironment;Ljava/lang/Class;Ljava/util/Map;Ljava/util/Set;)V
    ...
    .line 391
    const-string/jumbo v2, "Unable to generate view injector for @%s.\n\n%s"
...
.method private findAndParseTargets(Ljavax/annotation/processing/RoundEnvironment;)Ljava/util/Map;
    ...
    .line 135
    const-string/jumbo v4, "Unable to generate view injector for @InjectView.\n\n%s"
    ...
    .line 147
    const-string/jumbo v4, "Unable to generate view injector for @InjectViews.\n\n%s"
...
.method private isBindingInWrongPackage(Ljava/lang/Class;Ljavax/lang/model/element/Element;)Z
    ...
    .line 206
    const-string/jumbo v3, "@%s-annotated class incorrectly in Android framework package. (%s)"
    ...
    .line 211
    const-string/jumbo v3, "@%s-annotated class incorrectly in Java framework package. (%s)"
...
.method private isInaccessibleViaGeneratedCode(Ljava/lang/Class;Ljava/lang/String;Ljavax/lang/model/element/Element;)Z
    ...
    .line 175
    :cond_0
    const-string/jumbo v1, "@%s %s must not be private or static. (%s.%s)"
    ...
    .line 183
    const-string/jumbo v1, "@%s %s may only be contained in classes. (%s.%s)"
    ...
    .line 191
    const-string/jumbo v1, "@%s %s may not be contained in private classes. (%s.%s)"
...
.method private parseInjectView(Ljavax/lang/model/element/Element;Ljava/util/Map;Ljava/util/Set;)V
    ...
    .line 231
    const-string/jumbo v1, "@InjectView fields must extend from View or be an interface. (%s.%s)"
    ...
    .line 242
    const-string/jumbo v1, "Only one of @InjectView and @InjectViews is allowed. (%s.%s)"
    ...
    .line 261
    const-string/jumbo v2, "Attempt to use @InjectView for an already injected ID %d on \'%s\'. (%s.%s)"
...
.method private parseInjectViews(Ljavax/lang/model/element/Element;Ljava/util/Map;Ljava/util/Set;)V
    ...
    .line 319
    const-string/jumbo v1, "@InjectViews type must extend from View or be an interface. (%s.%s)"
    ...
    .line 300
    const-string/jumbo v1, "@InjectViews List must have a generic component. (%s.%s)"
    ...
    .line 308
    :cond_3
    const-string/jumbo v1, "@InjectViews must be a List or array. (%s.%s)"
    ...
    .line 336
    const-string/jumbo v1, "@InjectViews must specify at least one ID. (%s.%s)"
    ...
    .line 343
    const-string/jumbo v8, "@InjectViews annotation contains duplicate ID %d. (%s.%s)"
...
.method private parseListenerAnnotation(Ljava/lang/Class;Ljavax/lang/model/element/Element;Ljava/util/Map;Ljava/util/Set;)V
    ...
    const-string/jumbo v4, "@%s annotation must be on a method."
    ...
    const-string/jumbo v4, "@%s annotation value() type not int[]."
    ...
    .line 427
    const-string/jumbo v6, "@%s annotation for method contains duplicate ID %d. (%s.%s)"
    ...
    const-string/jumbo v4, "No @%s defined on @%s."
    ...
    .line 444
    const-string/jumbo v7, "ID free injection must not be annotated with @Optional. (%s.%s)"
    ...
    .line 453
    const-string/jumbo v7, "@%s annotation without an ID may only be used with an object of type \"%s\" or an interface. (%s.%s)"
    ...
    .line 460
    :cond_6
    const-string/jumbo v10, "@%s annotation contains invalid ID %d. (%s.%s)"
    ...
    const-string/jumbo v4, "Multiple listener methods specified on @%s."
    ...
    const-string/jumbo v4, "Both method() and callback() defined on @%s."
    ...
    const-string/jumbo v4, "No @%s defined on @%s\'s %s.%s."
    ...
    .line 545
    const-string/jumbo v5, "Unable to match @"
    ...
    const-string/jumbo v7, " method arguments. ("
    ...
    .line 560
    const-string/jumbo v4, "did not match any listener parameters"
    ...
    .line 562
    :cond_14
    const-string/jumbo v4, "matched listener parameter #"
    ...
    const-string/jumbo v5, " parameter(s):\n"
    ...
    .line 586
    const-string/jumbo v3, "Multiple listener methods with return value specified for ID %d. (%s.%s)"
...
.method public final process(Ljava/util/Set;Ljavax/annotation/processing/RoundEnvironment;)Z
    ...
    .line 116
    const-string/jumbo v3, "Unable to write injector for type %s: %s"
