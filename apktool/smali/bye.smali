...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbye;->c:Landroid/view/ViewGroup;

    iget-object v0, p0, Lbye;->c:Landroid/view/ViewGroup;
    ...
    iput-object v0, p0, Lbye;->e:Landroid/widget/RelativeLayout;

    iget-object v0, p0, Lbye;->e:Landroid/widget/RelativeLayout;
    ...
    iget-object v1, p0, Lbye;->e:Landroid/widget/RelativeLayout;

    invoke-virtual {v0, v1}, Landroid/view/ViewGroup;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lbye;->e:Landroid/widget/RelativeLayout;

    invoke-static {v0, v8, v8}, Lbxa;->a(Landroid/view/View;II)V

    new-instance v0, Landroid/widget/LinearLayout;

    invoke-direct {v0, p1}, Landroid/widget/LinearLayout;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lbye;->g:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lbye;->g:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lbye;->g:Landroid/widget/LinearLayout;
    ...
    invoke-static {v0, v5, v5, v1, v5}, Lbxa;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lbye;->f:Landroid/widget/ImageView;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lbye;->f:Landroid/widget/ImageView;

    const-string/jumbo v1, "220dip"

    const-string/jumbo v2, "160dip"

    invoke-static {v0, v1, v2}, Lbxa;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;)V

    iget-object v0, p0, Lbye;->f:Landroid/widget/ImageView;

    const-string/jumbo v1, "30dip"

    invoke-static {v0, v5, v5, v5, v1}, Lbxa;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/ProgressBar;

    invoke-direct {v0, p1}, Landroid/widget/ProgressBar;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lbye;->d:Landroid/widget/ProgressBar;

    iget-object v0, p0, Lbye;->g:Landroid/widget/LinearLayout;

    iget-object v1, p0, Lbye;->d:Landroid/widget/ProgressBar;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lbye;->d:Landroid/widget/ProgressBar;
    ...
    invoke-static {v0, v9, v7}, Lbxa;->a(Landroid/view/View;IF)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lbye;->b:Landroid/widget/TextView;

    iget-object v0, p0, Lbye;->b:Landroid/widget/TextView;

    sget-object v1, Lbwz;->t:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, p0, Lbye;->b:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbye;->a:Landroid/view/ViewGroup;
