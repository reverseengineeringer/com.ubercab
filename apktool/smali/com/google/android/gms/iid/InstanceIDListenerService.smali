...
.method public static a(Landroid/content/Context;Laee;)V
    .locals 3

    invoke-virtual {p1}, Laee;->b()V
...
.method private a(Landroid/content/Intent;)V
    ...
    invoke-static {p0}, Lady;->b(Landroid/content/Context;)Lady;
    ...
    :cond_1
    invoke-static {}, Lady;->c()Laed;

    move-result-object v0

    invoke-virtual {v0, p1}, Laed;->b(Landroid/content/Intent;)V
    ...
    :goto_2
    invoke-virtual {v2, v0}, Laee;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v1}, Laee;->d(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p0}, Ladq;->a(Landroid/content/Context;)Ladq;
    ...
    invoke-virtual {v0, v1, v2, v3}, Ladq;->a(Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_0
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    invoke-direct {p0, p3}, Lcom/google/android/gms/iid/InstanceIDListenerService;->a(I)V

    if-nez p1, :cond_0

    invoke-direct {p0}, Lcom/google/android/gms/iid/InstanceIDListenerService;->a()V
    ...
    :cond_1
    :try_start_1
    invoke-direct {p0, p1}, Lcom/google/android/gms/iid/InstanceIDListenerService;->a(Landroid/content/Intent;)V
    :try_end_1
