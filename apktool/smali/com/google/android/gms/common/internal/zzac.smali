...
.method private a(Landroid/content/res/Resources;IIZ)V
    ...
    sget v0, Llv;->common_plus_signin_btn_icon_dark:I

    sget v1, Llv;->common_plus_signin_btn_icon_light:I

    sget v2, Llv;->common_plus_signin_btn_icon_dark:I

    invoke-static {p3, v0, v1, v2}, Lcom/google/android/gms/common/internal/zzac;->a(IIII)I

    move-result v0

    sget v1, Llv;->common_plus_signin_btn_text_dark:I

    sget v2, Llv;->common_plus_signin_btn_text_light:I

    sget v3, Llv;->common_plus_signin_btn_text_dark:I

    invoke-static {p3, v1, v2, v3}, Lcom/google/android/gms/common/internal/zzac;->a(IIII)I

    move-result v1

    invoke-static {p2, v0, v1}, Lcom/google/android/gms/common/internal/zzac;->a(III)I
    ...
    :cond_0
    sget v0, Llv;->common_google_signin_btn_icon_dark:I

    sget v1, Llv;->common_google_signin_btn_icon_light:I

    sget v2, Llv;->common_google_signin_btn_icon_light:I

    invoke-static {p3, v0, v1, v2}, Lcom/google/android/gms/common/internal/zzac;->a(IIII)I

    move-result v0

    sget v1, Llv;->common_google_signin_btn_text_dark:I

    sget v2, Llv;->common_google_signin_btn_text_light:I

    sget v3, Llv;->common_google_signin_btn_text_light:I
...
.method private static a([Lcom/google/android/gms/common/api/Scope;)Z
    .locals 6
...
.method private b(Landroid/content/res/Resources;IIZ)V
    ...
    sget v0, Llu;->common_plus_signin_btn_text_dark:I

    sget v1, Llu;->common_plus_signin_btn_text_light:I

    sget v2, Llu;->common_plus_signin_btn_text_dark:I
    ...
    :cond_0
    sget v0, Llu;->common_google_signin_btn_text_dark:I

    sget v1, Llu;->common_google_signin_btn_text_light:I

    sget v2, Llu;->common_google_signin_btn_text_light:I
    ...
    :pswitch_0
    sget v0, Llw;->common_signin_button_text:I
    ...
    :pswitch_1
    sget v0, Llw;->common_signin_button_text_long:I
...
.method public final a(Landroid/content/res/Resources;II[Lcom/google/android/gms/common/api/Scope;)V
    ...
    invoke-static {p4}, Lcom/google/android/gms/common/internal/zzac;->a([Lcom/google/android/gms/common/api/Scope;)Z
