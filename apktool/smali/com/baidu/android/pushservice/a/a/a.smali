...
.method public varargs constructor <init>(ILcom/baidu/android/pushservice/a/a/a$a;[Landroid/net/Uri;)V
    ...
    const-string/jumbo v0, "DownLoadThread"
...
.method private a(Landroid/net/Uri;)[B
    ...
    const-string/jumbo v2, "getInputStreamFromUri function\'s uri param is error"
    ...
    :goto_1
    :try_start_1
    invoke-direct {p0, v2}, Lcom/baidu/android/pushservice/a/a/a;->a(Ljava/io/InputStream;)[B
    :try_end_1
    ...
    const-string/jumbo v2, "download inputstream close exception"
    ...
    const-string/jumbo v3, "Uri can\'t open a inputstream"
...
.method private a([Landroid/net/Uri;)[Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v3, "DownLoadThread"

    const-string/jumbo v4, "out of memory err no bitmap found"

    invoke-static {v3, v4}, Lcom/baidu/frontia/base/a/a/a;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "DownLoadThread"
    ...
    invoke-static {v4, v3}, Lcom/baidu/frontia/base/a/a/a;->e(Ljava/lang/String;Ljava/lang/String;)V
