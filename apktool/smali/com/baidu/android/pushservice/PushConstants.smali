...
.field public static final ADVERTISE_ENABLE:Ljava/lang/String; = "1"
...
.field public static final EXTRA_BIND_FOR_ADVERTISE:Ljava/lang/String; = "bind_advertise"

.field public static final EXTRA_BIND_NAME:Ljava/lang/String; = "bind_name"

.field public static final EXTRA_BIND_NOTIFY_STATUS:Ljava/lang/String; = "bind_notify_status"
...
.field public static final EXTRA_PUSH_MESSAGE_BODY:Ljava/lang/String; = "baidu_message_body"

.field public static final EXTRA_PUSH_MESSAGE_MESSAGE_ID:Ljava/lang/String; = "message_id"

.field public static final EXTRA_PUSH_MESSAGE_SECUR_INFO:Ljava/lang/String; = "baidu_message_secur_info"

.field public static final EXTRA_PUSH_MESSAGE_STRING:Ljava/lang/String; = "message_string"

.field public static final EXTRA_PUSH_MESSAGE_TYPE:Ljava/lang/String; = "baidu_message_type"
...
.field public static final KEY_MESSAGE_RECEIVED_IDS:Ljava/lang/String; = "com.baidu.android.pushservice.MESSAGE_IDS_RECEIVED"
...
.field public static final NOTIFY_DISABLE:Ljava/lang/String; = "0"

.field public static final NOTIFY_ENABLE:Ljava/lang/String; = "1"
...
.method public static createSDKMethodIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Lcom/baidu/android/pushservice/util/n;->f(Landroid/content/Context;)Landroid/content/Intent;
...
.method public static createWebMethodIntent(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-static {p0}, Lcom/baidu/android/pushservice/util/n;->e(Landroid/content/Context;)Landroid/content/Intent;
...
.method public static getErrorMsg(I)Ljava/lang/String;
    ...
    :sswitch_4
    const-string/jumbo v0, "Service not available temporary"

    goto :goto_0

    :sswitch_5
    const-string/jumbo v0, "Bind Relation Not Found"
    ...
    :sswitch_8
    const-string/jumbo v0, "Request Params Not Valid"

    goto :goto_0

    :sswitch_9
    const-string/jumbo v0, "Quota Use Up Payment Required"

    goto :goto_0

    :sswitch_a
    const-string/jumbo v0, "Data Required Not Found"

    goto :goto_0

    :sswitch_b
    const-string/jumbo v0, "Request Time Expires Timeout"

    goto :goto_0

    :sswitch_c
    const-string/jumbo v0, "Channel Token Timeout"

    goto :goto_0

    :sswitch_d
    const-string/jumbo v0, "Bind Number Too Many"

    goto :goto_0

    :sswitch_e
    const-string/jumbo v0, "Duplicate Operation"

    goto :goto_0

    :sswitch_f
    const-string/jumbo v0, "Group Not Found"

    goto :goto_0

    :sswitch_10
    const-string/jumbo v0, "Application Forbidden, Need Whitelist Authorization"

    goto :goto_0

    :sswitch_11
    const-string/jumbo v0, "App Need Inied First In Push-console"

    goto :goto_0

    :sswitch_12
    const-string/jumbo v0, "Number Of Tag For User Too Many"

    goto :goto_0

    :sswitch_13
    const-string/jumbo v0, "Number Of Tag For App Too Many"

    goto :goto_0

    :sswitch_14
    const-string/jumbo v0, "Application Do Not Have Unicast Capability"

    goto :goto_0

    :sswitch_15
    const-string/jumbo v0, "Application Do Not Have Multicast Capability"

    goto :goto_0

    :sswitch_16
    const-string/jumbo v0, "Application Is Not Approved, Can Not Use The Push Service"

    goto :goto_0

    :sswitch_17
    const-string/jumbo v0, "Requests Are Too Frequent To Be Temporarily Rejected"

    goto :goto_0

    :sswitch_18
    const-string/jumbo v0, "Get lightapp info fail"

    goto :goto_0

    :sswitch_19
    const-string/jumbo v0, "User blacked this app"
...
.method public static rsaEncrypt(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string/jumbo v2, "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQC/7VlVn9LIrZ71PL2RZMbK/Yxc\r\ndb046w/cXVylxS7ouPY06namZUFVhdbUnNRJzmGUZlzs3jUbvMO3l+4c9cw/n9aQ\r\nrm/brgaRDeZbeSrQYRZv60xzJIimuFFxsRM+ku6/dAyYmXiQXlRbgvFQ0MsVng4j\r\nv+cXhtTis2Kbwb8mQwIDAQAB\r\n"

    const/16 v3, 0x400

    invoke-static {v1, v2, v3}, Lcom/baidu/frontia/base/d/f;->a([BLjava/lang/String;I)[B
    ...
    const-string/jumbo v2, "PushConstants"
    ...
    const-string/jumbo v4, "rsaEncrypt error: "
