...
.method private addCustomContentToIntent(Landroid/content/Intent;)V
    ...
    const-string/jumbo v1, "PublicMsg"

    new-instance v2, Ljava/lang/StringBuilder;

    const-string/jumbo v3, "Custom content to JSONObject exception::"
...
.method private static insertADBehavior(Landroid/content/Context;Lcom/baidu/android/pushservice/c/h;Lcom/baidu/android/pushservice/f/b;Lcom/baidu/android/pushservice/f/m;)V
    .locals 3
    ...
    invoke-static {v0}, Lcom/baidu/android/pushservice/util/n;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p3, v0}, Lcom/baidu/android/pushservice/f/m;->c(Ljava/lang/String;)V

    iget-object v0, p1, Lcom/baidu/android/pushservice/c/h;->e:Ljava/lang/String;

    invoke-virtual {p3, v0}, Lcom/baidu/android/pushservice/f/m;->b(Ljava/lang/String;)V
    ...
    :try_start_0
    invoke-static {p0, p2}, Lcom/baidu/android/pushservice/f/v;->a(Landroid/content/Context;Lcom/baidu/android/pushservice/f/b;)J

    invoke-static {p0, v0}, Lcom/baidu/android/pushservice/f/v;->a(Landroid/content/Context;Lcom/baidu/android/pushservice/f/m;)J
    :try_end_0
    ...
    const-string/jumbo v0, "PublicMsg"

    const-string/jumbo v1, "PM insert db exception"
...
.method private insertADNoClientBehavior(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p6, v0, Lcom/baidu/android/pushservice/f/b;->f:Ljava/lang/String;
    ...
    iput-wide v2, v0, Lcom/baidu/android/pushservice/f/b;->g:J

    invoke-static {p1}, Lcom/baidu/frontia/base/c/b;->d(Landroid/content/Context;)Ljava/lang/String;
    ...
    iput-object p3, v0, Lcom/baidu/android/pushservice/f/b;->j:Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lcom/baidu/android/pushservice/f/v;->a(Landroid/content/Context;Lcom/baidu/android/pushservice/f/b;)J
...
.method private insertADNotiBehavior(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v2, p3}, Lcom/baidu/android/pushservice/f/m;-><init>(Ljava/lang/String;)V

    invoke-static {p1, v1, v0, v2}, Lcom/baidu/android/pushservice/message/PublicMsg;->insertADBehavior(Landroid/content/Context;Lcom/baidu/android/pushservice/c/h;Lcom/baidu/android/pushservice/f/b;Lcom/baidu/android/pushservice/f/m;)V

    const-string/jumbo v0, "pushadvertise:  insert user action"

    invoke-static {v0, p1}, Lcom/baidu/android/pushservice/util/n;->a(Ljava/lang/String;Landroid/content/Context;)V

    const-string/jumbo v0, "PublicMsg"

    const-string/jumbo v1, "pushadvertise:  insert user action"

    invoke-static {v0, v1, p1}, Lcom/baidu/frontia/base/a/a/b;->a(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
...
.method public static insertADSendACKFailed(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)V
    ...
    iput-object p1, v0, Lcom/baidu/android/pushservice/f/b;->f:Ljava/lang/String;

    iput-object p2, v0, Lcom/baidu/android/pushservice/f/b;->j:Ljava/lang/String;
    ...
    iput-object p3, v0, Lcom/baidu/android/pushservice/f/b;->d:Ljava/lang/String;

    iput-object p4, v0, Lcom/baidu/android/pushservice/f/b;->e:Ljava/lang/String;

    iput p6, v0, Lcom/baidu/android/pushservice/f/b;->i:I

    iput-object p7, v0, Lcom/baidu/android/pushservice/f/b;->h:Ljava/lang/String;

    iput-object p5, v0, Lcom/baidu/android/pushservice/f/b;->a:Ljava/lang/String;
    ...
    invoke-static {p0, v1, v0, v2}, Lcom/baidu/android/pushservice/message/PublicMsg;->insertADBehavior(Landroid/content/Context;Lcom/baidu/android/pushservice/c/h;Lcom/baidu/android/pushservice/f/b;Lcom/baidu/android/pushservice/f/m;)V
    ...
    const-string/jumbo v0, "pushadvertise:  insertADSendACKFailed"

    invoke-static {v0, p0}, Lcom/baidu/android/pushservice/util/n;->a(Ljava/lang/String;Landroid/content/Context;)V

    const-string/jumbo v0, "PublicMsg"

    const-string/jumbo v1, "pushadvertise: insertADSendACKFailed"
...
.method public static insertADSetEnableFailed(Landroid/content/Context;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;S)V
    ...
    iput p2, v0, Lcom/baidu/android/pushservice/f/b;->c:I

    iput-object p4, v0, Lcom/baidu/android/pushservice/f/b;->d:Ljava/lang/String;

    iput-object p5, v0, Lcom/baidu/android/pushservice/f/b;->e:Ljava/lang/String;

    iput p6, v0, Lcom/baidu/android/pushservice/f/b;->b:I
    ...
    const-string/jumbo v0, "pushadvertise: insertADSetEnableFailed"

    invoke-static {v0, p0}, Lcom/baidu/android/pushservice/util/n;->a(Ljava/lang/String;Landroid/content/Context;)V

    const-string/jumbo v0, "PublicMsg"

    const-string/jumbo v1, "pushadvertise:  insertADSetEnableFailed"
...
.method private insertBehavior(Landroid/content/Context;Lcom/baidu/android/pushservice/c/h;Lcom/baidu/android/pushservice/f/n;Lcom/baidu/android/pushservice/f/m;)V
    .locals 2
    ...
    invoke-virtual {p4, v0}, Lcom/baidu/android/pushservice/f/m;->d(Ljava/lang/String;)V
    ...
    invoke-virtual {p4, v0}, Lcom/baidu/android/pushservice/f/m;->c(Ljava/lang/String;)V

    iget-object v0, p2, Lcom/baidu/android/pushservice/c/h;->e:Ljava/lang/String;

    invoke-virtual {p4, v0}, Lcom/baidu/android/pushservice/f/m;->b(Ljava/lang/String;)V

    invoke-virtual {p2}, Lcom/baidu/android/pushservice/c/h;->c()Ljava/lang/String;

    move-result-object v0

    invoke-static {p4, p1, v0}, Lcom/baidu/android/pushservice/util/n;->a(Lcom/baidu/android/pushservice/f/m;Landroid/content/Context;Ljava/lang/String;)Lcom/baidu/android/pushservice/f/m;

    move-result-object v0

    :try_start_0
    invoke-static {p1, p3}, Lcom/baidu/android/pushservice/f/v;->a(Landroid/content/Context;Lcom/baidu/android/pushservice/f/n;)J

    invoke-static {p1, v0}, Lcom/baidu/android/pushservice/f/v;->a(Landroid/content/Context;Lcom/baidu/android/pushservice/f/m;)J
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private insertNotiBehavior(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p4, v0, Lcom/baidu/android/pushservice/f/n;->f:Ljava/lang/String;
    ...
    iput-object p3, v0, Lcom/baidu/android/pushservice/f/n;->j:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v1, v0, v2}, Lcom/baidu/android/pushservice/message/PublicMsg;->insertBehavior(Landroid/content/Context;Lcom/baidu/android/pushservice/c/h;Lcom/baidu/android/pushservice/f/n;Lcom/baidu/android/pushservice/f/m;)V
...
.method public handle(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "com.baidu.pushservice.action.publicmsg.DELETE_V2"
    ...
    const-string/jumbo v2, "Public msg deleted by user, title = "
    ...
    const-string/jumbo v1, "Public msg deleted by user"
    ...
    const-string/jumbo v5, "Intent broadcasted to app! ===> "
    ...
    invoke-static {v2, v4}, Lcom/baidu/frontia/base/a/a/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v5, "Intent sent to actvity! ===> "
    ...
    invoke-static {v2, v0, p1}, Lcom/baidu/frontia/base/a/a/b;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "No app component can deal, so start "
    ...
    const-string/jumbo v3, " launcher activity!"
    ...
    const-string/jumbo v4, "Version code is too low! ===> app ver: "
    ...
    const-string/jumbo v3, ", request ver:"
    ...
    const-string/jumbo v4, "parse customize action error\r\n"
    ...
    const-string/jumbo v4, ">>> Url cann\'t be deal! \r\n"
    ...
    invoke-static {v2, v1, p1}, Lcom/baidu/frontia/base/a/a/b;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
...
.method public handleADNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "=== Handle AD notification: "
    ...
    const-string/jumbo v0, "com.baidu.android.pushservice.action.adnotification.ADDELETE"
    ...
    const-string/jumbo v2, "AD notification deleted by user, title = "
    ...
    const-string/jumbo v0, "pushadvertise:  save delete action"

    invoke-static {v0, p1}, Lcom/baidu/android/pushservice/util/n;->a(Ljava/lang/String;Landroid/content/Context;)V

    const-string/jumbo v6, "010502"
    ...
    const-string/jumbo v2, "AD notification open failed by user, title = "
    ...
    const-string/jumbo v0, "pushadvertise:  save open failed action"

    invoke-static {v0, p1}, Lcom/baidu/android/pushservice/util/n;->a(Ljava/lang/String;Landroid/content/Context;)V

    const-string/jumbo v6, "010506"
    ...
    invoke-static {v1, v0, p1}, Lcom/baidu/frontia/base/a/a/b;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-string/jumbo v3, "Version code is too low! ===> app ver: "
    ...
    const-string/jumbo v2, ", request ver:"
...
.method public handleADShowNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v0, "pushadvertise: receive show  test action"

    invoke-static {v0, p1}, Lcom/baidu/android/pushservice/util/n;->a(Ljava/lang/String;Landroid/content/Context;)V

    const-string/jumbo v0, "PublicMsg"

    const-string/jumbo v1, "--handleADShowNotification--"

    invoke-static {v0, v1, p1}, Lcom/baidu/frontia/base/a/a/b;->c(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "handleADShowNotification  release"
...
.method public handlePrivateNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "=== Handle private notification: "
    ...
    const-string/jumbo v0, "com.baidu.android.pushservice.action.privatenotification.DELETE"
    ...
    const-string/jumbo v2, "private notification deleted by user, title = "
    ...
    invoke-static {p1, v1, v2, v3}, Lcom/baidu/android/pushservice/util/n;->a(Landroid/content/Context;Landroid/content/Intent;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Intent broadcasted to app! ===> "
    ...
    const-string/jumbo v3, "Intent sent to actvity! ===> "
...
.method public handleRichMediaNotification(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Handle rich media notification"
    ...
    const-string/jumbo v2, "=== Handle rich media notification: "
    ...
    const-string/jumbo v3, "rich media notification deleted by user, title = "
    ...
    iput-object v1, v0, Lcom/baidu/android/pushservice/f/n;->a:Ljava/lang/String;
    ...
    iput v1, v0, Lcom/baidu/android/pushservice/f/n;->i:I
...
.method sendResult(Landroid/content/Context;Ljava/lang/String;I)V
    ...
    invoke-virtual {v0}, Lcom/baidu/android/pushservice/ak;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/baidu/android/pushservice/ak;->c()Ljava/lang/String;
    ...
    const-string/jumbo v1, "Fail Send Public msg result. Token invalid!"
    ...
    const-string/jumbo v2, "Send Linkhit, msgId = "
    ...
    const-string/jumbo v0, "PushService-linkhit"
    ...
    invoke-static {v2, v0, v5}, Lcom/baidu/frontia/base/a/a/b;->b(Ljava/lang/String;Ljava/lang/String;Landroid/content/Context;)V
