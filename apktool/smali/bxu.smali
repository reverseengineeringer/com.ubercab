...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbxu;->p:Landroid/view/ViewGroup;

    iget-object v0, p0, Lbxu;->p:Landroid/view/ViewGroup;

    invoke-static {v0}, Lbxa;->a(Landroid/view/ViewGroup;)Landroid/widget/LinearLayout;

    move-result-object v0

    iput-object v0, p0, Lbxu;->q:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lbxu;->q:Landroid/widget/LinearLayout;
    ...
    const-string/jumbo v2, "40dip"

    invoke-static {v1, v10, v2}, Lbxa;->a(Landroid/view/View;ILjava/lang/String;)V

    iget-object v1, p0, Lbxu;->r:Landroid/widget/ImageView;

    const-string/jumbo v2, "10dip"

    invoke-static {v1, v7, v7, v7, v2}, Lbxa;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v1, Landroid/widget/EditText;

    invoke-direct {v1, p1}, Landroid/widget/EditText;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lbxu;->b:Landroid/widget/EditText;

    iget-object v1, p0, Lbxu;->b:Landroid/widget/EditText;
    ...
    sget-object v2, Lbwz;->s:Landroid/graphics/Typeface;
    ...
    invoke-static {v1, v10, v9}, Lbxa;->a(Landroid/view/View;II)V
    ...
    iput-object v1, p0, Lbxu;->d:Landroid/widget/EditText;

    iget-object v1, p0, Lbxu;->d:Landroid/widget/EditText;
    ...
    invoke-static {p1, v8, v1, v0}, Lbxa;->a(Landroid/content/Context;ZILandroid/widget/LinearLayout;)Landroid/widget/LinearLayout;

    move-result-object v1

    iput-object v1, p0, Lbxu;->h:Landroid/widget/LinearLayout;

    new-instance v1, Landroid/widget/TextView;

    invoke-direct {v1, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lbxu;->i:Landroid/widget/TextView;

    iget-object v1, p0, Lbxu;->i:Landroid/widget/TextView;

    invoke-static {v1}, Lbxa;->a(Landroid/widget/TextView;)V
    ...
    iget-object v1, p0, Lbxu;->h:Landroid/widget/LinearLayout;

    iget-object v2, p0, Lbxu;->i:Landroid/widget/TextView;
    ...
    iput-object v1, p0, Lbxu;->e:Landroid/widget/TableLayout;

    iget-object v1, p0, Lbxu;->e:Landroid/widget/TableLayout;

    invoke-virtual {v1, v8, v8}, Landroid/widget/TableLayout;->setColumnStretchable(IZ)V

    iget-object v1, p0, Lbxu;->e:Landroid/widget/TableLayout;

    const/4 v2, 0x0

    invoke-virtual {v1, v2, v8}, Landroid/widget/TableLayout;->setColumnShrinkable(IZ)V
    ...
    iget-object v2, p0, Lbxu;->e:Landroid/widget/TableLayout;
    ...
    iput-object v2, p0, Lbxu;->g:Landroid/widget/TextView;

    iget-object v2, p0, Lbxu;->g:Landroid/widget/TextView;
    ...
    invoke-static {v2, v3}, Lbxa;->a(Landroid/widget/TextView;I)V

    iget-object v2, p0, Lbxu;->g:Landroid/widget/TextView;

    const-string/jumbo v3, "0dp"

    invoke-static {v2, v3}, Lbxa;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-static {v2, v3, v4}, Lbxa;->a(Landroid/view/View;IF)V

    iget-object v2, p0, Lbxu;->g:Landroid/widget/TextView;

    const-string/jumbo v3, "4dip"

    const-string/jumbo v4, "5dip"

    const-string/jumbo v5, "2dip"

    const-string/jumbo v6, "5dip"

    invoke-static {v2, v3, v4, v5, v6}, Lbxa;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v2, Landroid/widget/TextView;

    invoke-direct {v2, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v2, p0, Lbxu;->j:Landroid/widget/TextView;

    iget-object v2, p0, Lbxu;->j:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lbxu;->j:Landroid/widget/TextView;

    const/4 v2, 0x5

    invoke-static {v1, v2}, Lbxa;->a(Landroid/widget/TextView;I)V

    iget-object v1, p0, Lbxu;->j:Landroid/widget/TextView;

    const-string/jumbo v2, "0dp"

    invoke-static {v1, v2}, Lbxa;->a(Landroid/view/View;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v3}, Lbxa;->a(Landroid/view/View;IF)V

    iget-object v1, p0, Lbxu;->j:Landroid/widget/TextView;

    const-string/jumbo v2, "2dip"

    const-string/jumbo v3, "5dip"

    const-string/jumbo v4, "4dip"

    const-string/jumbo v5, "5dip"
    ...
    iput-object v2, p0, Lbxu;->f:Landroid/widget/TextView;

    iget-object v2, p0, Lbxu;->f:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lbxu;->f:Landroid/widget/TextView;

    invoke-static {v1, v8}, Lbxa;->a(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v8, v2}, Lbxa;->a(Landroid/view/View;IF)V
    ...
    iput-object v1, p0, Lbxu;->k:Landroid/widget/TextView;

    iget-object v1, p0, Lbxu;->k:Landroid/widget/TextView;
    ...
    sget-object v2, Lbwz;->p:Landroid/graphics/Typeface;
    ...
    invoke-static {v1, v9, v9}, Lbxa;->a(Landroid/view/View;II)V
    ...
    invoke-direct {v1, p1}, Lbxz;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lbxu;->o:Lbxz;

    iget-object v1, p0, Lbxu;->o:Lbxz;

    iget-object v1, v1, Lbxz;->a:Landroid/widget/LinearLayout;
    ...
    iput-object v1, p0, Lbxu;->l:Landroid/widget/EditText;

    iget-object v1, p0, Lbxu;->l:Landroid/widget/EditText;
    ...
    iput-object v0, p0, Lbxu;->m:Landroid/widget/LinearLayout;

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lbxu;->n:Landroid/widget/TextView;

    iget-object v0, p0, Lbxu;->n:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lbxu;->m:Landroid/widget/LinearLayout;

    iget-object v1, p0, Lbxu;->n:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbxu;->c:Lbxp;

    iget-object v0, p0, Lbxu;->q:Landroid/widget/LinearLayout;

    iget-object v1, p0, Lbxu;->c:Lbxp;

    iget-object v1, v1, Lbxp;->a:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v1}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lbxu;->c:Lbxp;

    iget-object v0, v0, Lbxp;->a:Landroid/widget/LinearLayout;

    invoke-static {v0, v9, v9}, Lbxa;->a(Landroid/view/View;II)V
    ...
    iget-object v0, p0, Lbxu;->b:Landroid/widget/EditText;
    ...
    iget-object v0, p0, Lbxu;->d:Landroid/widget/EditText;
    ...
    iget-object v0, p0, Lbxu;->h:Landroid/widget/LinearLayout;

    invoke-virtual {v0, v11}, Landroid/widget/LinearLayout;->setNextFocusUpId(I)V

    invoke-virtual {p0, v8}, Lbxu;->a(Z)V

    iget-object v0, p0, Lbxu;->g:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lbxu;->f:Landroid/widget/TextView;

    const v1, 0xa80e

    invoke-virtual {v0, v1}, Landroid/widget/TextView;->setNextFocusUpId(I)V

    iget-object v0, p0, Lbxu;->j:Landroid/widget/TextView;
    ...
    iput-object v0, p0, Lbxu;->a:Landroid/view/ViewGroup;
