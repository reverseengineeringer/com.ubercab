...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbya;->d:Landroid/widget/TableLayout;

    iget-object v0, p0, Lbya;->d:Landroid/widget/TableLayout;
    ...
    iget-object v1, p0, Lbya;->d:Landroid/widget/TableLayout;
    ...
    iput-object v1, p0, Lbya;->c:Landroid/widget/ImageView;

    iget-object v1, p0, Lbya;->c:Landroid/widget/ImageView;
    ...
    const-string/jumbo v2, "Credit card"
    ...
    invoke-static {v1, v2, v4}, Lbxa;->a(Landroid/view/View;IF)V

    new-instance v1, Landroid/widget/TextView;

    invoke-direct {v1, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Lbya;->b:Landroid/widget/TextView;

    iget-object v1, p0, Lbya;->b:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lbya;->b:Landroid/widget/TextView;

    invoke-static {v0, v5, v5}, Lbxa;->a(Landroid/view/View;II)V

    iget-object v0, p0, Lbya;->b:Landroid/widget/TextView;

    const/16 v1, 0x15

    invoke-static {v0, v1, v4}, Lbxa;->a(Landroid/view/View;IF)V

    iget-object v0, p0, Lbya;->d:Landroid/widget/TableLayout;

    iput-object v0, p0, Lbya;->a:Landroid/view/ViewGroup;
