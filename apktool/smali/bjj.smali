...
# direct methods
.method constructor <init>(Lbjg;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-direct {p0, p1, p2}, Lbjj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-static {p1, p2, p4, p5}, Lbjj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_0
    ...
    iget-object v1, p0, Lbjj;->a:Lbjg;

    invoke-virtual {v1}, Lbjg;->s()Lbjx;
...
.method private static a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p1}, Lbjj;->b(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lbjj;->a:Lbjg;

    invoke-virtual {v2}, Lbjg;->s()Lbjx;
    ...
    invoke-virtual {v2, v3, p2, v0}, Lbjy;->a(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    :try_end_2
...
.method public final getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Lbjg;->a(Lbjg;)Lbiy;

    move-result-object v0

    invoke-static {}, Lbjf;->G()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lbiy;->a(J)Z
    ...
    invoke-static {v0}, Lbjg;->b(Lbjg;)Ljava/lang/String;

    move-result-object v0

    iget-object v1, p0, Lbjj;->a:Lbjg;

    invoke-virtual {v1}, Lbjg;->m()Landroid/content/Context;
    ...
    invoke-static {v1}, Lbjg;->a(Lbjg;)Lbiy;
...
.method public final onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lbjj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {}, Lbjg;->B()Ljava/util/Map;
    ...
    invoke-direct/range {v6 .. v11}, Lbjj;->a(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
