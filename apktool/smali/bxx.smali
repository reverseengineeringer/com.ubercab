...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lbxx;->a:Landroid/widget/TableLayout;

    iget-object v0, p0, Lbxx;->a:Landroid/widget/TableLayout;
    ...
    iput-object v0, p0, Lbxx;->b:Landroid/widget/TableRow;

    iget-object v0, p0, Lbxx;->a:Landroid/widget/TableLayout;

    iget-object v1, p0, Lbxx;->b:Landroid/widget/TableRow;

    invoke-virtual {v0, v1}, Landroid/widget/TableLayout;->addView(Landroid/view/View;)V

    iget-object v0, p0, Lbxx;->b:Landroid/widget/TableRow;

    const-string/jumbo v1, "30dip"

    invoke-static {v0, v6, v1}, Lbxa;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    invoke-static {v0, v7, v1}, Lbxa;->a(Landroid/view/View;IF)V

    new-instance v0, Landroid/widget/TableRow;

    invoke-direct {v0, p1}, Landroid/widget/TableRow;-><init>(Landroid/content/Context;)V

    iget-object v1, p0, Lbxx;->a:Landroid/widget/TableLayout;
    ...
    iput-object v1, p0, Lbxx;->c:Landroid/widget/TextView;

    iget-object v1, p0, Lbxx;->c:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lbxx;->c:Landroid/widget/TextView;

    const/4 v1, -0x1

    invoke-static {v0, v6, v1}, Lbxa;->a(Landroid/view/View;II)V
    ...
    iput-object v1, p0, Lbxx;->d:Landroid/widget/TextView;

    iget-object v1, p0, Lbxx;->d:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lbxx;->d:Landroid/widget/TextView;
