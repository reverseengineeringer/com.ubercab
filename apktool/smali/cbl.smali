...
.method public constructor <init>(Landroid/content/Context;Lcbk;)V
    ...
    iput-object v0, p0, Lcbl;->d:Landroid/widget/ScrollView;

    iget-object v0, p0, Lcbl;->d:Landroid/widget/ScrollView;
    ...
    iput-object v0, p0, Lcbl;->e:Landroid/widget/LinearLayout;

    iget-object v0, p0, Lcbl;->e:Landroid/widget/LinearLayout;
    ...
    iget-object v1, p0, Lcbl;->e:Landroid/widget/LinearLayout;
    ...
    const-string/jumbo v4, "20dip"

    invoke-static {v2, v0, v1, v3, v4}, Lbxa;->a(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, v3}, Lbxa;->a(Landroid/view/View;ILjava/lang/String;)V
    ...
    invoke-static {v0, v1, v3, v4, v5}, Lbxa;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/TextView;

    invoke-direct {v0, p1}, Landroid/widget/TextView;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcbl;->b:Landroid/widget/TextView;
    ...
    sget-boolean v0, Lbxl;->a:Z

    if-eqz v0, :cond_0

    const-string/jumbo v0, "direction: rtl;"

    :goto_0
    new-instance v1, Ljava/lang/StringBuilder;

    const-string/jumbo v4, "body { color: #515151; line-height: 26px; font-size: 18px; font-family: sans-serif-light, DroidSans, sans-serif; font-weight: 300; "
    ...
    const-string/jumbo v1, "} h1, strong { font-family: DroidSans, sans-serif; font-weight: 500; }h1 { font-size: 18px }h1, p { margin: 0 0 13px 0 }ul { margin: 0; padding-left: 1.1em; list-style-position: outside; }"
    ...
    const-string/jumbo v4, "<html><meta name=\'viewport\' content=\'width=device-width; initial-scale=1.0;\'/><head><style type=\"text/css\">"
    ...
    const-string/jumbo v1, "</style></head><body>"
    ...
    invoke-virtual {p2}, Lcbk;->ordinal()I
    ...
    invoke-static {v3, v0, v1}, Lbxa;->a(Landroid/view/View;II)V
    ...
    invoke-static {v3, v0, v1, v4, v5}, Lbxa;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    new-instance v0, Landroid/widget/Button;

    invoke-direct {v0, p1}, Landroid/widget/Button;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcbl;->c:Landroid/widget/Button;

    iget-object v0, p0, Lcbl;->c:Landroid/widget/Button;
    ...
    invoke-static {v0, v1, p1}, Lbxa;->a(Landroid/view/View;ZLandroid/content/Context;)V
    ...
    invoke-static {v0, v1, v2, v3, v4}, Lbxa;->b(Landroid/view/View;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "https://www.paypal.com/%s/webapps/mpp/ua/useragreement-full"
    ...
    sget-object v6, Lbxn;->aG:Lbxn;

    invoke-static {v6}, Lbxl;->a(Lbxn;)Ljava/lang/String;
