...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcfx;->a:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcfx;->b:Ljava/util/Map;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    sput-object v0, Lcfx;->c:Ljava/util/Map;
...
.method public constructor <init>()V
    ...
    sget-object v0, Lcfx;->a:Ljava/util/Map;
    ...
    const-string/jumbo v2, "Change Funding Source"
    ...
    const-string/jumbo v2, "Clear card details"
    ...
    const-string/jumbo v2, "Are you sure you want to clear your card details?"
    ...
    const-string/jumbo v2, "Address Line 1"
    ...
    const-string/jumbo v2, "Enable the display of your funding options to allow you to make a choice."
    ...
    const-string/jumbo v2, "<a href=\'%1$s\'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s."
    ...
    const-string/jumbo v2, "<h1><strong>Funding Sources</strong></h1><p>PayPal only shares which of your funding sources are available for use.</p>"
    ...
    const-string/jumbo v2, "Forgotten your password?"
    ...
    const-string/jumbo v2, "Preferred Funding Source"
    ...
    const-string/jumbo v2, "Please log in to PayPal again."
    ...
    const-string/jumbo v2, "Delivery Address"
    ...
    const-string/jumbo v2, "Verification Code"
    ...
    const-string/jumbo v2, "Enter the 6-digit verification code"
    ...
    const-string/jumbo v2, "Unauthorised Device"
    ...
    const-string/jumbo v2, "Unrecognised Source"
    ...
    sget-object v0, Lcfx;->b:Ljava/util/Map;
    ...
    const-string/jumbo v2, "<p><a href=\'%1$s\'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.</p><p>Please see the <a href=\'https://www.paypal.com/webapps/mpp/ua/recurringpymts-full\'>PayPal Recurring Payments and Billing Agreement</a> for more information.</p>"
    ...
    const-string/jumbo v2, "<p><a href=\'%1$s\'>Authorise charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.</p><p>Please see the <a href=\'https://cms.paypal.com/c2/cgi-bin/?cmd=_render-content&content_ID=ua/UserAgreement_full\'>PayPal Recurring Payments and Billing Agreement</a> for more information.</p>"
    ...
    const-string/jumbo v2, "<a href=\'%1$s\'>Authorise charges</a> for future purchases paid for with PayPal. You authorise and instruct PayPal to pay all amounts."
    ...
    const-string/jumbo v2, "Pre-approve future payments made from your PayPal account without logging in to PayPal each time. <a href=\'%1$s\'>See additional terms</a>, including funding sources and how to cancel future payments."
    ...
    const-string/jumbo v2, "<h1><strong>Funding Sources</strong></h1><p>PayPal only shares the information about which of your funding sources are available for use.</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Agreement</strong></h1><p>To make sure your PayPal account can be charged in future, this app may simulate a small test transaction but no money will be transferred.</p><p>Your default funding source (your PayPal balance, linked bank account, debit or credit card, in that order) will be used to pay for PayPal purchases. Please note, if your default funding source doesn\u2019t have enough funds to cover the purchase, your bank or card provider may charge you a fee.</p><p>To cancel this agreement, log in to your PayPal account and go to <strong>Profile</strong> then click <strong>My Settings</strong> and <strong>Change</strong> beside \u201cLog in with PayPal.\u201d</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Agreement</strong></h1><p>To make sure your PayPal account can be charged in the future, this app may simulate a small test transaction but no money will be transferred.</p><p>Your PayPal balance or primary debit or credit card will be used to pay for PayPal purchases.</p><p>To cancel this agreement, log in to your PayPal account and go to <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Agreement</strong></h1><p>To make sure your PayPal Account can be charged in the future, this app may simulate a small test transaction but no payment will be transferred.</p><p>Your default funding source will be used to pay for PayPal purchases.</p><p>To cancel this agreement, log in to your PayPal Account, go to <strong>Profile</strong> &gt; <strong>Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Authorisation</strong></h1><p>To make sure your PayPal account can be charged in the future, this app may simulate a small test transaction but no payment will be transferred.</p><p>Your default funding source will be used to pay for PayPal purchases.</p><p>To cancel this authorisation, log in to your PayPal account, go to <strong>Profile</strong> &gt; <strong>My account settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>Please see the \u201cPre-approved Payments\u201d section of the <a href=\'%s\'>PayPal User Agreement</a> for more information.</p>"
    ...
    const-string/jumbo v2, "<h1><strong>Future Payment Agreement</strong></h1><p>PayPal will first use your PayPal balance to pay for your purchase. If that doesn\u2019t cover your total, your bank account, PayPal Credit, debit card, credit card, and/or eCheque will be used in that order.</p><p>To cancel this agreement, go to www.paypal.co.uk <strong>Profile</strong> &gt; <strong>My Settings</strong> &gt; <strong>Log In with PayPal</strong> and remove this merchant from the list.</p><p>A small payment authorisation may be required to make sure your PayPal account can be charged in the future. The authorisation will be voided and you won\u2019t be charged.</p>"
    ...
    sget-object v0, Lcfx;->c:Ljava/util/Map;
    ...
    const-string/jumbo v2, "This authorisation has already been completed."
    ...
    const-string/jumbo v2, "Authorisation is in a state that cannot be voided."
    ...
    const-string/jumbo v2, "Authorisation has expired."
    ...
    const-string/jumbo v2, "The requested authorisation ID does not exist."
    ...
    const-string/jumbo v2, "Authorisation has been voided."
    ...
    const-string/jumbo v2, "Can only reauthorise the original authorisation, not a reauthorisation."
    ...
    const-string/jumbo v2, "Reauthorisation is not allowed within the honour period."
    ...
    const-string/jumbo v2, "Cannot access saved card details."
    ...
    const-string/jumbo v2, "The card details are invalid. Please correct and submit again."
    ...
    const-string/jumbo v2, "Currency of capture must be the same as currency of authorisation."
    ...
    const-string/jumbo v2, "Your selected funding source was not accepted. Please choose a different source."
    ...
    const-string/jumbo v2, "Invalid town/city/postcode combination."
    ...
    const-string/jumbo v2, "Vendor account does not have a confirmed email address."
    ...
    const-string/jumbo v2, "Your account has been limited."
    ...
    const-string/jumbo v2, "No more reauthorisations for this authorisation are allowed."
    ...
    const-string/jumbo v2, "Merchant profile preference is set to automatically refuse certain transactions."
    ...
    const-string/jumbo v2, "Order has already been voided or completed, or has expired."
    ...
    const-string/jumbo v2, "Maximum number of allowed authorisations for the order has been reached."
    ...
    const-string/jumbo v2, "Error encountered while adding delivery address to PayPal account."
    ...
    const-string/jumbo v2, "The delivery address provided is not valid."
    ...
    const-string/jumbo v2, "There was a problem setting up this payment - your card has expired. Please visit the PayPal website to check your account."
    ...
    const-string/jumbo v2, "There was a problem setting up this payment - account needs a valid funding source, such as a bank account or payment card. Please visit the PayPal website to check your account."
    ...
    const-string/jumbo v2, "Client not authorised."
    ...
    const-string/jumbo v2, "Request not authorised."
    ...
    const-string/jumbo v2, "Your login cannot be completed at this time. Please try again later, or go to www.paypal.com to address any security concerns with your PayPal account."
...
.method public final synthetic a(Ljava/lang/Enum;Ljava/lang/String;)Ljava/lang/String;
    ...
    sget-object v1, Lcfx;->b:Ljava/util/Map;
