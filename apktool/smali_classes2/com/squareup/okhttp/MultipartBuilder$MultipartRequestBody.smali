...
# instance fields
.field private final boundary:Lkhq;
...
# direct methods
.method public constructor <init>(Lcom/squareup/okhttp/MediaType;Lkhq;Ljava/util/List;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 207
    :cond_0
    iput-object p2, p0, Lcom/squareup/okhttp/MultipartBuilder$MultipartRequestBody;->boundary:Lkhq;
    ...
    invoke-virtual {p2}, Lkhq;->a()Ljava/lang/String;
...
.method private writeOrCountBytes(Lkho;Z)J
    .locals 11
    ...
    invoke-interface {p1, v3}, Lkho;->b([B)Lkho;

    .line 242
    iget-object v3, p0, Lcom/squareup/okhttp/MultipartBuilder$MultipartRequestBody;->boundary:Lkhq;

    invoke-interface {p1, v3}, Lkho;->b(Lkhq;)Lkho;
    ...
    invoke-interface {p1, v9}, Lkho;->b(Ljava/lang/String;)Lkho;
    ...
    invoke-interface {v9, v10}, Lkho;->b([B)Lkho;
    ...
    invoke-interface {v9, v10}, Lkho;->b(Ljava/lang/String;)Lkho;
    ...
    invoke-interface {p1, v3}, Lkho;->b(Ljava/lang/String;)Lkho;
    ...
    invoke-interface {v3, v0}, Lkho;->b(Ljava/lang/String;)Lkho;
    ...
    invoke-interface {v0, v3}, Lkho;->b([B)Lkho;
    ...
    .line 264
    invoke-interface {v3, v0, v1}, Lkho;->k(J)Lkho;
    ...
    invoke-interface {v3, v8}, Lkho;->b([B)Lkho;
    ...
    invoke-virtual {v0, p1}, Lcom/squareup/okhttp/RequestBody;->writeTo(Lkho;)V
    ...
    invoke-interface {p1, v0}, Lkho;->b([B)Lkho;

    .line 284
    iget-object v0, p0, Lcom/squareup/okhttp/MultipartBuilder$MultipartRequestBody;->boundary:Lkhq;
...
.method public final contentLength()J
    ...
    invoke-direct {p0, v0, v1}, Lcom/squareup/okhttp/MultipartBuilder$MultipartRequestBody;->writeOrCountBytes(Lkho;Z)J
...
.method public final writeTo(Lkho;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/squareup/okhttp/MultipartBuilder$MultipartRequestBody;->writeOrCountBytes(Lkho;Z)J
