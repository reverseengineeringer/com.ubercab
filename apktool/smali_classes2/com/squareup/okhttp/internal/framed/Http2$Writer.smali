...
.field private final hpackBuffer:Lkhn;
...
.method constructor <init>(Lkho;Z)V
    ...
    .line 372
    iput-object p1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->sink:Lkho;
    ...
    iput-object v0, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->hpackBuffer:Lkhn;

    .line 375
    new-instance v0, Lcom/squareup/okhttp/internal/framed/Hpack$Writer;

    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->hpackBuffer:Lkhn;

    invoke-direct {v0, v1}, Lcom/squareup/okhttp/internal/framed/Hpack$Writer;-><init>(Lkhn;)V
...
.method private writeContinuationFrames(IJ)V
    ...
    .line 461
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->sink:Lkho;

    iget-object v2, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->hpackBuffer:Lkhn;

    int-to-long v4, v1

    invoke-interface {v0, v2, v4, v5}, Lkho;->write(Lkhn;J)V
...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-virtual {v4}, Lkhq;->d()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lkhq;->g()[B

    move-result-object v1

    invoke-interface {v0, v1}, Lkho;->b([B)Lkho;
...
.method public final declared-synchronized data(ZILkhn;I)V
    ...
    :cond_1
    :try_start_1
    invoke-virtual {p0, p2, v0, p3, p4}, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->dataFrame(IBLkhn;I)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method final dataFrame(IBLkhn;I)V
    .locals 4
...
.method final frameHeader(IIBB)V
    ...
    # invokes: Lcom/squareup/okhttp/internal/framed/Http2;->writeMedium(Lkho;I)V
    invoke-static {v0, p2}, Lcom/squareup/okhttp/internal/framed/Http2;->access$600(Lkho;I)V
...
.method public final declared-synchronized goAway(ILcom/squareup/okhttp/internal/framed/ErrorCode;[B)V
    ...
    invoke-interface {v0, p3}, Lkho;->b([B)Lkho;
...
.method final headers(ZILjava/util/List;)V
    ...
    .line 445
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->hpackBuffer:Lkhn;
    ...
    iget-object v4, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->hpackBuffer:Lkhn;

    int-to-long v6, v1

    invoke-interface {v0, v4, v6, v7}, Lkho;->write(Lkhn;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {v0, p3}, Lkho;->h(I)Lkho;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {v0, v4}, Lkho;->h(I)Lkho;
...
.method public final declared-synchronized settings(Lcom/squareup/okhttp/internal/framed/Settings;)V
    ...
    .line 510
    :goto_1
    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/Http2$Writer;->sink:Lkho;

    invoke-interface {v3, v0}, Lkho;->i(I)Lkho;
    ...
    invoke-interface {v0, v3}, Lkho;->h(I)Lkho;
