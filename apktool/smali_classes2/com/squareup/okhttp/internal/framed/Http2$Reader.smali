...
# direct methods
.method constructor <init>(Lkhp;IZ)V
    .locals 2
    ...
    .line 96
    iput-object p1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:Lkhp;
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:Lkhp;

    invoke-direct {v0, v1}, Lcom/squareup/okhttp/internal/framed/Http2$ContinuationSource;-><init>(Lkhp;)V
    ...
    invoke-direct {v0, p2, v1}, Lcom/squareup/okhttp/internal/framed/Hpack$Reader;-><init>(ILkif;)V
...
.method private readData(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:Lkhp;

    invoke-interface {v0}, Lkhp;->h()B
    ...
    .line 228
    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:Lkhp;

    invoke-interface {p1, v2, p4, v3, v1}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->data(ZILkhp;I)V
    ...
    invoke-interface {v1, v2, v3}, Lkhp;->g(J)V
...
.method private readGoAway(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    invoke-interface {v0, v4, v5}, Lkhp;->d(J)Lkhq;

    move-result-object v0

    .line 347
    :cond_3
    invoke-interface {p1, v1, v3, v0}, Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;->goAway(ILcom/squareup/okhttp/internal/framed/ErrorCode;Lkhq;)V
...
.method private readPing(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    .line 326
    :cond_1
    iget-object v2, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:Lkhp;

    invoke-interface {v2}, Lkhp;->j()I
...
.method private readSettings(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;IBI)V
    ...
    invoke-interface {v0}, Lkhp;->i()S

    move-result v0

    .line 272
    iget-object v4, p0, Lcom/squareup/okhttp/internal/framed/Http2$Reader;->source:Lkhp;

    invoke-interface {v4}, Lkhp;->j()I
...
.method public final nextFrame(Lcom/squareup/okhttp/internal/framed/FrameReader$Handler;)Z
    .locals 7
    ...
    invoke-interface {v2, v4, v5}, Lkhp;->a(J)V
    :try_end_0
    ...
    # invokes: Lcom/squareup/okhttp/internal/framed/Http2;->readMedium(Lkhp;)I
    invoke-static {v2}, Lcom/squareup/okhttp/internal/framed/Http2;->access$300(Lkhp;)I
...
.method public final readConnectionPreface()V
    ...
    # getter for: Lcom/squareup/okhttp/internal/framed/Http2;->CONNECTION_PREFACE:Lkhq;
    invoke-static {}, Lcom/squareup/okhttp/internal/framed/Http2;->access$000()Lkhq;

    move-result-object v1

    invoke-virtual {v1}, Lkhq;->f()I

    move-result v1

    int-to-long v2, v1

    invoke-interface {v0, v2, v3}, Lkhp;->d(J)Lkhq;
    ...
    invoke-virtual {v1, v0}, Lkhq;->equals(Ljava/lang/Object;)Z
