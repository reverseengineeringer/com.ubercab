...
.method static synthetic access$1000(Lkhp;)I
    .locals 1

    .prologue
    .line 131
    invoke-static {p0}, Lcom/squareup/okhttp/Cache;->readInt(Lkhp;)I
...
.method private static readInt(Lkhp;)I
    .locals 6

    .prologue
    .line 681
    :try_start_0
    invoke-interface {p0}, Lkhp;->m()J

    move-result-wide v0

    .line 682
    invoke-interface {p0}, Lkhp;->q()Ljava/lang/String;
...
.method final get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v1, v3}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;->getSource(I)Lkif;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/squareup/okhttp/Cache$Entry;-><init>(Lkif;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
