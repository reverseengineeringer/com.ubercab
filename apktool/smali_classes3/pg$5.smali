...
.method public final a(Lasq;Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lpg$5;->a:Lpg;

    invoke-static {v0}, Lpg;->b(Lpg;)Laks;

    move-result-object v0

    const-string/jumbo v2, "sendMessageToNativeJs"

    invoke-interface {v0, v2, v1}, Laks;->b(Ljava/lang/String;Lorg/json/JSONObject;)V
    :try_end_1
