...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    sget v1, Lbp;->dropDownListViewStyle:I
    ...
    .line 1585
    iput-boolean p2, p0, Lgl;->h:Z

    .line 1586
    const/4 v0, 0x0

    invoke-virtual {p0, v0}, Lgl;->setCacheColorHint(I)V
...
.method private a(Landroid/view/View;I)V
    ...
    .prologue
    .line 1656
    invoke-virtual {p0, p2}, Lgl;->getItemIdAtPosition(I)J

    move-result-wide v0

    .line 1657
    invoke-virtual {p0, p1, p2, v0, v1}, Lgl;->performItemClick(Landroid/view/View;IJ)Z
...
.method private a(Landroid/view/View;IFF)V
    ...
    .line 1682
    invoke-virtual {p0, p3, p4}, Lgl;->drawableHotspotChanged(FF)V

    .line 1684
    :cond_0
    invoke-virtual {p0}, Lgl;->isPressed()Z
    ...
    .line 1685
    invoke-virtual {p0, v3}, Lgl;->setPressed(Z)V

    .line 1689
    :cond_1
    invoke-virtual {p0}, Lgl;->layoutChildren()V
    ...
    invoke-virtual {p0}, Lgl;->getFirstVisiblePosition()I

    move-result v1

    sub-int/2addr v0, v1

    invoke-virtual {p0, v0}, Lgl;->getChildAt(I)Landroid/view/View;
    ...
    .line 1712
    :cond_4
    invoke-virtual {p0, p2}, Lgl;->setSelection(I)V

    .line 1713
    invoke-virtual {p0, p2, p1, p3, p4}, Lgl;->a(ILandroid/view/View;FF)V

    .line 1718
    invoke-virtual {p0, v4}, Lgl;->a(Z)V

    .line 1722
    invoke-virtual {p0}, Lgl;->refreshDrawableState()V

    .line 1723
    return-void
.end method

.method public static synthetic a(Lgl;Z)Z
    .locals 0

    .prologue
    .line 1532
    iput-boolean p1, p0, Lgl;->g:Z
...
.method private b()V
    ...
    .line 1661
    iput-boolean v2, p0, Lgl;->i:Z

    .line 1662
    invoke-virtual {p0, v2}, Lgl;->setPressed(Z)V

    .line 1664
    invoke-virtual {p0}, Lgl;->drawableStateChanged()V
    ...
    .line 1671
    :cond_0
    iget-object v0, p0, Lgl;->j:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
    ...
    iput-object v0, p0, Lgl;->j:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
...
.method public final a(Landroid/view/MotionEvent;I)Z
    ...
    .line 1639
    iget-object v0, p0, Lgl;->k:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    iput-object v0, p0, Lgl;->k:Landroid/support/v4/widget/ListViewAutoScrollHelper;
    ...
    .line 1616
    invoke-virtual {p0, v5, v4}, Lgl;->pointToPosition(II)I
    ...
    invoke-direct {p0, v0, v6, v5, v4}, Lgl;->a(Landroid/view/View;IFF)V

    .line 1626
    if-ne v3, v2, :cond_0

    .line 1627
    invoke-direct {p0, v0, v6}, Lgl;->a(Landroid/view/View;I)V
