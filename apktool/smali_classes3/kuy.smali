...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkuy;->a:Ljava/lang/Boolean;
...
.method public static a(Ljava/lang/CharSequence;Landroid/graphics/Typeface;)Ljava/lang/CharSequence;
    ...
    invoke-static {p1}, Lkvd;->a(Landroid/graphics/Typeface;)Lkux;
...
.method static a(Landroid/content/Context;Landroid/widget/TextView;Lkup;Ljava/lang/String;Z)V
    .locals 1
    ...
    invoke-static {p0, p1, p3, p4}, Lkuy;->a(Landroid/content/Context;Landroid/widget/TextView;Ljava/lang/String;Z)Z
    ...
    .line 144
    :cond_2
    invoke-static {p0, p1, p2, p4}, Lkuy;->a(Landroid/content/Context;Landroid/widget/TextView;Lkup;Z)V

    goto :goto_0
.end method

.method private static a(Landroid/content/Context;Landroid/widget/TextView;Lkup;Z)V
    .locals 1
    ...
    .line 123
    invoke-virtual {p2}, Lkup;->b()Ljava/lang/String;

    move-result-object v0

    invoke-static {p0, p1, v0, p3}, Lkuy;->a(Landroid/content/Context;Landroid/widget/TextView;Ljava/lang/String;Z)Z
...
.method static a()Z
    ...
    .prologue
    .line 321
    sget-object v0, Lkuy;->a:Ljava/lang/Boolean;
...
.method private static a(Landroid/content/Context;Landroid/widget/TextView;Ljava/lang/String;Z)Z
    ...
    .line 112
    invoke-static {v0, p2}, Lkvd;->a(Landroid/content/res/AssetManager;Ljava/lang/String;)Landroid/graphics/Typeface;

    move-result-object v0

    .line 113
    invoke-static {p1, v0, p3}, Lkuy;->a(Landroid/widget/TextView;Landroid/graphics/Typeface;Z)Z
...
.method public static a(Landroid/widget/TextView;Landroid/graphics/Typeface;)Z
    ...
    invoke-static {p0, p1, v0}, Lkuy;->a(Landroid/widget/TextView;Landroid/graphics/Typeface;Z)Z
...
.method public static a(Landroid/widget/TextView;Landroid/graphics/Typeface;Z)Z
    ...
    invoke-static {v0, p1}, Lkuy;->a(Ljava/lang/CharSequence;Landroid/graphics/Typeface;)Ljava/lang/CharSequence;
    ...
    .line 78
    new-instance v0, Lkuy$1;

    invoke-direct {v0, p1}, Lkuy$1;-><init>(Landroid/graphics/Typeface;)V
