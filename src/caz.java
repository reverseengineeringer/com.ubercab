  ...
  implements cav
{
  ...
  public caz()
  {
    ...
    a.put(bxn.v, "Visa");
    a.put(bxn.w, "Change Payment Method");
    a.put(bxn.x, "Checking");
    a.put(bxn.y, "Checking this device…");
    a.put(bxn.z, "Clear card information");
    a.put(bxn.A, "Confirm");
    a.put(bxn.B, "Are you sure you want to clear your card information?");
    ...
    a.put(bxn.L, "Birth Date");
    a.put(bxn.M, "Email address");
    a.put(bxn.N, "Full Name");
    a.put(bxn.O, "Gender");
    a.put(bxn.P, "Language");
    a.put(bxn.Q, "Locale");
    a.put(bxn.R, "Telephone");
    a.put(bxn.S, "Time Zone");
    a.put(bxn.T, "Share the following: %s.");
    a.put(bxn.U, "Use Seamless Checkout.");
    a.put(bxn.V, "%s asks that you:");
    a.put(bxn.W, "Share the <a href='%1$s'>payment methods</a> linked to your PayPal account.");
    a.put(bxn.X, "Enable display of your funding options to allow you to make a choice.");
    a.put(bxn.Y, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    ...
    a.put(bxn.ai, "<h1><strong>Payment Methods</strong></h1><p>PayPal only shares which of your payment methods are available for use.</p>");
    a.put(bxn.aj, "Forgot password?");
    a.put(bxn.ak, "From");
    ...
    a.put(bxn.aA, "Phone");
    a.put(bxn.aB, "PIN");
    a.put(bxn.aC, "Preferred Payment Method");
    ...
    a.put(bxn.aL, "Please log in again to PayPal.");
    a.put(bxn.aM, "Session Expired");
    a.put(bxn.aN, "Shipping Address");
    ...
    a.put(bxn.aW, "Enter the 6-digit security code");
    ...
    a.put(bxn.bc, "Unauthorized Device");
    ...
    a.put(bxn.bg, "Unrecognized Source");
