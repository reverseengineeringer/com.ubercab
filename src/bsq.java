  ...
  implements cav
{
  ...
  public bsq()
  {
    a.put(bxn.a, "Согласиться и оплатить");
    a.put(bxn.b, "и прочие");
    a.put(bxn.c, "Аутентификация");
    a.put(bxn.d, "Назад");
    a.put(bxn.e, "Резервный");
    a.put(bxn.f, "Отмена");
    ...
    a.put(bxn.v, "Visa");
    a.put(bxn.w, "Изменить способ оплаты");
    a.put(bxn.x, "Проверка");
    a.put(bxn.y, "Выполняется проверка устройства…");
    a.put(bxn.z, "Очистить данные карты");
    a.put(bxn.A, "Подтвердить");
    a.put(bxn.B, "Вы уверены, что хотите очистить сведения о банковской карте?");
    a.put(bxn.C, "Оплатить по карте");
    a.put(bxn.D, "Выйти из учетной записи PayPal?");
    a.put(bxn.E, "Оплатить");
    a.put(bxn.F, "Соглашаюсь");
    a.put(bxn.G, "Дата создания счета");
    a.put(bxn.H, "Статус счета");
    a.put(bxn.I, "Тип счета");
    a.put(bxn.J, "Адрес");
    a.put(bxn.K, "Возрастной диапазон");
    a.put(bxn.L, "Дата рождения");
    a.put(bxn.M, "Эл. почта");
    a.put(bxn.N, "Полное имя");
    a.put(bxn.O, "Пол");
    a.put(bxn.P, "Язык");
    a.put(bxn.Q, "Локаль");
    a.put(bxn.R, "Телефон");
    a.put(bxn.S, "Часовой пояс");
    a.put(bxn.T, "Использовать совместно: %s.");
    a.put(bxn.U, "Воспользуйтесь безупречным способом оформления заказа.");
    a.put(bxn.V, "%s просит вашего разрешения:");
    a.put(bxn.W, "Поделиться информацией о <a href='%1$s'>способах оплаты</a>, привязанных к вашему счету PayPal.");
    a.put(bxn.X, "Включите отображение ваших источников средств, чтобы вы могли выбирать при совершении покупок.");
    a.put(bxn.Y, "<a href='%1$s'>Подтвердите списания</a> за будущие покупки через PayPal у продавца %2$s. Вы разрешаете PayPal оплачивать все суммы, запрашиваемые %3$s.");
    a.put(bxn.Z, "подключать и управлять дисконтными картами через ваш счет PayPal.");
    a.put(bxn.aa, "Подтвердить согласие с положениями %1$s <a href='%2$s'>Политики конфиденциальности</a> и <a href='%3$s'>Соглашения с пользователем</a>.");
    a.put(bxn.ab, "Разрешить им <a href='%1$s'>запрашивать денежные средства</a> от вашего имени, пока вы не аннулируете свое согласие.");
    a.put(bxn.ac, "Разрешить им <a href='%1$s'>отправлять денежные средства</a> от вашего имени, пока вы не аннулируете свое согласие.");
    a.put(bxn.ad, "Согласиться");
    a.put(bxn.ae, "Эл. почта");
    a.put(bxn.af, "Ложные данные");
    a.put(bxn.ag, "Изолированная программная среда");
    a.put(bxn.ah, "Действует до");
    a.put(bxn.ai, "<h1><strong>Способы оплаты</strong></h1><p>PayPal делится информацией только о том, какой из ваших способов оплаты доступен для использования.</p>");
    a.put(bxn.aj, "Забыли пароль?");
    a.put(bxn.ak, "С");
    a.put(bxn.al, "Какой источник средств предпочтительнее для будущих платежей пользователю %1$s?");
    a.put(bxn.am, "<h1><strong>Соглашение о будущих платежах</strong></h1><p>Для всех будущих платежей через PayPal этот продавец будет использовать ваш источник средств по умолчанию.</p><p>Для отмены данного соглашения войдите в систему PayPal под своим именем и перейдите по вкладке <strong>Профиль</strong> &gt; <strong>Мои настройки</strong> &gt; <strong>Войти через PayPal</strong> и удалите этого продавца из списка.</p><p>Будут применены условия раздела о регулярных платежах <a href='%s'>Соглашения с пользователем в отношении услуг PayPal</a>.</p><p>Для проверки работоспособности вашего счета PayPal это приложение может выполнить небольшую тестовую операцию без снятия или перевода денег.</p>");
    a.put(bxn.an, "Внутренняя ошибка");
    a.put(bxn.ao, "<p>Нажимая кнопку ниже, я подтверждаю свое согласие с условиями <a href='%1$s'>Соглашения с пользователем в отношении услуг PayPal</a> и заявляю, что, совершая данную финансовую операцию, действую в соответствии с действующим законодательством Японии, включая санкции в отношении перевода платежей в Северную Корею и Иран в рамках <a href='%2$s'>Закона об обмене валют и зарубежной торговле</a>.</p>");
    a.put(bxn.ap, "Вход");
    a.put(bxn.aq, "Вход с помощью учетной записи PayPal");
    a.put(bxn.ar, "Выход");
    a.put(bxn.as, "Выход");
    a.put(bxn.at, "ОК");
    a.put(bxn.au, "Пароль");
    a.put(bxn.av, "Оплата после доставки");
    a.put(bxn.aw, "Способ оплаты:");
    a.put(bxn.ax, "Оплатить картой");
    a.put(bxn.ay, "На счете PayPal");
    a.put(bxn.az, "PayPal Credit");
    a.put(bxn.aA, "Телефон");
    a.put(bxn.aB, "PIN-код");
    a.put(bxn.aC, "Предпочтительный способ оплаты");
    a.put(bxn.aD, "PayPal гарантирует защиту ваших <a href='%s'>конфиденциальных данных</a> и финансовой информации.");
    a.put(bxn.aE, "Выполняется обработка");
    a.put(bxn.aF, "Запомнить карту");
    a.put(bxn.aG, "Запросить средства");
    a.put(bxn.aH, "<h1><strong>%s</strong></h1><p>Любые сведения, относящиеся к операции, будут переданы продавцу.</p><p>Для отмены согласия зайдите на сайт paypal.com, выберите <strong>Войти через PayPal</strong> в разделе <strong>Профиль</strong> и удалите данного продавца.</p><p>Компания PayPal не несет ответственности за действия или ошибки со стороны продавца.</p>");
    a.put(bxn.aI, "Сберегательный");
    a.put(bxn.aJ, "Отпр. средства");
    a.put(bxn.aK, "Была проблема связи с серверами PayPal. Повторите попытку.");
    a.put(bxn.aL, "Войдите в учетную запись PayPal заново.");
    a.put(bxn.aM, "Ваш сеанс истек");
    a.put(bxn.aN, "Адрес доставки");
    a.put(bxn.aO, "Впервые в PayPal? Зарегистрироваться");
    a.put(bxn.aP, "Не выходить из системы");
    a.put(bxn.aQ, "Системная ошибка (%s). Повторите попытку позже.");
    a.put(bxn.aR, "Повторить");
    a.put(bxn.aS, "Не удалось выполнить вход, так как для вашего счета включена процедура двухфакторной аутентификации.");
    a.put(bxn.aT, "Код безопасности карты");
    a.put(bxn.aU, "Отправьте SMS-сообщение на свой номер телефона. 6-значный код, который вы получили, будет действителен в течение 5 минут.");
    a.put(bxn.aV, "Отправка SMS-сообщения");
    a.put(bxn.aW, "Введите 6-значный код безопасности");
    a.put(bxn.aX, "Номер вашего мобильного телефона");
    a.put(bxn.aY, "Отправить SMS-сообщение");
    a.put(bxn.aZ, "Отправить SMS-сообщение еще раз");
    a.put(bxn.ba, "Не удалось выполнить вход, так как для вашего счета включена процедура двухфакторной аутентификации. Войдите на веб-сайт PayPal, чтобы активировать ваш ключ безопасности.");
    a.put(bxn.bb, "Платежи через данное устройство запрещены.");
    a.put(bxn.bc, "Неавторизованное устройство");
    a.put(bxn.bd, "Платежи данному продавцу не разрешены (недействительный код клиента).");
    a.put(bxn.be, "Недействительный продавец");
    a.put(bxn.bf, "При обработке платежа произошла ошибка. Повторите попытку.");
    a.put(bxn.bg, "Нераспознанный источник");
    a.put(bxn.bh, "Приносим извинения");
    a.put(bxn.bi, "Ваш заказ");
    a.put(bxn.bj, "Очистить данные карты?");
    a.put(bxn.bk, "Не удалось подтвердить согласие");
    a.put(bxn.bl, "Соединение не выполнено");
    a.put(bxn.bm, "Не удалось войти в систему");
    a.put(bxn.bn, "Войдите в систему при помощи пароля");
    a.put(bxn.bo, "Войдите в систему при помощи PIN-кода");
    a.put(bxn.bp, "Минуточку…");
    a.put(bxn.bq, "Не удалось выполнить платеж");
    a.put(bxn.br, "Сканирование");
    a.put(bxn.bs, "Неправильный код безопасности. Повторите попытку.");
    a.put(bxn.bt, "через");
    a.put(bxn.bu, "Системная ошибка. Повторите попытку позже.");
