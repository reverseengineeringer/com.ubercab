...
public final class bvf
{
  ...
  private static final String c = btk.class.getSimpleName() + "." + bvf.class.getSimpleName();
  ...
  public static btf a(Context paramContext)
  {
    btf localbtf = new btf();
    localbtf.a(paramContext.getPackageName());
    try
    {
      localbtf.b(getPackageManagergetPackageInfoa0versionName);
      return localbtf;
    }
  ...
  public static String a(Context paramContext, btj parambtj)
  {
    try
    {
      if ((Build.VERSION.SDK_INT >= 9) && (wd.a(paramContext) == 0))
      {
        if (Looper.myLooper() != Looper.getMainLooper()) {
          return AdvertisingIdClient.getAdvertisingIdInfo(paramContext).getId();
        }
        new Thread(new bvg(paramContext, parambtj)).start();
      }
    }
  ...
  public static String c()
  {
    ...
    try
    {
      ...
      localObject = str1;
      localbth.a(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Android/data/com.ebay.lid/");
      localObject = str1;
      str1 = localbth.b("fb.bin");
      String str2 = str1;
      localObject = str1;
      if ("".equals(str1.trim()))
      {
        ...
        localObject = str2;
        localbth.a("fb.bin", str2.getBytes("UTF-8"));
      }
      return str2;
    }
    catch (Exception localException) {}
