...
public final class bxw
{
  ...
  public bxw(Context paramContext)
  {
    ...
    bxa.b((View)localObject, null, null, null, "16dip");
    d = new TextView(paramContext);
    d.setTextSize(14.0F);
    d.setTextColor(bwz.l);
    d.setGravity(17);
    ((LinearLayout)localObject).addView(d, new LinearLayout.LayoutParams(-1, -2));
    bxa.b(d, null, "8dip", null, "4dip");
    b = new Button(paramContext);
    ((LinearLayout)localObject).addView(b);
    bxa.a(b);
    bxa.a(b, -2, "24dip");
    bxa.a(b, 17, 1.0F);
    h = bxa.a(paramContext, false, 42043, localLinearLayout);
    ...
    g.setVisibility(8);
    h.addView(g, new ViewGroup.LayoutParams(-2, (int)TypedValue.applyDimension(1, 22.0F, paramContext.getResources().getDisplayMetrics())));
    bxa.b(g, null, null, "4dip", null);
    bxa.b(g, "36dip", "25dip");
    e = new TextView(paramContext);
    bxa.a(e);
    e.setText("Pay with Card");
    h.addView(e, new ViewGroup.LayoutParams(-2, -2));
    k = new Button(paramContext);
    k.setId(42042);
    bxa.a(k);
    localLinearLayout.addView(k);
    bxa.b(k, null, null, null, "16dip");
    bxa.a(k, -2, -2);
    bxa.a(k, 17, 1.0F);
    i = new bxp(paramContext);
