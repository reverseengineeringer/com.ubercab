...
public final class aya
  implements amd
{
  protected static final boolean a = awr.b;
  private static int d = 3000;
  private static int e = 4096;
  protected final ayi b;
  protected final ayb c;
  
  public aya(ayi paramayi)
  {
    this(paramayi, new ayb(e));
  }
  
  private aya(ayi paramayi, ayb paramayb)
  {
    b = paramayi;
    c = paramayb;
  }
  ...
  private static void a(long paramLong, atg<?> paramatg, byte[] paramArrayOfByte, StatusLine paramStatusLine)
  {
    if ((a) || (paramLong > d)) {
    ...
    {
      awr.b("HTTP response for request=<%s> [lifetime=%d], [size=%s], [rc=%d], [retryCount=%s]", new Object[] { paramatg, Long.valueOf(paramLong), paramArrayOfByte, Integer.valueOf(paramStatusLine.getStatusCode()), Integer.valueOf(paramatg.k().b()) });
      return;
    }
  }
  
  private static void a(String paramString, atg<?> paramatg, awg paramawg)
  {
    avb localavb = paramatg.k();
    int i = paramatg.j();
    try
    {
      localavb.a(paramawg);
      paramatg.a(String.format("%s-retry [timeout=%s]", new Object[] { paramString, Integer.valueOf(i) }));
      return;
    }
    catch (awg paramawg)
    {
      paramatg.a(String.format("%s-timeout-giveup [timeout=%s]", new Object[] { paramString, Integer.valueOf(i) }));
      throw paramawg;
    }
  }
  
  private static void a(Map<String, String> paramMap, agc paramagc)
  {
    if (paramagc == null) {}
    do
    {
  ...
  {
    aeg localaeg = new aeg(c, (int)paramHttpEntity.getContentLength());
    ...
    try
    {
      ...
      for (;;)
      {
        ...
        localObject1 = arrayOfByte;
        localaeg.write(arrayOfByte, 0, i);
      }
      localObject1 = arrayOfByte;
      localObject4 = localaeg.toByteArray();
      try
      {
        paramHttpEntity.consumeContent();
        c.a(arrayOfByte);
      ...
      catch (IOException paramHttpEntity)
      {
        for (;;)
        {
          awr.a("Error occured when calling consumingContent", new Object[0]);
        }
      }
    }
    catch (IOException paramHttpEntity)
  ...
  /* Error */
  public final aqe a(atg<?> paramatg)
  {
    // Byte code:
    ...
    //   21: aload 5
    //   23: aload_1
    //   24: invokevirtual 231	atg:f	()Lagc;
    //   27: invokestatic 233	aya:a	(Ljava/util/Map;Lagc;)V
    //   30: aload_0
    //   31: getfield 42	aya:b	Layi;
    //   34: aload_1
    //   35: aload 5
    ...
    //   80: invokestatic 250	aya:a	([Lorg/apache/http/Header;)Ljava/util/Map;
    //   83: astore 9
    //   85: iload_2
    //   86: sipush 304
    //   89: if_icmpne +89 -> 178
    ...
    //   94: astore 5
    //   96: aload_1
    //   97: invokevirtual 231	atg:f	()Lagc;
    //   100: astore 7
    //   102: aload 7
    ...
    //   125: lload_3
    //   126: lsub
    //   127: invokespecial 255	aqe:<init>	(I[BLjava/util/Map;ZJ)V
    //   130: areturn
    //   131: aload 9
    //   133: astore 5
    //   135: aload 7
    //   137: getfield 259	agc:g	Ljava/util/Map;
    //   140: aload 9
    ...
    //   155: sipush 304
    //   158: aload 7
    //   160: getfield 266	agc:a	[B
    //   163: aload 7
    //   165: getfield 259	agc:g	Ljava/util/Map;
    //   168: iconst_1
    //   169: invokestatic 218	android/os/SystemClock:elapsedRealtime	()J
    //   172: lload_3
    //   173: lsub
    //   174: invokespecial 255	aqe:<init>	(I[BLjava/util/Map;ZJ)V
    //   177: areturn
    //   178: aload 9
    //   180: astore 5
    //   182: aload 6
    ...
    //   204: invokespecial 272	aya:a	(Lorg/apache/http/HttpEntity;)[B
    //   207: astore 7
    //   209: aload 7
    //   211: astore 5
    ...
    //   219: aload 5
    //   221: aload 8
    //   223: invokestatic 274	aya:a	(JLatg;[BLorg/apache/http/StatusLine;)V
    //   226: iload_2
    //   227: sipush 200
    ...
    //   254: new 279	avo
    //   257: dup
    //   258: invokespecial 280	avo:<init>	()V
    //   261: invokestatic 282	aya:a	(Ljava/lang/String;Latg;Lawg;)V
    //   264: goto -260 -> 4
    //   267: aload 9
    //   269: astore 5
    //   271: iconst_0
    ...
    //   296: lload_3
    //   297: lsub
    //   298: invokespecial 255	aqe:<init>	(I[BLjava/util/Map;ZJ)V
    //   301: astore 7
    //   303: aload 7
    //   305: areturn
    //   306: astore 5
    ...
    //   312: new 279	avo
    //   315: dup
    //   316: invokespecial 280	avo:<init>	()V
    //   319: invokestatic 282	aya:a	(Ljava/lang/String;Latg;Lawg;)V
    //   322: goto -318 -> 4
    //   325: astore 5
    ...
    //   341: aload_1
    //   342: invokevirtual 294	atg:d	()Ljava/lang/String;
    ...
    //   403: iconst_1
    //   404: aload_1
    //   405: invokevirtual 294	atg:d	()Ljava/lang/String;
    //   408: aastore
    //   409: invokestatic 308	awr:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   412: aload 8
    //   414: ifnull +76 -> 490
    //   417: new 252	aqe
    //   420: dup
    ...
    //   430: lload_3
    //   431: lsub
    //   432: invokespecial 255	aqe:<init>	(I[BLjava/util/Map;ZJ)V
    //   435: astore 5
    //   437: iload_2
    //   438: sipush 401
    ...
    //   458: dup
    //   459: aload 5
    //   461: invokespecial 315	aef:<init>	(Laqe;)V
    //   464: invokestatic 282	aya:a	(Ljava/lang/String;Latg;Lawg;)V
    //   467: goto -463 -> 4
    //   470: new 317	arv
    //   473: dup
    //   474: aload 6
    //   476: invokespecial 320	arv:<init>	(Ljava/lang/Throwable;)V
    //   479: athrow
    //   480: new 175	avc
    //   483: dup
    //   484: aload 5
    //   486: invokespecial 321	avc:<init>	(Laqe;)V
    //   489: athrow
    //   490: new 323	apj
    //   493: dup
    //   494: iconst_0
    //   495: invokespecial 326	apj:<init>	(B)V
    //   498: athrow
    //   499: astore 9
    //   501: aconst_null
    //   502: astore 8
