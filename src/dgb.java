...
public final class dgb
{
  ...
  public dgb(Application paramApplication, ctc paramctc)
  {
    a = paramApplication;
    b = paramctc;
  }
  ...
  public static VehicleInspectionStep a(blw paramblw, bmg parambmg)
  {
    parambmg = (Form)paramblw.a(parambmg.b("form"), Form.class);
    for (;;)
    {
      try
      {
        if (parambmg.getComponents().size() == 1)
        {
          VehicleInspectionComponent localVehicleInspectionComponent = (VehicleInspectionComponent)parambmg.getComponents().get(0);
          ...
          if (localVehicleInspection != null)
          {
            ...
            paramblw = localVehicleInspectionComponent.getTitle();
            localDisplay = localDisplay.setStepTitle(paramblw);
            if (localVehicleInspection.getTitle() != null)
            {
              paramblw = localVehicleInspection.getTitle();
              paramblw = localVehicleInspectionStep.setDisplay(localDisplay.setMainTitle(paramblw).setImageUrl(localVehicleInspectionComponent.getIcon())).setExtra(Extra.create().setRequiredDocumentId(localComponentOptions.getRequiredDocumentId()).setRequiredDocumentUuid(localComponentOptions.getRequiredDocumentUuid()).setVehicleUuid(localComponentOptions.getVehicleUuid()));
              paramblw.setStepType("vehicle_inspection");
              paramblw.setStepId("vehicle_inspection");
              parambmg = parambmg.getOptions();
              if (parambmg == null) {
                break label209;
              }
              paramblw.setContextualHelp(parambmg.getContextualHelp());
              paramblw.setLiveChat(parambmg.getLiveChat());
              break label209;
            }
            paramblw = "";
            continue;
      ...
      catch (NullPointerException paramblw) {}
      label209:
      return paramblw;
      label211:
      paramblw = "";
