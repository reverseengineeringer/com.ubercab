  ...
  extends aqs
{
  ...
  public aju(asq paramasq, String paramString)
  {
    e = paramasq;
    d = paramString;
  }
  ...
  public final void a()
  {
    ...
    for (;;)
    {
      ...
      catch (IndexOutOfBoundsException localIndexOutOfBoundsException1)
      {
        ...
        aqt.d("Error while parsing ping URL: " + (String)localObject1, localIndexOutOfBoundsException1);
        continue;
      }
      catch (IOException localIOException1)
      {
        aqt.d("Error while pinging URL: " + (String)localObject1, localIOException1);
        continue;
      }
      catch (RuntimeException localRuntimeException1)
      {
        aqt.d("Error while pinging URL: " + (String)localObject1, localRuntimeException1);
        continue;
        Object localObject4 = "";
        continue;
      }
      ...
      tp.e();
      aqz.a(e.getContext(), (Intent)localObject1);
      return;
      if (!"market".equalsIgnoreCase(((URL)localObject2).getProtocol()))
      {
        ...
        try
        {
          tp.e().a(e.getContext(), e.o().b, false, localHttpURLConnection);
          ...
          if ((j >= 300) && (j <= 399))
          {
            ...
            if (localMap.containsKey("Location"))
            {
              ...
              {
                aqt.d("Arrived at landing page, this ideally should not happen. Will open it in browser.");
