  ...
  extends byz
{
  ...
  public byy(bxd parambxd, bwy parambwy, bxg parambxg, String paramString1, String paramString2, String paramString3, ca paramca, Map paramMap, byx[] paramArrayOfbyx, String paramString4, boolean paramBoolean, String paramString5, String paramString6, String paramString7)
  {
    super(parambxd, parambwy, parambxg, paramString1);
    a = paramString3;
    b = paramca;
    c = paramMap;
    d = paramArrayOfbyx;
  ...
  public final String b()
  {
    ...
    for (;;)
    {
      ...
      if ((d != null) && (d.length > 0))
      {
        ...
        ((JSONObject)localObject2).accumulate("items", byx.a(d));
