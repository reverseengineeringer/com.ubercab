...
public final class ajh
{
  ...
  public static final aji b = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      ...
      PackageManager localPackageManager = paramAnonymousasq.getContext().getPackageManager();
      ...
      paramAnonymousasq.a("openableURLs", localHashMap);
    }
  };
  public static final aji c = new aji()
  {
    /* Error */
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      ...
      //   325: ldc -112
      //   327: aload 7
      //   329: invokestatic 149	aqt:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
      //   332: goto -50 -> 282
      //   335: iconst_0
      //   336: istore 4
      //   338: goto -66 -> 272
      ...
      //   343: ldc -105
      //   345: aload 7
      //   347: invokestatic 149	aqt:b	(Ljava/lang/String;Ljava/lang/Throwable;)V
      //   350: goto -68 -> 282
      //   353: aload_1
      //   354: ldc -118
      //   356: aload 6
  ...
  public static final aji d = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      ...
      try
      {
        Object localObject = paramAnonymousasq.n();
        if ((localObject == null) || (!((aff)localObject).a(paramAnonymousMap))) {
          break label117;
        }
        localObject = ((aff)localObject).a(paramAnonymousMap, paramAnonymousasq.getContext());
      ...
      new art(paramAnonymousasq.getContext(), ob, paramAnonymousMap).g();
    }
  };
  public static final aji e = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      paramAnonymousMap = paramAnonymousasq.i();
      if (paramAnonymousMap != null)
      {
        paramAnonymousMap.a();
        return;
      }
      paramAnonymousasq = paramAnonymousasq.j();
      if (paramAnonymousasq != null)
      {
        paramAnonymousasq.a();
        return;
      }
  ...
  public static final aji f = new aji()
  {
    private static void a(asq paramAnonymousasq)
    {
      ...
      try
      {
        ...
        paramAnonymousasq.b("appStreaming", localJSONObject);
        return;
      }
      catch (Throwable paramAnonymousasq) {}
    }
    ...
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      ...
      while (paramAnonymousasq.i() == null) {
        return;
      }
      pm.o();
    }
  };
  public static final aji g = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      paramAnonymousasq.b("1".equals(paramAnonymousMap.get("custom_close")));
    }
  };
  public static final aji h = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
  ...
  public static final aji i = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      aqt.c("Received log message: " + (String)paramAnonymousMap.get("string"));
    }
  };
  public static final aji j = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      ...
      try
      {
        ...
        paramAnonymousasq = paramAnonymousasq.n();
        if (paramAnonymousasq != null) {
          paramAnonymousasq.a().a(i, j, k);
        }
        return;
      }
      catch (NumberFormatException paramAnonymousasq)
      {
        aqt.d("Could not parse touch parameters from gmsg.");
      }
    }
  };
  public static final aji k = new aji()
  {
    public final void a(asq paramAnonymousasq, Map<String, String> paramAnonymousMap)
    {
      if (!((Boolean)agz.at.c()).booleanValue()) {
        return;
      }
      if (!Boolean.parseBoolean((String)paramAnonymousMap.get("disabled"))) {}
      for (boolean bool = true;; bool = false)
      {
        paramAnonymousasq.c(bool);
        return;
      }
    }
  };
  public static final aji l = new ajy();
  public static final aji m = new akc();
  public static final aji n = new ajg();
}
