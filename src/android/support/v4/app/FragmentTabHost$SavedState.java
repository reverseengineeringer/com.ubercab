  ...
  extends View.BaseSavedState
{
  ...
  {
    public final FragmentTabHost.SavedState createFromParcel(Parcel paramAnonymousParcel)
    {
      return new FragmentTabHost.SavedState(paramAnonymousParcel, null);
    }
    
    public final FragmentTabHost.SavedState[] newArray(int paramAnonymousInt)
    {
