...
class FragmentTransitionCompat21
{
  ...
  public static void addTransitionTargets(final Object paramObject1, Object paramObject2, View paramView1, final FragmentTransitionCompat21.ViewRetriever paramViewRetriever, final View paramView2, FragmentTransitionCompat21.EpicenterView paramEpicenterView, final Map<String, String> paramMap, final ArrayList<View> paramArrayList1, Map<String, View> paramMap1, final Map<String, View> paramMap2, ArrayList<View> paramArrayList2)
  {
  ...
  private static void setSharedElementEpicenter(Transition paramTransition, FragmentTransitionCompat21.EpicenterView paramEpicenterView)
  {
    if (paramTransition != null) {
      paramTransition.setEpicenterCallback(new Transition.EpicenterCallback()
      {
        ...
        public final Rect onGetEpicenter(Transition paramAnonymousTransition)
        {
          if ((mEpicenter == null) && (epicenter != null)) {
            mEpicenter = FragmentTransitionCompat21.getBoundsOnScreen(epicenter);
          }
          return mEpicenter;
        }
      });
