...
final class SwipeProgressBar
{
  ...
  final void draw(Canvas paramCanvas)
  {
    int i = mBounds.width();
  ...
  final void setColorScheme(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    mColor1 = paramInt1;
    mColor2 = paramInt2;
    mColor3 = paramInt3;
  ...
  final void setTriggerPercentage(float paramFloat)
  {
