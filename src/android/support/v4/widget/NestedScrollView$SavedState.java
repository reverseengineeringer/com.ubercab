  ...
  extends View.BaseSavedState
{
  ...
  {
    public final NestedScrollView.SavedState createFromParcel(Parcel paramAnonymousParcel)
    {
      return new NestedScrollView.SavedState(paramAnonymousParcel);
    }
    
    public final NestedScrollView.SavedState[] newArray(int paramAnonymousInt)
    {
