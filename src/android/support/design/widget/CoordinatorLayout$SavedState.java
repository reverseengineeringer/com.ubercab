  ...
  extends View.BaseSavedState
{
  ...
  {
    private static CoordinatorLayout.SavedState a(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
    {
      return new CoordinatorLayout.SavedState(paramAnonymousParcel, paramAnonymousClassLoader);
    }
    
    private static CoordinatorLayout.SavedState[] a(int paramAnonymousInt)
    {
