  ...
  implements Parcelable
{
  ...
  {
    private static ParcelableSparseArray a(Parcel paramAnonymousParcel, ClassLoader paramAnonymousClassLoader)
    {
      return new ParcelableSparseArray(paramAnonymousParcel, paramAnonymousClassLoader);
    }
    
    private static ParcelableSparseArray[] a(int paramAnonymousInt)
    {
