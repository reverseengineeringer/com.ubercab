  ...
  extends LinearLayoutCompat
{
  ...
  public ForegroundLinearLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, ao.ForegroundLinearLayout, paramInt, 0);
    f = paramContext.getInt(ao.ForegroundLinearLayout_android_foregroundGravity, f);
    paramAttributeSet = paramContext.getDrawable(ao.ForegroundLinearLayout_android_foreground);
    if (paramAttributeSet != null) {
      setForeground(paramAttributeSet);
    }
    a = paramContext.getBoolean(ao.ForegroundLinearLayout_foregroundInsidePadding, true);
