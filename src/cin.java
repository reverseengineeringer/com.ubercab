  ...
  extends chy
{
  ...
  private static int a(ContentResolver paramContentResolver, Uri paramUri)
  {
    ...
    //   0: aload_0
    //   1: aload_1
    //   2: getstatic 14	cin:b	[Ljava/lang/String;
    //   5: aconst_null
    //   6: aconst_null
    //   7: aconst_null
  ...
  private static cio a(int paramInt1, int paramInt2)
  {
  ...
  {
    paramcje = d;
    return ("content".equals(paramcje.getScheme())) && ("media".equals(paramcje.getAuthority()));
  }
  ...
  public final cji b(cje paramcje)
  {
    ...
    {
      localObject2 = a(h, i);
      if ((i == 0) && (localObject2 == cio.c))
      {
        return new cji(null, c(paramcje), ciy.b, k);
        i = 0;
      }
      else
      {
        ...
        a(h, i, e, f, localOptions, paramcje);
        if (i != 0) {
          if (localObject2 == cio.c) {
            i = j;
          }
        }
        for (localObject1 = MediaStore.Video.Thumbnails.getThumbnail((ContentResolver)localObject1, l, i, localOptions);; localObject1 = MediaStore.Images.Thumbnails.getThumbnail((ContentResolver)localObject1, l, d, localOptions))
        {
          ...
          return new cji((Bitmap)localObject1, null, ciy.b, k);
          i = d;
          break;
        }
      }
