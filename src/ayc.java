...
public final class ayc
  implements agb
{
  private final Map<String, ayd> a = new LinkedHashMap(16, 0.75F, true);
  private long b = 0L;
  private final File c;
  private final int d;
  
  private ayc(File paramFile)
  {
    c = paramFile;
    d = 5242880;
  }
  
  public ayc(File paramFile, byte paramByte)
  {
    this(paramFile);
  }
  ...
  private void a(int paramInt)
  {
    ...
    for (;;)
    {
      return;
      if (awr.b) {
        awr.a("Pruning old cache entries.", new Object[0]);
      }
      long l1 = b;
      ...
      {
        localayd = (ayd)((Map.Entry)localIterator.next()).getValue();
        if (d(b).delete())
        {
          b -= a;
      ...
      for (;;)
      {
        ...
        awr.a("pruned %d files, %d bytes, %d ms", new Object[] { Integer.valueOf(i), Long.valueOf(b - l1), Long.valueOf(SystemClock.elapsedRealtime() - l2) });
        return;
        awr.b("Could not delete cache entry for key=%s, filename=%s", new Object[] { b, c(b) });
        break label119;
        break;
      }
    }
  ...
  private void a(String paramString, ayd paramayd)
  {
    ...
    for (b += a;; b = (a - a + l))
    {
      a.put(paramString, paramayd);
      return;
      localayd = (ayd)a.get(paramString);
      l = b;
    }
  }
  ...
  private void b(String paramString)
  {
    try
    {
      ...
      e(paramString);
      if (!bool) {
        awr.b("Could not delete cache entry for key=%s, filename=%s", new Object[] { paramString, c(paramString) });
      }
      return;
    }
    finally {}
  ...
  {
    ayd localayd = (ayd)a.get(paramString);
    if (localayd != null)
    {
      b -= a;
  ...
  /* Error */
  public final agc a(String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 28	ayc:a	Ljava/util/Map;
    //   6: aload_1
    ...
    //   28: aload_0
    //   29: aload_1
    //   30: invokespecial 95	ayc:d	(Ljava/lang/String;)Ljava/io/File;
    //   33: astore 5
    //   35: new 267	aye
    //   38: dup
    ...
    //   48: iconst_0
    //   49: invokespecial 273	aye:<init>	(Ljava/io/InputStream;B)V
    //   52: astore_3
    //   53: aload_3
    //   54: astore_2
    //   55: aload_3
    //   56: invokestatic 276	ayd:a	(Ljava/io/InputStream;)Layd;
    //   59: pop
    //   60: aload_3
    //   61: astore_2
    //   62: aload 4
    ...
    //   70: aload_3
    //   71: invokestatic 281	aye:a	(Laye;)I
    //   74: i2l
    //   75: lsub
    //   76: l2i
    //   77: invokestatic 216	ayc:a	(Ljava/io/InputStream;I)[B
    //   80: invokevirtual 284	ayd:a	([B)Lagc;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_1
    //   88: aload_3
    //   89: invokevirtual 287	aye:close	()V
    //   92: goto -68 -> 24
    //   95: astore_1
    //   96: aconst_null
    //   97: astore_1
    ...
    //   129: aastore
    //   130: invokestatic 126	awr:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   133: aload_3
    //   134: astore_2
    //   135: aload_0
    //   136: aload_1
    //   137: invokespecial 295	ayc:b	(Ljava/lang/String;)V
    //   140: aload_3
    //   141: ifnull +7 -> 148
    //   144: aload_3
    //   145: invokevirtual 287	aye:close	()V
    //   148: aconst_null
    //   149: astore_1
    //   150: goto -126 -> 24
    //   153: astore_1
    ...
    //   163: ifnull +7 -> 170
    //   166: aload_2
    //   167: invokevirtual 287	aye:close	()V
    //   170: aload_1
    //   171: athrow
    //   172: astore_1
    //   173: aload_0
    ...
    //   54	113	2	localaye1	aye
    //   52	93	3	localaye2	aye
  ...
  public final void a()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 32	ayc:c	Ljava/io/File;
    //   6: invokevirtual 298	java/io/File:exists	()Z
    //   9: ifne +36 -> 45
    //   12: aload_0
    //   13: getfield 32	ayc:c	Ljava/io/File;
    ...
    //   30: iconst_0
    //   31: aload_0
    //   32: getfield 32	ayc:c	Ljava/io/File;
    //   35: invokevirtual 292	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   38: aastore
    //   39: invokestatic 305	awr:c	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   42: aload_0
    //   43: monitorexit
    //   44: return
    //   45: aload_0
    //   46: getfield 32	ayc:c	Ljava/io/File;
    ...
    //   98: astore_3
    //   99: aload 4
    //   101: invokestatic 276	ayd:a	(Ljava/io/InputStream;)Layd;
    //   104: astore 7
    //   106: aload 4
    //   108: astore_3
    //   109: aload 7
    ...
    //   116: putfield 102	ayd:a	J
    //   119: aload 4
    //   121: astore_3
    //   122: aload_0
    //   123: aload 7
    //   125: getfield 92	ayd:b	Ljava/lang/String;
    //   128: aload 7
    //   130: invokespecial 316	ayc:a	(Ljava/lang/String;Layd;)V
    //   133: aload 4
  ...
  /* Error */
  public final void a(String paramString, agc paramagc)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    //   2: aload_0
    //   3: aload_2
    //   4: getfield 323	agc:a	[B
    //   7: arraylength
    //   8: invokespecial 325	ayc:a	(I)V
    //   11: aload_0
    //   12: aload_1
    //   13: invokespecial 95	ayc:d	(Ljava/lang/String;)Ljava/io/File;
    //   16: astore_3
    ...
    //   31: aload_1
    //   32: aload_2
    //   33: invokespecial 330	ayd:<init>	(Ljava/lang/String;Lagc;)V
    //   36: astore 5
    //   38: aload 5
    //   40: aload 4
    //   42: invokevirtual 333	ayd:a	(Ljava/io/OutputStream;)Z
    //   45: ifne +61 -> 106
    //   48: aload 4
    ...
    //   66: aastore
    //   67: invokestatic 126	awr:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    //   99: aastore
    //   100: invokestatic 126	awr:b	(Ljava/lang/String;[Ljava/lang/Object;)V
    //   103: aload_0
    //   104: monitorexit
    //   105: return
    //   106: aload 4
    //   108: aload_2
    //   109: getfield 323	agc:a	[B
    ...
    //   121: aload_1
    //   122: aload 5
    //   124: invokespecial 316	ayc:a	(Ljava/lang/String;Layd;)V
    //   127: goto -24 -> 103
    //   130: astore_1
    //   131: aload_0
    //   132: monitorexit
