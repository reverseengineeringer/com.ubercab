  ...
  implements cav
{
  ...
  public cgc()
  {
    a.put(bxn.a, "Accetta e paga");
    a.put(bxn.b, "e altri");
    a.put(bxn.c, "Autenticazione…");
    a.put(bxn.d, "Prec.");
    a.put(bxn.e, "Di riserva");
    a.put(bxn.f, "Annulla");
    a.put(bxn.g, "American Express");
    a.put(bxn.h, "Carta Aura");
    a.put(bxn.i, "Carta Aurore");
    ...
    a.put(bxn.v, "Visa");
    a.put(bxn.w, "Modifica metodo di pagamento");
    a.put(bxn.x, "Conto corrente");
    a.put(bxn.y, "Controllo dispositivo…");
    a.put(bxn.z, "Rimuovi dati della carta");
    a.put(bxn.A, "Conferma");
    a.put(bxn.B, "Rimuovere i dati della carta?");
    a.put(bxn.C, "Addebita importo sulla carta");
    a.put(bxn.D, "Vuoi uscire da PayPal?");
    a.put(bxn.E, "Paga");
    a.put(bxn.F, "Accetta");
    a.put(bxn.G, "Data creazione conto");
    a.put(bxn.H, "Stato del conto");
    a.put(bxn.I, "Tipo di conto");
    a.put(bxn.J, "Indirizzo");
    a.put(bxn.K, "Fascia di età");
    a.put(bxn.L, "Data di nascita");
    a.put(bxn.M, "Indirizzo email");
    a.put(bxn.N, "Nome e cognome");
    a.put(bxn.O, "Sesso");
    a.put(bxn.P, "Lingua");
    a.put(bxn.Q, "Locale");
    a.put(bxn.R, "Telefono");
    a.put(bxn.S, "Fuso orario");
    a.put(bxn.T, "Condividi il seguente: %s.");
    a.put(bxn.U, "Usa Pagamento express.");
    a.put(bxn.V, "%s ti chiede di:");
    a.put(bxn.W, "Condividi i <a href='%1$s'>metodi di pagamento</a> collegati al tuo conto PayPal.");
    a.put(bxn.X, "Per effettuare una scelta, attiva la visualizzazione dei metodi di pagamento.");
    a.put(bxn.Y, "<a href='%1$s'>Autorizza l’addebito</a> dei prossimi acquisti effettuati su %2$s e pagati con PayPal. Autorizzi PayPal a pagare tutti gli importi richiesti da %3$s.");
    a.put(bxn.Z, "consentirgli di aggiungere e gestire la propria carta fedeltà nel tuo portafoglio PayPal.");
    a.put(bxn.aa, "Accettare l’<a href='%2$s'></a> Informativa sulla privacy<a href='%3$s'> e le</a> Condizioni d’uso di %1$s.");
    a.put(bxn.ab, "Consentirgli di <a href='%1$s'>richiedere denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(bxn.ac, "Consentirgli di <a href='%1$s'>inviare denaro</a> a tuo nome fino alla revoca del consenso.");
    a.put(bxn.ad, "Consenso");
    a.put(bxn.ae, "Email");
    a.put(bxn.af, "Dati di esempio");
    a.put(bxn.ag, "Sandbox");
    a.put(bxn.ah, "Scadenza");
    a.put(bxn.ai, "<h1><strong>Metodi di pagamento</strong></h1><p>PayPal condivide solo i tuoi metodi di pagamento disponibili per l’utilizzo.</p>");
    a.put(bxn.aj, "Password dimenticata?");
    a.put(bxn.ak, "Da");
    a.put(bxn.al, "Come vuoi pagare i prossimi acquisti su %1$s?");
    a.put(bxn.am, "<h1><strong>Consenso ai pagamenti preautorizzati</strong></h1><p>Gli importi dei prossimi pagamenti effettuati con PayPal da questa app verranno prelevati dal tuo metodo di pagamento predefinito.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona <strong>Profilo</strong> &gt; <strong>Sicurezza</strong> &gt; <strong>Log in con PayPal</strong> e rimuovi il commerciante dall’elenco.</p><p>Si applica la sezione Pagamenti automatici delle <a href='%s'>Condizioni d’uso PayPal</a>.</p><p>Per verificare il funzionamento dell’addebito dei pagamenti futuri sul tuo conto PayPal, questa app potrebbe simulare una transazione di prova, senza un reale trasferimento di denaro.</p>");
    a.put(bxn.an, "Errore interno");
    a.put(bxn.ao, "<p>Cliccando il pulsante di seguito, accetto le <a href='%1$s'>Condizioni d’uso PayPal</a> e dichiaro di rispettare le leggi e normative del Giappone, tra cui le sanzioni previste per i pagamenti alla Corea del Nord e all’Iran in base al <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> (Legge sugli scambi e sul commercio estero), per completare la transazione.</p>");
    a.put(bxn.ap, "Accedi");
    a.put(bxn.aq, "Log in con PayPal");
    a.put(bxn.ar, "Esci");
    a.put(bxn.as, "Esci");
    a.put(bxn.at, "OK");
    a.put(bxn.au, "Password");
    a.put(bxn.av, "Paga dopo la consegna");
    a.put(bxn.aw, "Paga con");
    a.put(bxn.ax, "Paga con una carta");
    a.put(bxn.ay, "Saldo PayPal");
    a.put(bxn.az, "PayPal Credit");
    a.put(bxn.aA, "Telefono");
    a.put(bxn.aB, "PIN");
    a.put(bxn.aC, "Metodo di pagamento preferito");
    a.put(bxn.aD, "PayPal protegge la tua <a href='%s'>privacy</a> e i tuoi dati.");
    a.put(bxn.aE, "Elaborazione in corso");
    a.put(bxn.aF, "Ricorda dati carta");
    a.put(bxn.aG, "Richiedi denaro");
    a.put(bxn.aH, "<h1><strong>%s</strong></h1><p>Tutti i dettagli rilevanti della transazione verranno condivisi con il commerciante.</p><p>Per annullare il consenso, accedi al tuo conto PayPal, seleziona l’icona <strong>Profilo</strong> &gt; Sicurezza &gt; <strong>Log in con PayPal</strong> e rimuovi questo commerciante.</p><p>PayPal non è responsabile di azioni o errori da parte del Partner.</p>");
    a.put(bxn.aI, "Conto corrente");
    a.put(bxn.aJ, "Invia denaro");
    a.put(bxn.aK, "Si è verificato un problema con i nostri server. Riprova.");
    a.put(bxn.aL, "Ripeti l’accesso a PayPal.");
    a.put(bxn.aM, "Sessione scaduta");
    a.put(bxn.aN, "Indirizzo di spedizione");
    a.put(bxn.aO, "Non hai un conto PayPal? Registrati");
    a.put(bxn.aP, "Rimani collegato");
    a.put(bxn.aQ, "Errore di sistema (%s). Riprova più tardi.");
    a.put(bxn.aR, "Riprova");
    a.put(bxn.aS, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione.");
    a.put(bxn.aT, "Codice di sicurezza");
    a.put(bxn.aU, "Ricevi un SMS sul tuo telefono. Il codice a 6 cifre sarà valido per 5 minuti.");
    a.put(bxn.aV, "Invio SMS in corso");
    a.put(bxn.aW, "Immetti il codice di sicurezza a 6 cifre");
    a.put(bxn.aX, "Numero di cellulare");
    a.put(bxn.aY, "Ricevi SMS");
    a.put(bxn.aZ, "Ricevi un altro SMS");
    a.put(bxn.ba, "Impossibile effettuare l’accesso perché sul tuo conto è attiva la doppia autenticazione. Visita il sito PayPal per attivare la chiave di accesso.");
    a.put(bxn.bb, "Pagamenti da questo dispositivo non consentiti.");
    a.put(bxn.bc, "Dispositivo non autorizzato");
    a.put(bxn.bd, "I pagamenti a questo venditore non sono consentiti (clientId non valido).");
    a.put(bxn.be, "Sito non valido");
    a.put(bxn.bf, "Si è verificato un problema durante l’elaborazione del pagamento. Riprova.");
    a.put(bxn.bg, "Metodo non riconosciuto");
    a.put(bxn.bh, "Spiacenti");
    a.put(bxn.bi, "Il tuo ordine");
    a.put(bxn.bj, "Rimuovere la carta?");
    a.put(bxn.bk, "Consenso non riuscito");
    a.put(bxn.bl, "Connessione non riuscita");
    a.put(bxn.bm, "Accesso non riuscito");
    a.put(bxn.bn, "Accedi con la password");
    a.put(bxn.bo, "Accedi con il PIN");
    a.put(bxn.bp, "Attendi…");
    a.put(bxn.bq, "Pagamento non riuscito");
    a.put(bxn.br, "Scansione");
    a.put(bxn.bs, "Codice di sicurezza errato. Riprova.");
    a.put(bxn.bt, "tramite");
    a.put(bxn.bu, "Errore di sistema. Riprova più tardi.");
