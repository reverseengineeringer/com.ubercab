  ...
  implements axm
{
  ...
  public static axm a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof axm))) {
      return (axm)localIInterface;
    }
    return new axo(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    boolean bool = a(azs.a(paramParcel1.readStrongBinder()));
