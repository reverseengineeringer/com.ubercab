  ...
  implements byp
{
  ...
  public cad()
  {
    ...
    a.put(bvh.Z, "Allow them to link and manage their loyalty card in your PayPal wallet.");
    ...
    a.put(bvh.aU, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(bvh.aV, "Sending SMS");
    a.put(bvh.aW, "Enter the 6-digit security code");
    a.put(bvh.aX, "Your mobile number");
    a.put(bvh.aY, "Send SMS");
    a.put(bvh.aZ, "Send SMS Again");
