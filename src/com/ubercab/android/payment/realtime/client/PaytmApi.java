...
public abstract interface PaytmApi
{
  ...
  public abstract kld<PaytmDepositRequestResponse> depositRequest(@Path("id") String paramString1, @Query("amount") String paramString2, @Query("currency_code") String paramString3);
  
  @GET("/rt/payment/paytm/payment_profiles/{payment_profile_uuid}/user-details")
  public abstract kld<PaytmUserDetails> getUserDetails(@Path("payment_profile_uuid") String paramString);
}
