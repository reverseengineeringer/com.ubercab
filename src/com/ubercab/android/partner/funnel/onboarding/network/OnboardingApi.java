...
public abstract interface OnboardingApi
{
  ...
  public abstract kld<OnboardingForm> postOnboardingForm(@Header("X-Uber-Df-Variant") String paramString1, @Path("driverUUID") String paramString2, @Body Map<String, Object> paramMap);
  
  @GET("/rt/onboarding/dynamic-form/step/{driverUUID}")
  public abstract kld<OnboardingForm> requestNextForm(@Header("X-Uber-Df-Variant") String paramString1, @Path("driverUUID") String paramString2);
}
