...
public abstract interface SeatbeltApi
{
  ...
  public abstract void singleTrip(@Path("uuid") String paramString1, @Query("user_type") String paramString2, @Query("token") String paramString3, Callback<TripSummary> paramCallback);
  ...
  public abstract kld<SupportTree> supportHome(@Query("device_type") String paramString1, @Query("user_type") String paramString2, @Query("locale") String paramString3);
  
  @GET("/support/support-home")
  public abstract kld<SupportTree> supportHome(@Query("device_type") String paramString1, @Query("user_type") String paramString2, @Query("locale") String paramString3, @Query("latitude") double paramDouble1, @Query("longitude") double paramDouble2);
  ...
  public abstract void supportNode(@Path("uuid") String paramString1, @Query("locale") String paramString2, Callback<SupportNode> paramCallback);
  ...
  public abstract kld<TripHistory> tripHistory(@Path("uuid") String paramString1, @Query("user_type") String paramString2, @Query("token") String paramString3, @Query("offset") int paramInt1, @Query("limit") int paramInt2);
  
  @GET("/support/users/{uuid}/trips")
  public abstract void tripHistory(@Path("uuid") String paramString1, @Query("user_type") String paramString2, @Query("token") String paramString3, @Query("offset") int paramInt1, @Query("limit") int paramInt2, Callback<TripHistory> paramCallback);
