  ...
  public void onItemClick(int paramInt)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        localObject1 = ((Cursor)localObject1).getString(((Cursor)localObject1).getColumnIndex("data1"));
        break;
...
/* Location:
 * Qualified Name:     com.ubercab.client.feature.safetynet.SafetyNetConfiguredShareTripFragment
