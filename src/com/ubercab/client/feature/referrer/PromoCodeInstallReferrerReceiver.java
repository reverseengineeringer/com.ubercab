...
public class PromoCodeInstallReferrerReceiver
  extends BroadcastReceiver
{
  ...
  public void onReceive(Context paramContext, Intent paramIntent)
  {
    ...
    if (!TextUtils.isEmpty(paramIntent))
    {
      ...
      if (!TextUtils.isEmpty(paramIntent)) {
        huf.a(paramContext, paramIntent);
      }
    }
  }
}
...
/* Location:
 * Qualified Name:     com.ubercab.client.feature.referrer.PromoCodeInstallReferrerReceiver
