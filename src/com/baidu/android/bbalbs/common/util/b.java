...
public final class b
{
  ...
  {
    // Byte code:
    //   0: new 44	java/io/FileReader
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 47	java/io/FileReader:<init>	(Ljava/io/File;)V
    //   8: astore_2
    //   9: aload_2
    //   10: astore_0
    //   11: sipush 8192
    ...
    //   17: aload_2
    //   18: astore_0
    //   19: new 49	java/io/CharArrayWriter
    //   22: dup
    //   23: invokespecial 50	java/io/CharArrayWriter:<init>	()V
    //   26: astore 4
    //   28: aload_2
    //   29: astore_0
    //   30: aload_2
    //   31: aload_3
    //   32: invokevirtual 54	java/io/FileReader:read	([C)I
    //   35: istore_1
    //   36: iload_1
    //   37: ifle +33 -> 70
    //   40: aload_2
    ...
    //   45: iconst_0
    //   46: iload_1
    //   47: invokevirtual 58	java/io/CharArrayWriter:write	([CII)V
    //   50: goto -22 -> 28
    //   53: astore_3
    //   54: aload_2
    //   55: astore_0
    //   56: aload_3
    //   57: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   60: aload_2
    //   61: ifnull +7 -> 68
    //   64: aload_2
    //   65: invokevirtual 64	java/io/FileReader:close	()V
    //   68: aconst_null
    //   69: areturn
    //   70: aload_2
    //   71: astore_0
    //   72: aload 4
    //   74: invokevirtual 67	java/io/CharArrayWriter:toString	()Ljava/lang/String;
    //   77: astore_3
    //   78: aload_2
    //   79: invokevirtual 64	java/io/FileReader:close	()V
    //   82: aload_3
    //   83: areturn
    //   84: astore_0
    //   85: aload_0
    //   86: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   89: aload_3
    //   90: areturn
    //   91: astore_0
    //   92: aload_0
    //   93: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   96: aconst_null
    //   97: areturn
    //   98: astore_2
    //   99: aconst_null
    ...
    //   111: astore_0
    //   112: aload_0
    //   113: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   116: goto -7 -> 109
    //   119: astore_2
    //   120: goto -19 -> 101
    //   123: astore_3
  ...
  private List<b.a> a(Intent paramIntent, boolean paramBoolean)
  {
        ...
        if ((activityInfo != null) && (activityInfo.applicationInfo != null)) {
          for (;;)
          {
            try
            {
              ...
              byte[] arrayOfByte = com.baidu.android.bbalbs.common.a.b.a(((String)localObject1).getBytes("utf-8"));
              Object localObject4 = new JSONObject(new String(arrayOfByte));
              localObject1 = new b.a(null);
              ...
              if (paramBoolean)
              {
                ...
                if (!TextUtils.isEmpty((CharSequence)localObject2))
                {
                  ...
                  {
                    localObject2 = a(com.baidu.android.bbalbs.common.a.b.a(((String)localObject2).getBytes()), c);
    ...
    Collections.sort(localArrayList, new c(this));
  ...
  private void a()
  {
    ...
    //   5: dup
    //   6: invokestatic 291	com/baidu/android/bbalbs/common/util/a:a	()[B
    ...
    //   27: putfield 256	com/baidu/android/bbalbs/common/util/b:c	Ljava/security/PublicKey;
    //   30: aload_1
    //   31: invokevirtual 311	java/io/ByteArrayInputStream:close	()V
    //   34: return
    //   35: astore_1
    //   36: aload_1
    //   37: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   40: return
    //   41: astore_1
    //   42: aconst_null
    //   43: astore_1
    ...
    //   53: astore_1
    //   54: aload_1
    //   55: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   58: return
    //   59: astore_1
    //   60: aload_2
    //   61: ifnull +7 -> 68
    ...
    //   70: astore_2
    //   71: aload_2
    //   72: invokestatic 61	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/Throwable;)V
    //   75: goto -7 -> 68
    //   78: astore_3
    //   79: aload_1
    //   80: astore_2
  ...
  private b.b b()
  {
    ...
    for (;;)
    {
      ...
      for (localObject1 = b.b.a(f(a((File)localObject1)));; localObject1 = null)
      {
        ...
        for (Object localObject3 = ((File)localObject2).getName();; localObject3 = "files")
        {
          ...
          {
            localObject2 = b.b.a(f(a((File)localObject2)));
          ...
          {
            break;
            localObject1 = (b.a)((List)localObject1).get(0);
            bool = c;
            if (c) {
              break label996;
            }
            ...
            localObject2 = localObject1;
            if (localObject1 == null) {
              localObject2 = b.b.a(f(b("com.baidu.deviceid.v2")));
            }
            ...
            for (;;)
            {
              ...
              for (i = 1;; i = j)
              {
                ...
                for (;;)
                {
                  ...
                  for (localObject1 = e(((b.b)localObject3).a());; localObject1 = null)
                  {
                    ...
                    if (bool) {
                      ...
                      else
                      {
                        localObject2 = localObject1;
                        if (TextUtils.isEmpty((CharSequence)localObject1)) {
                          localObject2 = e(((b.b)localObject3).a());
                        }
                    ...
                    if (c("android.permission.WRITE_EXTERNAL_STORAGE"))
                    {
                      ...
                      if (((b & 0x8) != 0) || (!((File)localObject1).exists()))
                      {
                        localObject1 = localObject2;
                        if (TextUtils.isEmpty((CharSequence)localObject2)) {
                          localObject1 = e(((b.b)localObject3).a());
                        }
  ...
  private static void b(String paramString1, String paramString2)
  {
    ...
    try
    {
      ...
      paramString1.write(com.baidu.android.bbalbs.common.a.b.a(a.a("30212102dicudiab", "30212102dicudiab", localStringBuilder.toString().getBytes()), "utf-8"));
      paramString1.flush();
      paramString1.close();
      return;
    }
  ...
  private b.b d()
  {
    ...
    {
      localObject2 = b(a);
      localObject2 = b(com.baidu.android.bbalbs.common.a.c.a(("com.baidu" + (String)localObject1 + (String)localObject2).getBytes(), true));
    }
    if (!TextUtils.isEmpty((CharSequence)localObject2))
    {
      localObject3 = new b.b(null);
  ...
  /* Error */
  private b.b d(String paramString)
  {
    // Byte code:
    //   0: iconst_1
    //   1: istore_3
    ...
    //   75: dup
    //   76: new 44	java/io/FileReader
    //   79: dup
    //   80: aload 4
    //   82: invokespecial 47	java/io/FileReader:<init>	(Ljava/io/File;)V
    ...
    //   134: astore 5
    //   136: aload 6
    //   138: invokestatic 178	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   141: ifne +172 -> 313
    //   144: new 36	com/baidu/android/bbalbs/common/util/b$b
    //   147: dup
    //   148: aconst_null
    //   149: invokespecial 450	com/baidu/android/bbalbs/common/util/b$b:<init>	(Lcom/baidu/android/bbalbs/common/util/c;)V
    //   152: astore_1
    //   153: aload_1
    //   154: aload 6
    //   156: putfield 471	com/baidu/android/bbalbs/common/util/b$b:a	Ljava/lang/String;
    //   159: aload_1
    //   160: aload 5
    //   162: putfield 473	com/baidu/android/bbalbs/common/util/b$b:b	Ljava/lang/String;
    //   165: aload_1
    //   166: areturn
    //   167: aload 4
    //   169: invokevirtual 608	java/io/BufferedReader:close	()V
    //   172: new 85	java/lang/String
    //   175: dup
    //   176: ldc_w 555
    //   179: ldc_w 555
    //   182: aload 5
    //   184: invokevirtual 99	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   187: invokevirtual 254	java/lang/String:getBytes	()[B
    //   190: invokestatic 189	com/baidu/android/bbalbs/common/a/b:a	([B)[B
    //   193: invokestatic 610	com/baidu/android/bbalbs/common/a/a:b	(Ljava/lang/String;Ljava/lang/String;[B)[B
    //   196: invokespecial 194	java/lang/String:<init>	([B)V
    //   199: ldc_w 517
    ...
    //   226: iconst_0
    //   227: aaload
    //   228: invokevirtual 219	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   231: ifeq +54 -> 285
    //   234: aload 5
    //   236: iconst_1
    //   237: aaload
    ...
    //   257: aload 4
    //   259: aload_1
    //   260: invokestatic 503	com/baidu/android/bbalbs/common/util/b:b	(Ljava/lang/String;Ljava/lang/String;)V
    //   263: aload_1
    //   264: astore 6
    //   266: aload 4
    //   268: astore 5
    ...
    //   290: astore 4
    //   292: aload_1
    //   293: invokestatic 178	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   296: ifeq +9 -> 305
    //   299: aload 5
    //   301: iconst_1
    //   302: aaload
  ...
  private b.b e()
  {
    ...
    if (((File)localObject).exists())
    {
      ...
      if (!TextUtils.isEmpty((CharSequence)localObject)) {
        try
        {
          localObject = b.b.a(new String(a.b("30212102dicudiab", "30212102dicudiab", com.baidu.android.bbalbs.common.a.b.a(((String)localObject).getBytes()))));
  ...
  private static String e(String paramString)
  {
    ...
    try
    {
      paramString = com.baidu.android.bbalbs.common.a.b.a(a.a("30212102dicudiab", "30212102dicudiab", paramString.getBytes()), "utf-8");
      return paramString;
    }
  ...
  private static String f(String paramString)
  {
    ...
    try
    {
      paramString = new String(a.b("30212102dicudiab", "30212102dicudiab", com.baidu.android.bbalbs.common.a.b.a(paramString.getBytes())));
      return paramString;
    }
    catch (Exception paramString)
    {
...
/* Location:
 * Qualified Name:     com.baidu.android.bbalbs.common.util.b
