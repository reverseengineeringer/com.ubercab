...
public final class d
{
  ...
  private d()
  {
    ...
    f = new f(g.a());
    i = new c(this, g.a());
    h = new g(this, g.a(), i.n());
  }
  
  private BDLocation a(final String[] paramArrayOfString)
  {
    new BDLocation();
  ...
  private boolean r()
  {
    ...
    Object localObject = c.getPackageManager().resolveContentProvider(b, 0);
    if (localObject == null)
    {
      String[] arrayOfString = i.o();
      int j = 0;
      while (j < arrayOfString.length)
      {
        ProviderInfo localProviderInfo = c.getPackageManager().resolveContentProvider(arrayOfString[j], 0);
    ...
    return (localObject == null) || (str.equals(packageName));
  }
  ...
  public final BDLocation a(a parama, i parami, BDLocation paramBDLocation, d.b paramb, d.a parama1)
  {
    int j;
    if (paramb == d.b.a)
    {
      j = i.a();
      paramb = com.baidu.location.i.c.a().d() + "&mixMode=1";
      if (parama1 != d.a.a) {
        break label115;
      }
    }
    ...
    {
      parami = e.a(parama, parami, paramBDLocation, paramb, parama1.booleanValue(), j);
      parama = null;
      if (parami.length > 0)
      {
        parami = a(parami);
      ...
      return parama;
      paramb = com.baidu.location.i.c.a().d();
      j = 0;
      break;
    }
  }
