...
final class f
{
  ...
  f(SQLiteDatabase paramSQLiteDatabase)
  {
    ...
    try
    {
      b.execSQL("CREATE TABLE IF NOT EXISTS LOG(timestamp LONG PRIMARY KEY, log VARCHAR(4000))");
      return;
    }
  ...
  private void a(boolean paramBoolean)
  {
    ...
    if ((paramBoolean) && (a != null)) {
      str = String.format("DELETE FROM LOG WHERE timestamp in (%s);", new Object[] { a });
    }
    try
    {
      if (a.length() > 0) {
  ...
  private String b()
  {
    ...
    //   27: astore 8
    //   29: aload_0
    //   30: getfield 51	com/baidu/location/e/f:b	Landroid/database/sqlite/SQLiteDatabase;
    //   33: getstatic 40	com/baidu/location/e/f:e	Ljava/lang/String;
    //   36: aconst_null
    ...
    //   214: putfield 49	com/baidu/location/e/f:a	Ljava/lang/String;
    //   217: aload_1
    //   218: astore 4
    //   220: aload_2
    //   221: ifnull -40 -> 181
    ...
    //   27	174	8	localJSONObject	org.json.JSONObject
    // Exception table:
    //   from	to	target	type
