  ...
  extends ViewGroup
{
  ...
  private com.baidu.platform.comapi.map.g b;
  private BaiduMap c;
  private ImageView d;
  private Bitmap e;
  ...
  private ImageView l;
  private float n;
  private com.baidu.platform.comapi.map.i o;
  ...
  private void b(Context paramContext)
  {
    ...
    f.setOnZoomOutClickListener(new h(this));
    f.setOnZoomInClickListener(new i(this));
    addView(f);
  }
  ...
  private void b(Context paramContext, BaiduMapOptions paramBaiduMapOptions)
  {
    ...
    for (b = new com.baidu.platform.comapi.map.g(paramContext, null);; b = new com.baidu.platform.comapi.map.g(paramContext, paramBaiduMapOptions.a()))
    {
      addView(b);
      o = new g(this);
      b.a().a(o);
  ...
  protected final void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (paramInt1 < paramInt3)
    {
      ...
      for (Object localObject = b;; localObject = b.a().a((GeoPoint)localObject))
      {
        a(localView);
