  ...
  extends MethodVisitor
{
    ...
    if (paramInt1 < paramInt2)
    {
      ...
      if (i1 == 0)
      {
        ...
        for (;;)
        {
          paramInt1 += 1;
          break;
          v.putByte(7).putShort(b.newClass(b.H[i1].g));
          continue;
          v.putByte(8).putShort(b.H[i1].c);
        }
      }
      ...
      if ((i2 & 0xFF00000) == 24117248)
      {
        ...
        localStringBuffer.append(b.H[(i2 & 0xFFFFF)].g);
        localStringBuffer.append(';');
      }
      for (;;)
      {
  ...
  private void c()
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        {
        default: 
          v.putByte(255).putShort(i5).putShort(i8);
          a(3, i8 + 3);
          v.putShort(i10);
          a(i8 + 3, i8 + 3 + i10);
          return;
      ...
      a(i8 + 3, i8 + 4);
      return;
      v.putByte(247).putShort(i5);
      a(i8 + 3, i8 + 4);
      return;
      v.putByte(251).putShort(i5);
      return;
      v.putByte(i2 + 251).putShort(i5);
      return;
      v.putByte(i2 + 251).putShort(i5);
      a(i3 + 3, i8 + 3);
      return;
  ...
  final void a(ByteVector paramByteVector)
  {
    ...
    if (h != 0)
    {
      paramByteVector.putByteArray(b.M.b, h, i);
      return;
    }
    if (r.b > 0) {}
    for (int i2 = 1;; i2 = 0)
  ...
  {
    paramString1 = b.a(paramString1, paramString2, paramHandle, paramVarArgs);
    int i2 = c;
    if (P != null)
    {
      if (M != 0) {
    ...
    for (;;)
    {
      ...
      while (localObject1 != null)
      {
        ...
        if ((a & 0x40) == 0)
        {
          ...
          paramInt1 = y;
          y = (paramInt1 + 1);
          localObject3[paramInt1] = (b.c("java/lang/Throwable") | 0x1700000);
          b();
          B = Handler.a(B, (Label)localObject1, (Label)localObject2);
        }
        localObject1 = i;
        paramInt1 = paramInt2;
      }
        ...
        if (L > 0)
        {
          ...
          for (paramInt2 = 0; localObject1 != null; paramInt2 = i1)
          {
            ...
            if ((a & 0x80) != 0)
            {
              ...
              {
                i1 = paramInt2 + 1;
                ((Label)localObject2).b(null, i1 / 32L << 32 | 1L << i1 % 32, L);
              }
            }
            localObject1 = i;
          }
      ...
      for (;;)
      {
        ...
        for (;;)
        {
          ...
          for (;;)
          {
            ...
            break label1104;
            break;
            s = Math.max(paramInt1, paramInt2);
            return;
            s = paramInt1;
            t = paramInt2;
            return;
  ...
  public void visitMethodInsn(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      paramString1 = b.a(paramString1, paramString2, paramString3, bool);
      i2 = c;
      i1 = i2;
      if (P != null)
      {
  ...
  public void visitTableSwitchInsn(int paramInt1, int paramInt2, Label paramLabel, Label... paramVarArgs)
  {
    ...
    {
      paramVarArgs[paramInt1].a(this, r, i2, true);
      paramInt1 += 1;
    }
