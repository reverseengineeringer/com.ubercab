...
public final class aoa
{
  ...
  private aoa(ByteBuffer paramByteBuffer)
  {
    a = paramByteBuffer;
    a.order(ByteOrder.LITTLE_ENDIAN);
  }
  
  private aoa(byte[] paramArrayOfByte, int paramInt)
  {
  ...
  public static aoa a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, paramArrayOfByte.length);
  }
  
  private static aoa a(byte[] paramArrayOfByte, int paramInt)
  {
    return new aoa(paramArrayOfByte, paramInt);
  }
  
  private void a(byte paramByte)
  {
    if (!a.hasRemaining()) {
      throw new aob(a.position(), a.limit());
    }
    a.put(paramByte);
  }
  ...
  public static int b(int paramInt, aoi paramaoi)
  {
    return h(paramInt) * 2 + c(paramaoi);
  }
  ...
  private void b(String paramString)
  {
    ...
    try
    {
      ...
      j = a.position();
      if (a.remaining() < i) {
        throw new aob(i + j, a.limit());
      }
    }
    catch (BufferOverflowException paramString)
    {
      aob localaob = new aob(a.position(), a.limit());
      localaob.initCause(paramString);
      throw localaob;
    }
    a.position(j + i);
    a(paramString, a);
  ...
  public static int c(int paramInt, aoi paramaoi)
  {
    return h(paramInt) + d(paramaoi);
  }
  ...
  private static int c(aoi paramaoi)
  {
    return paramaoi.d();
  }
  ...
  private static int d(aoi paramaoi)
  {
    int i = paramaoi.d();
    return i + e(i);
  }
  ...
  public final void a(int paramInt, aoi paramaoi)
  {
    c(paramInt, 2);
    b(paramaoi);
  }
  ...
  public final void b(aoi paramaoi)
  {
    d(paramaoi.c());
    paramaoi.a(this);
  }
