...
final class cka
{
  ...
  static int a(Resources paramResources, cjk paramcjk)
  {
    if ((e != 0) || (d == null)) {
      return e;
    }
    ...
    if (localList.size() == 2)
    {
      paramcjk = (String)localList.get(0);
      return paramResources.getIdentifier((String)localList.get(1), paramcjk, str);
    }
  ...
  static int a(Bitmap paramBitmap)
  {
    ...
    for (int i = ckc.a(paramBitmap); i < 0; i = paramBitmap.getRowBytes() * paramBitmap.getHeight()) {
  ...
  static Resources a(Context paramContext, cjk paramcjk)
  {
    if ((e != 0) || (d == null)) {
  ...
  static cik a(Context paramContext)
  {
    try
    {
      ...
      cik localcik = ckd.a(paramContext);
      return localcik;
    }
    catch (ClassNotFoundException localClassNotFoundException) {}
    return new cjy(paramContext);
  }
  ...
  static String a(chz paramchz)
  {
    return a(paramchz, "");
  }
  
  static String a(chz paramchz, String paramString)
  {
  ...
  static String a(cjk paramcjk)
  {
    paramcjk = a(paramcjk, a);
    a.setLength(0);
    return paramcjk;
  }
  
  static String a(cjk paramcjk, StringBuilder paramStringBuilder)
  {
    if (f != null)
    {
      ...
      if (paramcjk.d())
      {
        paramStringBuilder.append("resize:").append(h).append('x').append(paramcjk.i);
        paramStringBuilder.append('\n');
      }
      if (!paramcjk.j) {
        break label273;
    ...
    for (;;)
    {
      ...
      while (i < j)
      {
        paramStringBuilder.append(((cjx)g.get(i)).a());
        paramStringBuilder.append('\n');
        i += 1;
      }
      if (d != null)
  ...
  static int c(Context paramContext)
  {
    ...
    label63:
    for (int i = ckb.a(localActivityManager);; i = j)
    {
      return i * 1048576 / 7;
      i = 0;
      break;
