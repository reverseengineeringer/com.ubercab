  ...
  implements byp
{
  ...
  public byq()
  {
    a.put(bvh.a, "الموافقة والدفع");
    a.put(bvh.b, "وغير ذلك");
    a.put(bvh.c, "جارِ المصادقة");
    a.put(bvh.d, "عودة");
    a.put(bvh.e, "الاحتياطية");
    a.put(bvh.f, "إلغاء");
    ...
    a.put(bvh.v, "Visa‏");
    a.put(bvh.w, "تغيير طريقة الدفع");
    a.put(bvh.x, "حساب جاري");
    a.put(bvh.y, "جار فحص هذا الجهاز…");
    a.put(bvh.z, "مسح معلومات البطاقة");
    a.put(bvh.A, "تأكيد");
    a.put(bvh.B, "هل تريد بالفعل مسح معلومات بطاقتك؟");
    a.put(bvh.C, "بطاقة الدفع الآجل");
    a.put(bvh.D, "هل تريد بالفعل تسجيل الخروج من باي بال؟");
    a.put(bvh.E, "دفع");
    a.put(bvh.F, "موافقة");
    a.put(bvh.G, "تاريخ إنشاء الحساب");
    a.put(bvh.H, "حالة الحساب");
    a.put(bvh.I, "نوع الحساب");
    a.put(bvh.J, "العنوان");
    a.put(bvh.K, "الفئة العمرية");
    a.put(bvh.L, "تاريخ الميلاد");
    a.put(bvh.M, "عنوان البريد الإلكتروني");
    a.put(bvh.N, "الاسم بالكامل");
    a.put(bvh.O, "الجنس");
    a.put(bvh.P, "اللغة");
    a.put(bvh.Q, "اللغة المحلية");
    a.put(bvh.R, "الهاتف");
    a.put(bvh.S, "المنطقة الزمنية");
    a.put(bvh.T, "مشاركة ما يلي: ‎%s‎‏.");
    a.put(bvh.U, "تمتع بسلاسة الدفع مع خدمة السداد السريع.");
    a.put(bvh.V, "%s يطلب منك:");
    a.put(bvh.W, "مشاركة <a href='%1$s'>طرق الدفع</a> المربوطة بحسابك على باي بال.");
    a.put(bvh.X, "قم بتفعيل عرض خيارات التمويل الخاصة بك لتتمكن من الاختيار بينها.");
    a.put(bvh.Y, "<a href='%1$s'>تفويض المدفوعات</a> مقابل مشتريات ‎%2$s‎ المستقبلية المسددة قيمتها بواسطة باي بال. أنت تُكلف باي بال بإجراء جميع المدفوعات التي يطلبها ‎%3$s‎‏.");
    a.put(bvh.Z, "السماح له بإضافة بطاقة الولاء الخاصه به في محفظتك على بال بال وإداراتها.");
    a.put(bvh.aa, "الموافقة على <a href='%2$s'>سياسة الخصوصية</a> و<a href='%3$s'>اتفاقية المستخدم</a> %1$s‏.");
    a.put(bvh.ab, "اسمح لهم <a href='%1$s'>بطلب تحويل الأموال</a> نيابةً عنك إلى أن تسحب موافقتك.");
    a.put(bvh.ac, "اسمح لهم <a href='%1$s'>بإرسال الأموال</a> نيابةً عنك إلى أن تسحب موافقتك.");
    a.put(bvh.ad, "قبول");
    a.put(bvh.ae, "البريد الإلكتروني");
    a.put(bvh.af, "بيانات صورية");
    a.put(bvh.ag, "آلية الاختبار Sandbox‏");
    a.put(bvh.ah, "تاريخ انتهاء الصلاحية");
    a.put(bvh.ai, "<h1><strong>طرق الدفع</strong></h1><p>لا يشارك باي بال إلا طرق الدفع المتاحة للاستخدام.</p>");
    a.put(bvh.aj, "هل نسيت كلمة المرور؟");
    a.put(bvh.ak, "مِن");
    a.put(bvh.al, "كيف ترغب في تمويل المدفوعات المستقبلية إلى %1$s‏؟");
    a.put(bvh.am, "<h1><strong>اتفاقية المدفوعات المستقبلية</strong></h1><p>سيُستخدم مصدر التمويل الافتراضي لديك لسداد مدفوعات باي بال المستقبلية من هذا التاجر.</p><p>لإلغاء هذه الاتفاقية، سجِّل الدخول إلى حسابك على باي بال، وانتقل إلى <strong>الملف الشخصي</strong> ثم <strong>إعداداتي</strong> ثم <strong>تسجيل الدخول مع باي بال</strong>، واحذف هذا التاجر من القائمة.تنطبق بنود </p><p>قسم المدفوعات المتكررة من <a href='%s'>اتفاقية مستخدم باي بال</a>.</p><p>للتأكد من إمكانية إجراء مدفوعات عبر حسابك على باي بال، قد يقوم هذا التطبيق بمحاكاة إجراء معاملة صغيرة على سبيل التجربة دون أن يتم تحويل أي مبالغ خلال هذه العملية.</p>");
    a.put(bvh.an, "خطأ داخلي");
    a.put(bvh.ao, "<p>بالضغط على الزر أدناه، أقرُّ بموافقتي على بنود <a href='%1$s'>اتفاقية مستخدم باي بال</a> كما أُقرُّ بالتزامي بالقوانين والتشريعات اليابانية بما في ذلك العقوبات المفروضة على المدفوعات الموجهة إلى كوريا الشمالية وإيران وفقاً <a href='%2$s'>لقانون النقد الأجنبي والتجارة الخارجية</a> وذلك من أجل إتمام هذه المعاملة.</p>");
    a.put(bvh.ap, "تسجيل الدخول");
    a.put(bvh.aq, "تسجيل الدخول مع باي بال");
    a.put(bvh.ar, "تسجيل الخروج");
    a.put(bvh.as, "تسجيل الخروج");
    a.put(bvh.at, "موافق");
    a.put(bvh.au, "كلمة المرور");
    a.put(bvh.av, "الدفع بعد التسليم");
    a.put(bvh.aw, "دفع بواسطة");
    a.put(bvh.ax, "دفع بواسطة البطاقة");
    a.put(bvh.ay, "رصيد باي بال");
    a.put(bvh.az, "PayPal Credit");
    a.put(bvh.aA, "الهاتف");
    a.put(bvh.aB, "رمز التعريف الشخصي");
    a.put(bvh.aC, "طريقة الدفع المفضلة");
    a.put(bvh.aD, "باي بال يحمي <a href='%s'>خصوصيتك</a> ومعلوماتك المالية.");
    a.put(bvh.aE, "جارٍ المعالجة");
    a.put(bvh.aF, "تذكّر البطاقة");
    a.put(bvh.aG, "طلب تحويل أموال");
    a.put(bvh.aH, "<h1><strong>%s</strong></h1><p> سيتم إطلاع التاجر على أي بيانات ذات أهمية للمعاملة.</p><p>لسحب موافقتك، سجِّل الدخول إلى موقع paypal.com، ثم انتقل إلى خيارات <strong>تسجيل الدخول مع باي بال</strong> تحت إعدادات <strong>الملف الشخصي</strong>، واحذف هذا التاجر من القائمة.</p><p>باي بال غير مسؤول عن أيّ إجراءات أو أخطاء تقع من جانب الشريك.</p>");
    a.put(bvh.aI, "حساب توفير");
    a.put(bvh.aJ, "إرسال أموال");
    a.put(bvh.aK, "لقد تعذر الاتصال بخوادم باي بال. يرجى إعادة المحاولة.");
    a.put(bvh.aL, "يُرجى إعادة تسجيل الدخول إلى باي بال.");
    a.put(bvh.aM, "انتهى توقيت الجلسة.");
    a.put(bvh.aN, "عنوان الشحن");
    a.put(bvh.aO, "حديث المعرفة بـ PayPal؟ تسجيل الاشتراك");
    a.put(bvh.aP, "أبقني مسجّل الدخول");
    a.put(bvh.aQ, "خطأ نظام (‎%s‎‏). يرجى إعادة المحاولة لاحقاً.");
    a.put(bvh.aR, "أعد المحاولة");
    a.put(bvh.aS, "تعذر تسجيل الدخول إذ تم تفعيل المصادقة الثنائية على حسابك.");
    a.put(bvh.aT, "كود الحماية");
    a.put(bvh.aU, "إرسال رسالة نصية إلى هاتفك. سيبقى الكود المكون من 6 أرقام الذي ستتلقاه صالحاً لمدة 5 دقائق.");
    a.put(bvh.aV, "جارٍ إرسال الرسالة النصية.");
    a.put(bvh.aW, "أدخل كود الحماية المكون من 6 أرقام");
    a.put(bvh.aX, "رقم جوالك");
    a.put(bvh.aY, "إرسال رسالة نصية");
    a.put(bvh.aZ, "أعد إرسال الرسالة النصية");
    a.put(bvh.ba, "تعذر تسجيل الدخول إذ تم تفعيل المصادقة الثنائية على حسابك. يُرجى زيارة موقع باي بال الإلكتروني لتفعيل مفتاح الحماية الخاص بك.");
    a.put(bvh.bb, "غير مسموح بإجراء مدفوعات من هذا الجهاز.");
    a.put(bvh.bc, "جهاز غير مفوض باستخدامه");
    a.put(bvh.bd, "غير مسموح بإجراء مدفوعات لهذا التاجر (هوية العميل غير صحيحة).");
    a.put(bvh.be, "بيانات التاجر غير صحيحة");
    a.put(bvh.bf, "لقد تعذرت معالجة مدفوعاتك. يرجى إعادة المحاولة.");
    a.put(bvh.bg, "مصدر تمويل غير معروف");
    a.put(bvh.bh, "عذراً");
    a.put(bvh.bi, "طلبك");
    a.put(bvh.bj, "مسح البطاقة؟");
    a.put(bvh.bk, "لم يفلح القبول");
    a.put(bvh.bl, "لم يفلح الاتصال");
    a.put(bvh.bm, "لم يفلح تسجيل الدخول");
    a.put(bvh.bn, "تسجيل الدخول بكلمة المرور");
    a.put(bvh.bo, "تسجيل الدخول برمز التعريف الشخصي");
    a.put(bvh.bp, "لحظة من فضلك…");
    a.put(bvh.bq, "لم يفلح إجراء الدفع");
    a.put(bvh.br, "مسح ضوئي");
    a.put(bvh.bs, "كود الحماية غير صحيح. يرجى إعادة المحاولة.");
    a.put(bvh.bt, "عَبْر");
    a.put(bvh.bu, "خطأ نظام. يرجى إعادة المحاولة لاحقاً.");
