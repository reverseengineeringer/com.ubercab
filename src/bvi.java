...
public final class bvi
{
  ...
  public bvi(Context paramContext)
  {
    ...
    while (m < 10)
    {
      ...
      localTextView.setTextColor(but.k);
      localTextView.setLinkTextColor(but.t);
      localTextView.setTypeface(but.s);
      localTextView.setTextSize(18.0F);
      localTextView.setSingleLine(false);
      localTextView.setMovementMethod(LinkMovementMethod.getInstance());
      localLinearLayout.addView(localTextView);
      buu.a(localTextView, -1, -2);
      buu.a(localTextView, null, "10dip");
      arrayOfTextView[m] = localTextView;
      c[m].setFocusable(false);
      c[m].setVisibility(8);
      c[m].setId(m + 100);
      m += 1;
    }
    ...
    buu.a(d, -1, -2);
    buu.a(d, "20dip", "10dip");
    d.setNextFocusRightId(1);
    e = new TextView(paramContext);
    e.setId(4);
    buu.b(e);
    localLinearLayout.addView(e);
    buu.a(e, -1, -2);
    buu.b(e, null, "20dip", null, "10dip");
    e.setVisibility(8);
    h = buu.a(paramContext, true, 1, localLinearLayout);
    h.setNextFocusLeftId(2);
    h.setNextFocusRightId(3);
    i = new TextView(paramContext);
    buu.a(i);
    i.setText("Agree");
    h.addView(i, new ViewGroup.LayoutParams(-2, -2));
    g = new Button(paramContext);
    g.setId(3);
    buu.a(g);
    localLinearLayout.addView(g);
    buu.b(g, null, null, null, "16dip");
    buu.a(g, -2, -2);
    buu.a(g, 17, 1.0F);
    g.setNextFocusLeftId(1);
    f = new bvj(paramContext);
    k.addView(f.a);
    buu.a(f.a, -2, -2);
    buu.a(f.a, 17, 1.0F);
    a = j;
