  ...
  extends axq
{
  ...
  public final boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof avn)) {
        return false;
      }
      paramObject = (avn)paramObject;
      if (a == null)
      {
        if (a != null) {
          return false;
  ...
  public final int hashCode()
  {
    ...
    for (;;)
    {
      return ((j + (i + (m + 527) * 31) * 31) * 31 + k) * 31 + axo.a(d);
      i = a.intValue();
      break;
      label83:
      j = b.hashCode();
