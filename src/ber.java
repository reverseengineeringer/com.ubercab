  ...
  implements bep
{
  ...
  public final void a(int paramInt, Account paramAccount, bem parambem)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAccount != null)
        {
          ...
          if (parambem != null)
          {
            paramAccount = parambem.asBinder();
  ...
  /* Error */
  public final void a(aam paramaam, int paramInt, boolean paramBoolean)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   58: aload_0
    //   59: getfield 15	ber:a	Landroid/os/IBinder;
    //   62: bipush 9
    //   64: aload 5
    //   66: aload 6
    //   68: iconst_0
  ...
  public final void a(bem parambem)
  {
    ...
    //   30: aload_0
    //   31: getfield 15	ber:a	Landroid/os/IBinder;
    //   34: bipush 11
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
  ...
  public final void a(AuthAccountRequest paramAuthAccountRequest, bem parambem)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAuthAccountRequest != null)
        {
          ...
          if (parambem != null)
          {
            paramAuthAccountRequest = parambem.asBinder();
  ...
  public final void a(ResolveAccountRequest paramResolveAccountRequest, aay paramaay)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramResolveAccountRequest != null)
        {
          ...
          if (paramaay != null)
          {
            paramResolveAccountRequest = paramaay.asBinder();
  ...
  public final void a(com.google.android.gms.signin.internal.CheckServerAuthResult paramCheckServerAuthResult)
  {
    ...
    //   24: aload_2
    //   25: iconst_0
    //   26: invokevirtual 80	com/google/android/gms/signin/internal/CheckServerAuthResult:writeToParcel	(Landroid/os/Parcel;I)V
    //   29: aload_0
    //   30: getfield 15	ber:a	Landroid/os/IBinder;
    //   33: iconst_3
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
  ...
  public final void a(RecordConsentRequest paramRecordConsentRequest, bem parambem)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramRecordConsentRequest != null)
        {
          ...
          if (parambem != null)
          {
            paramRecordConsentRequest = parambem.asBinder();
  ...
  public final void a(SignInRequest paramSignInRequest, bem parambem)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramSignInRequest != null)
        {
          ...
          if (parambem != null)
          {
            paramSignInRequest = parambem.asBinder();
