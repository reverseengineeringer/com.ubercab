  ...
  extends cmj
{
  ...
  public cmp(long paramLong, cly<cmi> paramcly)
  {
    super(paramLong);
    b = paramcly;
  }
  ...
  final cmm a(cmc paramcmc)
  {
    paramcmc = paramcmc.a(c);
    if (paramcmc.isEmpty()) {
      return cmm.a(paramcmc, new byte[0]);
    }
    HashSet localHashSet = new HashSet();
    Object localObject1 = ((cmi)b.a()).e().entrySet().iterator();
    while (((Iterator)localObject1).hasNext())
    {
    ...
    localObject1 = new ArrayList(paramcmc.size());
    Object localObject2 = paramcmc.iterator();
    ...
    return cmm.a(paramcmc, ((TSerializer)localObject2).a((kij)localObject3));
  }
}
