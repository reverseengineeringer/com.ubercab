  ...
  extends bwt
{
  ...
  public bwj(bus parambus, bva parambva, String paramString1, String paramString2, ca paramca, Map paramMap, bwr[] paramArrayOfbwr, String paramString3, String paramString4, String paramString5, String paramString6, boolean paramBoolean)
  {
    super(bux.h, parambus, parambva, paramString1);
    f = paramca;
    g = paramMap;
    h = paramArrayOfbwr;
    i = paramString3;
  ...
  public final String b()
  {
    ...
    for (;;)
    {
      ...
      if ((h != null) && (h.length > 0))
      {
        ...
        ((JSONObject)localObject2).accumulate("items", bwr.a(h));
      ...
      localObject1 = new JSONObject();
      ((JSONObject)localObject1).accumulate("device_info", bwy.a(btw.a().toString()));
      ((JSONObject)localObject1).accumulate("app_info", bwy.a(btt.a().toString()));
      ((JSONObject)localObject1).accumulate("risk_data", bwy.a(bre.a().c().toString()));
      localObject2 = new JSONObject();
  ...
  public final bwj d(String paramString)
  {
    l = paramString;
    return this;
  }
  ...
  public final bwj e(String paramString)
  {
    m = paramString;
    return this;
  }
  ...
  public final bwj f(String paramString)
  {
    n = paramString;
    return this;
  }
