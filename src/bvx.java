  ...
  extends ArrayAdapter
{
  ...
  public bvx(Context paramContext, ArrayList paramArrayList, int paramInt)
  {
  ...
  private static int a(Context paramContext, RelativeLayout paramRelativeLayout, String paramString, int paramInt)
  {
    ...
    buu.c(paramContext, 83);
    buu.b(paramContext, "6dip", null, "6dip", null);
  ...
  {
    paramView = (bvw)getItem(paramInt);
    ...
    if (paramInt == a)
    {
      ...
      buu.b(paramViewGroup, "6dip", null, "6dip", null);
      localRelativeLayout.addView(paramViewGroup, buu.a(1, 2301));
      ...
      if (bwy.d(paramView.k()))
      {
        paramViewGroup.append("  ");
        paramViewGroup.append(paramView.k());
      }
      if (bwy.d(paramView.l()))
      {
        ...
        if ((!bwy.c((CharSequence)localObject2)) && (((String)localObject2).equals(paramView.toLowerCase(Locale.US)))) {
          break label456;
        }
      }
    }
