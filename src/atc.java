...
public final class atc
  extends asr
{
  public atc(asq paramasq, boolean paramBoolean)
  {
    super(paramasq, paramBoolean);
  }
  
  private static WebResourceResponse a(Context paramContext, String paramString1, String paramString2)
  {
    HashMap localHashMap = new HashMap();
    localHashMap.put("User-Agent", tp.e().a(paramContext, paramString1));
    localHashMap.put("Cache-Control", "max-stale=3600");
    paramContext = (String)new aro(paramContext).a(paramString2, localHashMap).get(60L, TimeUnit.SECONDS);
  ...
  public final WebResourceResponse shouldInterceptRequest(android.webkit.WebView paramWebView, String paramString)
  {
    ...
    //   20: aload_1
    //   21: aload_2
    //   22: invokespecial 112	asr:shouldInterceptRequest	(Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    //   25: areturn
    //   26: aload_1
    //   27: instanceof 114
    //   30: ifne +15 -> 45
    //   33: ldc 116
    //   35: invokestatic 121	aqt:d	(Ljava/lang/String;)V
    //   38: aload_0
    //   39: aload_1
    //   40: aload_2
    //   41: invokespecial 112	asr:shouldInterceptRequest	(Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    //   44: areturn
    //   45: aload_1
    //   46: checkcast 114	asq
    //   49: astore 4
    //   51: aload 4
    //   53: invokeinterface 125 1 0
    //   58: invokevirtual 128	asr:f	()V
    //   61: aload 4
    //   63: invokeinterface 132 1 0
    //   68: getfield 137	com/google/android/gms/ads/internal/client/AdSizeParcel:e	Z
    //   71: ifeq +61 -> 132
    //   74: getstatic 143	agz:F	Lagv;
    //   77: invokevirtual 149	agv:c	()Ljava/lang/Object;
    ...
    //   105: invokestatic 165	aqt:e	(Ljava/lang/String;)V
    //   108: aload 4
    //   110: invokeinterface 169 1 0
    //   115: aload_0
    //   116: getfield 172	atc:a	Lasq;
    //   119: invokeinterface 176 1 0
    //   124: getfield 182	com/google/android/gms/ads/internal/util/client/VersionInfoParcel:b	Ljava/lang/String;
    //   127: aload_3
    //   128: invokestatic 184	atc:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    //   131: areturn
    //   132: aload 4
    //   134: invokeinterface 188 1 0
    //   139: ifeq +16 -> 155
    //   142: getstatic 191	agz:E	Lagv;
    //   145: invokevirtual 149	agv:c	()Ljava/lang/Object;
    //   148: checkcast 67	java/lang/String
    //   151: astore_3
    //   152: goto -68 -> 84
    //   155: getstatic 194	agz:D	Lagv;
    //   158: invokevirtual 149	agv:c	()Ljava/lang/Object;
    ...
    //   172: dup
    //   173: ldc -60
    //   175: invokespecial 154	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   178: aload_3
    //   179: invokevirtual 201	java/lang/Exception:getMessage	()Ljava/lang/String;
    //   182: invokevirtual 158	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   185: invokevirtual 163	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   188: invokestatic 121	aqt:d	(Ljava/lang/String;)V
    //   191: aload_0
    //   192: aload_1
    //   193: aload_2
    //   194: invokespecial 112	asr:shouldInterceptRequest	(Landroid/webkit/WebView;Ljava/lang/String;)Landroid/webkit/WebResourceResponse;
    //   197: areturn
    //   198: astore_3
    //   199: goto -30 -> 169
    //   202: astore_3
