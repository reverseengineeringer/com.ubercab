  ...
  implements bmt
{
  ...
  public final void a(int paramInt, Account paramAccount, bmq parambmq)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAccount != null)
        {
          ...
          if (parambmq != null)
          {
            paramAccount = parambmq.asBinder();
  ...
  /* Error */
  public final void a(aax paramaax, int paramInt, boolean paramBoolean)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore 4
    ...
    //   58: aload_0
    //   59: getfield 15	bmv:a	Landroid/os/IBinder;
    //   62: bipush 9
    //   64: aload 5
    //   66: aload 6
    //   68: iconst_0
  ...
  public final void a(bmq parambmq)
  {
    ...
    //   30: aload_0
    //   31: getfield 15	bmv:a	Landroid/os/IBinder;
    //   34: bipush 11
    //   36: aload_2
    //   37: aload_3
    //   38: iconst_0
  ...
  public final void a(AuthAccountRequest paramAuthAccountRequest, bmq parambmq)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramAuthAccountRequest != null)
        {
          ...
          if (parambmq != null)
          {
            paramAuthAccountRequest = parambmq.asBinder();
  ...
  public final void a(ResolveAccountRequest paramResolveAccountRequest, abj paramabj)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramResolveAccountRequest != null)
        {
          ...
          if (paramabj != null)
          {
            paramResolveAccountRequest = paramabj.asBinder();
  ...
  public final void a(com.google.android.gms.signin.internal.CheckServerAuthResult paramCheckServerAuthResult)
  {
    ...
    //   29: aload_0
    //   30: getfield 15	bmv:a	Landroid/os/IBinder;
    //   33: iconst_3
    //   34: aload_2
    //   35: aload_3
    //   36: iconst_0
  ...
  public final void a(RecordConsentRequest paramRecordConsentRequest, bmq parambmq)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramRecordConsentRequest != null)
        {
          ...
          if (parambmq != null)
          {
            paramRecordConsentRequest = parambmq.asBinder();
  ...
  public final void a(SignInRequest paramSignInRequest, bmq parambmq)
  {
    Parcel localParcel1 = Parcel.obtain();
    Parcel localParcel2 = Parcel.obtain();
    for (;;)
    {
      try
      {
        ...
        if (paramSignInRequest != null)
        {
          ...
          if (parambmq != null)
          {
            paramSignInRequest = parambmq.asBinder();
