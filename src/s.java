...
public final class s
{
  ...
  public static void a(Context paramContext)
  {
    ...
    try
    {
      ...
      List localList = w.a(paramContext, localApplicationInfo, localFile, false);
      if (a(localList))
      {
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        paramContext = w.a(paramContext, localApplicationInfo, localThrowable, true);
        if (!a(paramContext)) {
          break;
        }
  ...
  private static void a(ClassLoader paramClassLoader, File paramFile, List<File> paramList)
  {
    if (!paramList.isEmpty())
    {
      if (Build.VERSION.SDK_INT >= 19) {
        u.a(paramClassLoader, paramList, paramFile);
      }
    }
    else {
      return;
    ...
    {
      t.a(paramClassLoader, paramList, paramFile);
      return;
    }
    v.a(paramClassLoader, paramList);
  }
