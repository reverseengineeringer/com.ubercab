  ...
  implements bdj
{
  ...
  public static bdj a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof bdj))) {
      return (bdj)localIInterface;
    }
    return new bdl(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    a(bcv.a(paramParcel1.readStrongBinder()));
