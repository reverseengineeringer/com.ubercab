...
public final class aee
{
  ...
  public aee(Context paramContext)
  {
    this(paramContext, "com.google.android.gms.appid");
  }
  
  private aee(Context paramContext, String paramString)
  {
    b = paramContext;
  ...
  final KeyPair a(String paramString, long paramLong)
  {
    try
    {
      KeyPair localKeyPair = adz.a();
      SharedPreferences.Editor localEditor = a.edit();
      a(localEditor, paramString, "|P|", ady.a(localKeyPair.getPublic().getEncoded()));
      a(localEditor, paramString, "|K|", ady.a(localKeyPair.getPrivate().getEncoded()));
