...
public final class bxx
{
  ...
  public bxx(Context paramContext)
  {
    ...
    d.setTextColor(bwz.b);
    d.setTextSize(14.0F);
    d.setPaintFlags(8);
    ((TableRow)localObject).addView(d);
    d.setGravity(19);
    bxa.b(d, "0dip", "4dip", "0dip", "4dip");
    bxa.a(d, -2, -2);
    d.setClickable(true);
  }
