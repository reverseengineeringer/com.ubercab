...
public abstract class bed
  ...
  implements bec
{
  public static bec a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof bec))) {
      return (bec)localIInterface;
    }
    return new bee(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    a(bhf.a(paramParcel1.readStrongBinder()));
