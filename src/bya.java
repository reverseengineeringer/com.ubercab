...
public final class bya
{
  ...
  public bya(Context paramContext)
  {
    d = new TableLayout(paramContext);
    d.setColumnStretchable(1, true);
    d.setColumnShrinkable(0, true);
