...
public final class bvr
{
  ...
  public bvr(Context paramContext)
  {
    ...
    ((TableRow)localObject).addView(c);
    buu.a(c, -2, -1);
    localObject = new TableRow(paramContext);
    a.addView((View)localObject);
    d = new TextView(paramContext);
    d.setTextColor(but.b);
    d.setTextSize(14.0F);
    d.setPaintFlags(8);
    ((TableRow)localObject).addView(d);
    d.setGravity(19);
    buu.b(d, "0dip", "4dip", "0dip", "4dip");
    buu.a(d, -2, -2);
    d.setClickable(true);
  }
