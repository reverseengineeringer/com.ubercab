...
{
  static Map<String, adk> a = new HashMap();
  static String f;
  private static adq g;
  private static adp h;
  Context b;
  KeyPair c;
  String d = "";
  long e;
  
  private adk(Context paramContext, String paramString)
  {
  ...
  public static adk a(Context paramContext, Bundle paramBundle)
  {
    if (paramBundle == null) {
      paramBundle = "";
    }
    for (;;)
    {
      try
      {
        ...
        if (g == null)
        {
          g = new adq(localContext);
          h = new adp(localContext);
        }
        f = Integer.toString(a(localContext));
        adk localadk = (adk)a.get(paramBundle);
        paramContext = localadk;
        if (localadk == null)
        {
          paramContext = new adk(localContext, paramBundle);
  ...
  public static adk b(Context paramContext)
  {
  ...
  public final String a(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    for (paramString2 = paramString1;; paramString2 = d)
    {
      ...
      return adp.a(h.a(paramBundle, d()));
    }
  }
