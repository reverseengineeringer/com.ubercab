...
public final class bvo
{
  ...
  public bvo(Context paramContext)
  {
    ...
    buu.a(f, "0dp");
    buu.a(f, 1, 0.5F);
    buu.a(f, "2dip", "5dip", "2dip", "5dip");
    k = new TextView(paramContext);
    k.setTextSize(16.0F);
    k.setTypeface(but.p);
    k.setGravity(51);
    k.setTextColor(but.g);
    localLinearLayout.addView(k);
    buu.a(k, -2, -2);
    buu.a(k, "6dip", "2dip", "6dip", "2dip");
    buu.b(k, null, null, null, "10dip");
    o = new bvt(paramContext);
    buu.b(o.a, null, null, null, "10dip");
    localLinearLayout.addView(o.a);
    l = new EditText(paramContext);
    l.setId(43025);
    l.setInputType(2);
    l.setTextColor(but.k);
    l.setTypeface(but.s);
    l.setSingleLine(true);
    l.setFilters(new InputFilter[] { new InputFilter.LengthFilter(6) });
    localLinearLayout.addView(l);
    buu.a(l, -1, -2);
    buu.b(l, null, null, null, "10dip");
    m = buu.a(paramContext, true, 43026, localLinearLayout);
