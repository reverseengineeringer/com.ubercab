  ...
  implements cav
{
  ...
  public cga()
  {
    a.put(bxn.a, "Valider et payer");
    a.put(bxn.b, "et autre(s)");
    a.put(bxn.c, "Authentification");
    a.put(bxn.d, "Retour");
    a.put(bxn.e, "Secondaire");
    a.put(bxn.f, "Annuler");
    ...
    a.put(bxn.v, "Visa");
    a.put(bxn.w, "Modifier le mode de paiement");
    a.put(bxn.x, "Courant");
    a.put(bxn.y, "Vérification de l’appareil…");
    a.put(bxn.z, "Effacer les informations de carte");
    a.put(bxn.A, "Confirmer");
    a.put(bxn.B, "Souhaitez-vous vraiment effacer les informations relatives à votre carte ?");
    a.put(bxn.C, "Débiter la carte");
    a.put(bxn.D, "Souhaitez-vous vraiment vous déconnecter de PayPal ?");
    a.put(bxn.E, "Payer");
    a.put(bxn.F, "Accepter");
    a.put(bxn.G, "Date de création du compte");
    a.put(bxn.H, "État du compte");
    a.put(bxn.I, "Type de compte");
    a.put(bxn.J, "Adresse");
    a.put(bxn.K, "Tranche d’âge");
    a.put(bxn.L, "Date de naissance");
    a.put(bxn.M, "Adresse email");
    a.put(bxn.N, "Nom complet");
    a.put(bxn.O, "Sexe");
    a.put(bxn.P, "Langue");
    a.put(bxn.Q, "Pays");
    a.put(bxn.R, "Téléphone");
    a.put(bxn.S, "Fuseau horaire");
    a.put(bxn.T, "Partager les informations suivantes : %s.");
    a.put(bxn.U, "Utiliser le paiement simplifié.");
    a.put(bxn.V, "%s vous demande de :");
    a.put(bxn.W, "Partager les <a href='%1$s'>modes de paiement</a> liés à votre compte PayPal.");
    a.put(bxn.X, "Activer l’affichage de vos options d’approvisionnement pour vous permettre de faire votre choix.");
    a.put(bxn.Y, "<a href='%1$s'>Autoriser les débits</a> pour les futurs achats chez %2$s payés avec PayPal. Vous donnez pour instruction à PayPal de payer tous les montants demandés par %3$s.");
    a.put(bxn.Z, "L’autoriser à ajouter et à gérer sa carte de fidélité dans votre portefeuille.");
    a.put(bxn.aa, "Accepter le <a href='%2$s'>règlement sur le respect de la vie privée</a> et les <a href='%3$s'>conditions d’utilisation</a> de %1$s .");
    a.put(bxn.ab, "L’autoriser à <a href='%1$s'>demander de l’argent</a> en votre nom jusqu’à nouvel ordre.");
    a.put(bxn.ac, "L’autoriser à <a href='%1$s'>envoyer de l’argent</a> en votre nom jusqu’à nouvel ordre.");
    a.put(bxn.ad, "Accepter");
    a.put(bxn.ae, "Email");
    a.put(bxn.af, "Données d’exemple");
    a.put(bxn.ag, "Environnement de test");
    a.put(bxn.ah, "Date d’expiration");
    a.put(bxn.ai, "<h1><strong>Modes de paiement</strong></h1><p>PayPal communique uniquement vos modes de paiement disponibles.</p>");
    a.put(bxn.aj, "Mot de passe oublié ?");
    a.put(bxn.ak, "De");
    a.put(bxn.al, "Comment souhaitez-vous approvisionner les futurs paiements à %1$s ?");
    a.put(bxn.am, "<h1><strong>Autorisation pour les futurs paiements</strong></h1><p>Votre source d’approvisionnement par défaut sera utilisée pour payer les futurs paiements PayPal chez ce marchand.</p><p>Pour annuler cette autorisation, connectez-vous à votre compte PayPal et accédez à <strong>Préférences</strong> &gt; <strong>Mes paramètres</strong> &gt; <strong>Connexion avec PayPal</strong> et supprimez ce marchand de la liste.</p><p>L’article Paiement récurrent des <a href='%s'>Conditions d’utilisation de PayPal</a> s’appliquera.</p><p>Pour s’assurer que votre compte PayPal pourra être débité à l’avenir, cette application peut simuler une petite transaction test sans transfert d’argent.</p>");
    a.put(bxn.an, "Erreur interne");
    a.put(bxn.ao, "<p>En cliquant sur le bouton ci-dessous, j’accepte les <a href='%1$s'>Conditions d’utilisation de PayPal</a> et déclare être en conformité avec les lois et réglementations japonaises, notamment les sanctions liées aux paiements vers la Corée-du-Nord et l’Iran conformément au <a href='%2$s'>Foreign Exchange and Foreign Trade Act</a> pour effectuer cette transaction.</p>");
    a.put(bxn.ap, "Connexion");
    a.put(bxn.aq, "Connexion avec PayPal");
    a.put(bxn.ar, "Déconnexion");
    a.put(bxn.as, "Déconnexion");
    a.put(bxn.at, "OK");
    a.put(bxn.au, "Mot de passe");
    a.put(bxn.av, "Paiement après Livraison");
    a.put(bxn.aw, "Payer par");
    a.put(bxn.ax, "Payer par carte");
    a.put(bxn.ay, "Solde PayPal");
    a.put(bxn.az, "PayPal Credit");
    a.put(bxn.aA, "Téléphone");
    a.put(bxn.aB, "Code d’accès");
    a.put(bxn.aC, "Mode de paiement principal");
    a.put(bxn.aD, "PayPal garantit le <a href='%s'>respect de votre vie privée</a> et protège vos informations financières.");
    a.put(bxn.aE, "En cours de traitement");
    a.put(bxn.aF, "Mémoriser la carte");
    a.put(bxn.aG, "Demande d’argent");
    a.put(bxn.aH, "<h1><strong>%s</strong></h1><p>Toute information pertinente relative à la transaction sera communiquée au marchand.</p><p>Pour annuler l’autorisation, connectez-vous à paypal.com, puis accédez à <strong>Connexion avec PayPal</strong> sous <strong>Préférences</strong> et supprimez ce marchand.</p><p>PayPal n’est pas responsable des actions ou erreurs imputables au partenaire.</p>");
    a.put(bxn.aI, "Épargne");
    a.put(bxn.aJ, "Envoi d’argent");
    a.put(bxn.aK, "Un problème est survenu lors de la communication avec les serveurs PayPal. Merci de recommencer.");
    a.put(bxn.aL, "Merci de vous reconnecter à PayPal.");
    a.put(bxn.aM, "La session a expiré");
    a.put(bxn.aN, "Adresse de livraison");
    a.put(bxn.aO, "Nouveau sur PayPal ? Ouvrir un compte");
    a.put(bxn.aP, "Rester connecté");
    a.put(bxn.aQ, "Erreur système (%s). Réessayez ultérieurement.");
    a.put(bxn.aR, "Réessayer");
    a.put(bxn.aS, "Nous ne pouvons pas vous connecter car votre compte fait l’objet d’une authentification à deux facteurs.");
    a.put(bxn.aT, "Code de sécurité");
    a.put(bxn.aU, "Envoyer un SMS à votre téléphone. Le code à six chiffres que vous recevez sera valide pendant cinq minutes.");
    a.put(bxn.aV, "Envoi du SMS");
    a.put(bxn.aW, "Saisissez le code de sécurité à six chiffres");
    a.put(bxn.aX, "Votre numéro de mobile");
    a.put(bxn.aY, "Envoyer un SMS");
    a.put(bxn.aZ, "Envoyer de nouveau un SMS");
    a.put(bxn.ba, "Nous ne pouvons pas vous connecter, car votre compte fait l’objet d’une authentification à deux facteurs. Rendez-vous sur le site PayPal pour activer votre clé de sécurité.");
    a.put(bxn.bb, "Vous ne pouvez pas effectuer de paiements à partir de cet appareil.");
    a.put(bxn.bc, "Appareil non autorisé");
    a.put(bxn.bd, "Les paiements à ce marchand ne sont pas autorisés (identifiant client incorrect).");
    a.put(bxn.be, "Marchand incorrect");
    a.put(bxn.bf, "Un problème est survenu lors du traitement de votre paiement. Réessayez.");
    a.put(bxn.bg, "Source non reconnue");
    a.put(bxn.bh, "Désolé");
    a.put(bxn.bi, "Votre commande");
    a.put(bxn.bj, "Effacer la carte ?");
    a.put(bxn.bk, "Échec de l’autorisation");
    a.put(bxn.bl, "Échec de la connexion");
    a.put(bxn.bm, "Échec de la connexion");
    a.put(bxn.bn, "Connexion par mot de passe");
    a.put(bxn.bo, "Connexion par code d’accès");
    a.put(bxn.bp, "Un instant…");
    a.put(bxn.bq, "Échec du paiement");
    a.put(bxn.br, "Scanner");
    a.put(bxn.bs, "Cryptogramme visuel incorrect. Réessayez.");
    a.put(bxn.bt, "Via");
    a.put(bxn.bu, "Erreur système. Réessayez ultérieurement.");
