  ...
  implements byf
{
  ...
  private byc(String paramString1, String paramString2, String paramString3, String paramString4, String paramString5, String paramString6, String paramString7, String paramString8)
  {
    b = paramString1;
    c = paramString2;
    d = paramString3;
  ...
  public static ArrayList a(JSONObject paramJSONObject, JSONArray paramJSONArray, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      {
        Log.e("paypal.sdk", paramJSONObject.getMessage());
      }
      if (j < paramJSONArray.length())
      {
        if (j != paramInt) {
          a(localArrayList, paramJSONArray.getJSONObject(j));
        }
        j += 1;
      }
      else
  ...
  private static void a(ArrayList paramArrayList, JSONObject paramJSONObject)
  {
    if (paramJSONObject != null)
    {
      paramJSONObject.optString("type");
      paramArrayList.add(new byc("", paramJSONObject.getString("recipient_name"), paramJSONObject.getString("line1"), paramJSONObject.optString("line2"), paramJSONObject.getString("city"), paramJSONObject.getString("state"), paramJSONObject.getString("postal_code"), paramJSONObject.getString("country_code")));
    }
  }
