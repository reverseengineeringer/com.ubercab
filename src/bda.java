...
public final class bda
{
  ...
  private bda(Context paramContext)
  {
    paramContext = paramContext.getResources();
    String str = paramContext.getResourcePackageName(rj.common_google_play_services_unknown_issue);
  ...
  private bda(String paramString)
  {
    a = paramString;
    b = Status.a;
    c = true;
  ...
  {
    abe.a(paramContext, "Context must not be null.");
    if (e == null) {}
    try
    {
      if (e == null) {
        e = new bda(paramContext);
      }
      return eb;
    }
    finally {}
  ...
  {
    abe.a(paramContext, "Context must not be null.");
    abe.a(paramString, "App ID must be nonempty.");
    try
    {
      if (e != null)
      {
