...
public final class ade
{
  ...
  private ade(Context paramContext, Class<? extends GcmListenerService> paramClass)
  {
  ...
  public static ade a(Context paramContext, Class<? extends GcmListenerService> paramClass)
  {
    try
    {
      if (a == null) {
        a = new ade(paramContext, paramClass);
      }
      paramContext = a;
      return paramContext;
    }
