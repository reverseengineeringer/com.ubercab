...
public final class ed
{
  ...
  public static void a(Context paramContext)
  {
    ...
    try
    {
      ...
      List localList = eh.a(paramContext, localApplicationInfo, localFile, false);
      if (a(localList))
      {
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        ...
        paramContext = eh.a(paramContext, localApplicationInfo, localThrowable, true);
        if (!a(paramContext)) {
          break;
        }
  ...
  private static void a(ClassLoader paramClassLoader, File paramFile, List<File> paramList)
  {
    if (!paramList.isEmpty())
    {
      if (Build.VERSION.SDK_INT >= 19) {
        ef.a(paramClassLoader, paramList, paramFile);
      }
    }
    else {
      return;
    ...
    {
      ee.a(paramClassLoader, paramList, paramFile);
      return;
    }
    eg.a(paramClassLoader, paramList);
  }
