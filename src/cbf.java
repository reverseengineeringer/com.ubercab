  ...
  extends cag
{
  ...
  public cbf(Intent paramIntent, PayPalConfiguration paramPayPalConfiguration)
  {
  ...
  public final boolean e()
  {
    ...
    label145:
    Object localObject;
    if ((c().m() != null) && (bwy.a(PayPalFuturePaymentActivity.class.getSimpleName(), c().m().toString(), "merchantPrivacyPolicyUrl")) && (a(c().m().toString())))
    {
      bool2 = true;
      a(bool2, "merchantPrivacyPolicyUrl");
      if ((c().n() == null) || (!bwy.a(PayPalFuturePaymentActivity.class.getSimpleName(), c().n().toString(), "merchantUserAgreementUrl")) || (!a(c().n().toString()))) {
        break label204;
      }
      bool3 = true;
