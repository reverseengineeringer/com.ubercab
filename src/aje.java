  ...
  extends aim
{
  ...
  public aje(Context paramContext, String paramString1, String paramString2)
  {
    b = paramContext;
    a = paramString1;
    c = paramString2;
  ...
  public aje(Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    b = paramContext;
    a = paramString1;
    c = paramString2;
  ...
  public final void a()
  {
    ...
    //   9: aload_0
    //   10: getfield 24	aje:c	Ljava/lang/String;
    ...
    //   19: invokestatic 52	ain:e	(Ljava/lang/String;)V
    //   22: new 54	java/net/URL
    //   25: dup
    //   26: aload_0
    //   27: getfield 24	aje:c	Ljava/lang/String;
    ...
    //   39: astore_2
    //   40: aload_0
    //   41: getfield 18	aje:d	Ljava/lang/String;
    //   44: invokestatic 67	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   47: ifeq +74 -> 121
    //   50: invokestatic 72	ul:c	()Laiq;
    //   53: aload_0
    //   54: getfield 20	aje:b	Landroid/content/Context;
    //   57: aload_0
    //   58: getfield 22	aje:a	Ljava/lang/String;
    //   61: iconst_1
    //   62: aload_2
    //   63: invokevirtual 77	aiq:a	(Landroid/content/Context;Ljava/lang/String;ZLjava/net/HttpURLConnection;)V
    //   66: aload_2
    ...
    //   103: aload_0
    //   104: getfield 24	aje:c	Ljava/lang/String;
    ...
    //   113: invokestatic 90	ain:d	(Ljava/lang/String;)V
    //   116: aload_2
    //   117: invokevirtual 93	java/net/HttpURLConnection:disconnect	()V
    //   120: return
    //   121: invokestatic 72	ul:c	()Laiq;
    //   124: pop
    //   125: aload_2
    //   126: aload_0
    //   127: getfield 18	aje:d	Ljava/lang/String;
    //   130: invokestatic 96	aiq:a	(Ljava/net/HttpURLConnection;Ljava/lang/String;)V
    //   133: goto -67 -> 66
    //   136: astore_3
    //   137: aload_2
    ...
    //   153: aload_0
    //   154: getfield 24	aje:c	Ljava/lang/String;
    ...
    //   175: invokestatic 90	ain:d	(Ljava/lang/String;)V
    //   178: return
    //   179: astore_2
    ...
    //   189: aload_0
    //   190: getfield 24	aje:c	Ljava/lang/String;
    ...
    //   211: invokestatic 90	ain:d	(Ljava/lang/String;)V
    //   214: return
    //   215: astore_2
    ...
    //   225: aload_0
    //   226: getfield 24	aje:c	Ljava/lang/String;
    ...
    //   247: invokestatic 90	ain:d	(Ljava/lang/String;)V
    //   250: return
