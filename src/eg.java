...
final class eg
{
  private static void b(ClassLoader paramClassLoader, List<File> paramList)
  {
    ...
    Field localField = ed.a(paramClassLoader, "path");
    ...
    ed.a(paramClassLoader, "mPaths", arrayOfString);
    ed.a(paramClassLoader, "mFiles", arrayOfFile);
    ed.a(paramClassLoader, "mZips", arrayOfZipFile);
    ed.a(paramClassLoader, "mDexs", arrayOfDexFile);
  }
}
