  ...
  implements byp
{
  ...
  public byt()
  {
    ...
    a.put(bvh.v, "Visa");
    a.put(bvh.w, "Change Payment Method");
    a.put(bvh.x, "Checking");
    a.put(bvh.y, "Checking this device…");
    a.put(bvh.z, "Clear card information");
    a.put(bvh.A, "Confirm");
    a.put(bvh.B, "Are you sure you want to clear your card information?");
    ...
    a.put(bvh.L, "Birth Date");
    a.put(bvh.M, "Email address");
    a.put(bvh.N, "Full Name");
    a.put(bvh.O, "Gender");
    a.put(bvh.P, "Language");
    a.put(bvh.Q, "Locale");
    a.put(bvh.R, "Telephone");
    a.put(bvh.S, "Time Zone");
    a.put(bvh.T, "Share the following: %s.");
    a.put(bvh.U, "Use Seamless Checkout.");
    a.put(bvh.V, "%s asks that you:");
    a.put(bvh.W, "Share the <a href='%1$s'>payment methods</a> linked to your PayPal account.");
    a.put(bvh.X, "Enable display of your funding options to allow you to make a choice.");
    a.put(bvh.Y, "<a href='%1$s'>Authorize charges</a> for future %2$s purchases paid for with PayPal. You instruct PayPal to pay all amounts requested by %3$s.");
    ...
    a.put(bvh.ai, "<h1><strong>Payment Methods</strong></h1><p>PayPal only shares which of your payment methods are available for use.</p>");
    a.put(bvh.aj, "Forgot password?");
    a.put(bvh.ak, "From");
    ...
    a.put(bvh.aA, "Phone");
    a.put(bvh.aB, "PIN");
    a.put(bvh.aC, "Preferred Payment Method");
    ...
    a.put(bvh.aL, "Please log in again to PayPal.");
    a.put(bvh.aM, "Session Expired");
    a.put(bvh.aN, "Shipping Address");
    ...
    a.put(bvh.aW, "Enter the 6-digit security code");
    ...
    a.put(bvh.bc, "Unauthorized Device");
    ...
    a.put(bvh.bg, "Unrecognized Source");
