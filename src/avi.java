...
public abstract class avi
  ...
  implements avh
{
  public static avh a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof avh))) {
      return (avh)localIInterface;
    }
    return new avj(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 1: 
      ...
      if (localavb != null) {
        paramParcel1 = localavb.asBinder();
      }
