...
public class acy
{
  ...
  public static boolean a(Context paramContext, int paramInt)
  {
    ...
    do
    {
      ...
      try
      {
        ...
        acz.a();
        return acz.a(paramContext.getPackageManager(), (PackageInfo)localObject);
      }
      catch (PackageManager.NameNotFoundException paramContext) {}
    ...
    for (boolean bool = true;; bool = false) {
      synchronized (a)
      {
        ...
        try
        {
          ...
          acz.a();
          if (acz.a(paramPackageManager, new acu[] { acx.a[1] }) != null) {}
          for (e = 1; e != 0; e = 0) {
            return bool;
          }
        }
  ...
  public static int c(Context paramContext)
  {
    ...
    try
    {
      paramContext.getResources().getString(lw.common_google_play_services_unknown_issue);
    ...
    catch (Throwable localThrowable)
    {
      for (;;)
      {
        try
        {
          ...
          if (acz.a(localPackageInfo, acx.a) != null) {
            break label180;
          }
    ...
    try
    {
      paramContext = acz.a(localPackageManager.getPackageInfo("com.android.vending", 8256), acx.a);
      if (paramContext == null)
      {
    ...
    if (acz.a(localThrowable, new acu[] { paramContext }) == null)
    {
      Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
      return 9;
    }
  ...
  {
    return acs.b().a(null, paramInt, null);
  }
  
  @Deprecated
  public static void d(Context paramContext)
  {
    int j = acs.b().a(paramContext);
    if (j != 0)
    {
      paramContext = acs.b().a(paramContext, j, "e");
      Log.e("GooglePlayServicesUtil", "GooglePlayServices not available due to error " + j);
      if (paramContext == null) {
        throw new wb(j);
      }
      throw new wc(j, "Google Play Services not available", paramContext);
    }
  }
  ...
  {
    paramContext = paramContext.getPackageManager();
    return (auu.i()) && (paramContext.hasSystemFeature("cn.google"));
  }
}
