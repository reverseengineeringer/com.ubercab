...
public abstract class atv
  ...
  implements atu
{
  public static atu a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof atu))) {
      return (atu)localIInterface;
    }
    return new atw(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    paramParcel2 = ats.a(paramParcel1.readStrongBinder());
    if (paramParcel1.readInt() != 0) {
      vx localvx = LogEventParcelable.CREATOR;
    }
    for (paramParcel1 = vx.a(paramParcel1);; paramParcel1 = null)
    {
