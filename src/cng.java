  ...
  implements cna
{
  ...
  private final List<cne<Metric>> b;
  private final List<Integer> c;
  private final Random d;
  private int e;
  
  private cng(List<Integer> paramList)
  {
    this(paramList, (byte)0);
  }
  
  private cng(List<Integer> paramList, byte paramByte)
  {
    this(paramList, new Random());
  }
  
  private cng(List<Integer> paramList, Random paramRandom)
  {
    c(paramList);
    d = paramRandom;
    a = paramList;
  ...
  private boolean a(Metric paramMetric, int paramInt)
  {
    ...
    //   2: aload_0
    //   3: iload_2
    //   4: invokespecial 70	cng:a	(I)V
    //   7: aload_0
    //   8: getfield 45	cng:b	Ljava/util/List;
    //   11: iload_2
    //   12: invokeinterface 74 2 0
    //   17: checkcast 76	cne
    //   20: astore_3
    //   21: aload_3
    //   22: invokevirtual 79	cne:c	()Z
    //   25: ifeq +16 -> 41
    //   28: aload_3
    //   29: aload_1
    //   30: invokevirtual 82	cne:a	(Ljava/lang/Object;)V
    //   33: aload_0
    //   34: invokespecial 52	cng:b	()V
    //   37: aload_0
    //   38: monitorexit
    //   39: iconst_1
    //   40: ireturn
    //   41: aload_3
    //   42: aload_1
    //   43: invokevirtual 82	cne:a	(Ljava/lang/Object;)V
    //   46: goto -9 -> 37
    //   49: astore_1
    //   50: aload_0
    //   51: monitorexit
  ...
  public static cna b(List<Integer> paramList)
  {
    return new cng(paramList);
  }
  ...
  private static List<cne<Metric>> d(List<Integer> paramList)
  {
    ArrayList localArrayList = new ArrayList();
    int i = 0;
    while (i < paramList.size())
    {
      localArrayList.add(new cne(200));
      i += 1;
    }
  ...
  public final List<Metric> a(cnc paramcnc)
  {
    ...
    //   9: astore 4
    //   11: aload_0
    //   12: invokespecial 144	cng:c	()Lcne;
    //   15: astore_3
    //   16: aload_3
    //   17: ifnonnull +8 -> 25
    //   20: aload_0
    ...
    //   24: areturn
    //   25: aload_3
    //   26: invokevirtual 146	cne:d	()Ljava/lang/Object;
    ...
    //   47: aload 4
    //   49: aload_3
    //   50: invokevirtual 153	cne:b	()Ljava/lang/Object;
    //   53: invokeinterface 123 2 0
    //   58: pop
    //   59: aload_3
    //   60: invokevirtual 79	cne:c	()Z
    //   63: ifeq +7 -> 70
    //   66: aload_0
    //   67: invokespecial 52	cng:b	()V
    //   70: aload_0
    //   71: invokespecial 144	cng:c	()Lcne;
    //   74: astore_3
    //   75: aload_3
    //   76: ifnonnull +6 -> 82
    //   79: goto -59 -> 20
    //   82: aload_3
    //   83: invokevirtual 146	cne:d	()Ljava/lang/Object;
    ...
    //   start	length	slot	name	signature
    //   0	101	0	this	cng
    //   0	101	1	paramcnc	cnc
    //   32	58	2	localMetric	Metric
    //   15	68	3	localcne	cne
