...
public final class brt
{
  ...
  public brt()
  {
    ...
    c.addRequestInterceptor(new bru(this));
    c.addResponseInterceptor(new brv());
    c.setHttpRequestRetryHandler(new bsb());
    e = ((ThreadPoolExecutor)Executors.newCachedThreadPool());
    f = new WeakHashMap();
    g = new HashMap();
  }
  
  private void a(DefaultHttpClient paramDefaultHttpClient, HttpContext paramHttpContext, HttpUriRequest paramHttpUriRequest, bry parambry, Context paramContext)
  {
    paramHttpUriRequest = e.submit(new brx(paramDefaultHttpClient, paramHttpContext, paramHttpUriRequest, parambry));
  ...
  public final void a(Context paramContext, String paramString, Header[] paramArrayOfHeader, bry parambry)
  {
    paramString = new HttpGet(paramString);
    if (paramArrayOfHeader != null) {
      paramString.setHeaders(paramArrayOfHeader);
    }
    a(c, d, paramString, parambry, paramContext);
  }
  
  public final void a(Context paramContext, String paramString, Header[] paramArrayOfHeader, HttpEntity paramHttpEntity, bry parambry)
  {
  ...
  public final void b(Context paramContext, String paramString, Header[] paramArrayOfHeader, bry parambry)
  {
