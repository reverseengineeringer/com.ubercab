  ...
  implements cav
{
  ...
  public cba()
  {
    ...
    a.put(bxn.Z, "Allow them to link and manage their loyalty card in your PayPal wallet.");
    ...
    a.put(bxn.aU, "Send an SMS to your phone. The 6-digit code you receive will be valid for 5 minutes.");
    a.put(bxn.aV, "Sending SMS");
    a.put(bxn.aW, "Enter the 6-digit security code");
    a.put(bxn.aX, "Your mobile number");
    a.put(bxn.aY, "Send SMS");
    a.put(bxn.aZ, "Send SMS Again");
