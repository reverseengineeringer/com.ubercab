  ...
  extends buv
{
  ...
  public buu(String paramString, List paramList, Handler paramHandler, boolean paramBoolean)
  {
    a = paramString;
    b = paramList;
    c = new ArrayList();
  ...
  public final void run()
  {
    ...
    //   4: astore_3
    //   5: aload_0
    //   6: getfield 31	buu:d	Landroid/os/Handler;
    //   9: ifnonnull +4 -> 13
    //   12: return
    //   13: aload_0
    //   14: getfield 31	buu:d	Landroid/os/Handler;
    //   17: aload_0
    //   18: getfield 31	buu:d	Landroid/os/Handler;
    //   21: iconst_0
    //   22: aload_0
    //   23: getfield 22	buu:a	Ljava/lang/String;
    ...
    //   32: pop
    //   33: aload_0
    //   34: getfield 33	buu:e	Z
    //   37: ifne +24 -> 61
    //   40: aload_0
    //   41: getfield 29	buu:c	Ljava/util/List;
    ...
    //   60: pop
    //   61: aload_0
    //   62: getfield 29	buu:c	Ljava/util/List;
    ...
    //   81: pop
    //   82: aload_0
    //   83: getfield 29	buu:c	Ljava/util/List;
    ...
    //   102: pop
    //   103: aload_0
    //   104: getfield 29	buu:c	Ljava/util/List;
    ...
    //   156: new 97	bva
    //   159: dup
    //   160: invokespecial 98	bva:<init>	()V
    //   163: sipush 443
    ...
    //   263: astore_2
    //   264: aload_0
    //   265: getfield 31	buu:d	Landroid/os/Handler;
    //   268: aload_0
    //   269: getfield 31	buu:d	Landroid/os/Handler;
    //   272: iconst_1
    //   273: aload_2
    ...
    //   280: pop
    //   281: aload_3
    //   282: invokestatic 156	bze:a	(Ljava/io/Closeable;)V
    //   285: aload_1
    //   286: ifnull +14 -> 300
    //   289: aload_1
    //   290: invokeinterface 85 1 0
    //   295: invokeinterface 159 1 0
    //   300: invokestatic 164	buw:a	()Lbuw;
    //   303: aload_0
    //   304: invokevirtual 167	buw:b	(Lbuv;)V
    //   307: return
    ...
    //   334: pop
    //   335: aload_0
    //   336: getfield 35	buu:f	Lorg/apache/http/conn/ssl/SSLSocketFactory;
    ...
    //   349: new 178	bur
    //   352: dup
    //   353: invokespecial 179	bur:<init>	()V
    //   356: sipush 443
    ...
    //   452: ldc 95
    //   454: aload_0
    //   455: getfield 35	buu:f	Lorg/apache/http/conn/ssl/SSLSocketFactory;
    //   458: sipush 443
    ...
    //   476: astore_3
    //   477: aload_3
    //   478: invokestatic 156	bze:a	(Ljava/io/Closeable;)V
    //   481: aload_1
    //   482: ifnull +14 -> 496
    //   485: aload_1
    //   486: invokeinterface 85 1 0
    //   491: invokeinterface 159 1 0
    //   496: invokestatic 164	buw:a	()Lbuw;
    //   499: aload_0
    //   500: invokevirtual 167	buw:b	(Lbuv;)V
    //   503: aload_2
    //   504: athrow
    //   505: aload_2
    ...
    //   509: dup
    //   510: aload_0
    //   511: getfield 24	buu:b	Ljava/util/List;
    //   514: ldc -22
    ...
    //   582: goto -18 -> 564
    //   585: aload_0
    //   586: getfield 31	buu:d	Landroid/os/Handler;
    //   589: aload_0
    //   590: getfield 31	buu:d	Landroid/os/Handler;
    //   593: iconst_2
    //   594: aload_3
    ...
    //   604: pop
    //   605: aload_2
    //   606: invokestatic 156	bze:a	(Ljava/io/Closeable;)V
    //   609: aload_1
    //   610: invokeinterface 85 1 0
    //   615: invokeinterface 159 1 0
    //   620: invokestatic 164	buw:a	()Lbuw;
    //   623: aload_0
    //   624: invokevirtual 167	buw:b	(Lbuv;)V
    //   627: return
    //   628: astore_2
    //   629: aload 4
    //   631: astore_3
