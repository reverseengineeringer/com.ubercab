...
public final class btg
{
  ...
  static
  {
    if (!btg.class.desiredAssertionStatus()) {}
  ...
  public btg(btf parambtf, String paramString)
  {
    if ((!c) && (parambtf == null)) {
  ...
  public final bB a()
  {
    ...
    for (;;)
    {
      try
      {
        localObject1 = ce.a(buv.a(), (String)localObject1);
        String str = a.a(b + "loginEmail");
        localObject3 = a.a(b + "loginTypePrevious");
        if (!bwy.a((CharSequence)localObject3)) {
          break label145;
        }
        localObject3 = null;
        localObject3 = new bB(str, (ce)localObject1, (bti)localObject3);
      ...
      continue;
      label145:
      Object localObject3 = bti.valueOf((String)localObject3);
    }
  }
  ...
  public final bF a(String paramString)
  {
    ...
    for (int i = Integer.parseInt(str5);; i = 0)
    {
      ...
      for (int j = Integer.parseInt(str5);; j = 0)
      {
        ...
        if ((bwy.c(str5)) || (!str5.equals(paramString))) {
          paramString = null;
        }
        do
        {
  ...
  public final void a(bF parambF, String paramString)
  {
    ...
    if (parambF.c() != null) {}
    for (Object localObject1 = new bwf().format(parambF.c());; localObject1 = null)
    {
