public final class anz
{
  ...
  private anz(byte[] paramArrayOfByte, int paramInt)
  {
    a = paramArrayOfByte;
    b = 0;
    c = (paramInt + 0);
  ...
  public static anz a(byte[] paramArrayOfByte)
  {
    return a(paramArrayOfByte, paramArrayOfByte.length);
  }
  
  private static anz a(byte[] paramArrayOfByte, int paramInt)
  {
    return new anz(paramArrayOfByte, paramInt);
  }
