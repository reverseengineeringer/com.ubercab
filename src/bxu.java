...
public final class bxu
{
  ...
  public bxu(Context paramContext)
  {
    ...
    e.addView(localTableRow);
    bxa.a(localTableRow, -1, -2);
    g = new TextView(paramContext);
    g.setId(43023);
    localTableRow.addView(g);
    bxa.a(g, 3);
    bxa.a(g, "0dp");
    bxa.a(g, 3, 0.5F);
    bxa.a(g, "4dip", "5dip", "2dip", "5dip");
    j = new TextView(paramContext);
    j.setId(43024);
    localTableRow.addView(j);
    bxa.a(j, 5);
    bxa.a(j, "0dp");
    bxa.a(j, 5, 0.5F);
    bxa.a(j, "2dip", "5dip", "4dip", "5dip");
    localTableRow = new TableRow(paramContext);
    e.addView(localTableRow);
    bxa.a(localTableRow, -1, -2);
    f = new TextView(paramContext);
    f.setId(43027);
    localTableRow.addView(f);
    bxa.a(f, 1);
    bxa.a(f, "0dp");
    bxa.a(f, 1, 0.5F);
    bxa.a(f, "2dip", "5dip", "2dip", "5dip");
    k = new TextView(paramContext);
    k.setTextSize(16.0F);
    k.setTypeface(bwz.p);
    k.setGravity(51);
    k.setTextColor(bwz.g);
    localLinearLayout.addView(k);
    bxa.a(k, -2, -2);
    bxa.a(k, "6dip", "2dip", "6dip", "2dip");
    bxa.b(k, null, null, null, "10dip");
    o = new bxz(paramContext);
    bxa.b(o.a, null, null, null, "10dip");
    localLinearLayout.addView(o.a);
    l = new EditText(paramContext);
    l.setId(43025);
    l.setInputType(2);
    l.setTextColor(bwz.k);
    l.setTypeface(bwz.s);
    l.setSingleLine(true);
    l.setFilters(new InputFilter[] { new InputFilter.LengthFilter(6) });
    localLinearLayout.addView(l);
    bxa.a(l, -1, -2);
    bxa.b(l, null, null, null, "10dip");
    m = bxa.a(paramContext, true, 43026, localLinearLayout);
    n = new TextView(paramContext);
    bxa.a(n);
    n.setText("init");
    m.addView(n);
    c = new bxp(paramContext);
    q.addView(c.a);
    bxa.a(c.a, -2, -2);
    bxa.a(c.a, 17, 1.0F);
