...
public final class bxs
{
  ...
  private bxs(String paramString1, String paramString2, String paramString3, Double paramDouble, String paramString4, String paramString5)
  {
    a = paramString1;
    b = paramString2;
    c = paramString3;
  ...
  public static bxs a(JSONObject paramJSONObject)
  {
    ...
    if (paramJSONObject.optJSONObject("payment_card") != null)
    {
      ...
      if (localObject3 != null)
      {
        ...
        for (;;)
        {
          ...
          } else if (((String)localObject2).equals("MASTERCARD")) {
          ...
          } else if (((String)localObject2).equals("VISA")) {
    ...
    if (paramJSONObject.optJSONObject("credit") != null)
    {
      if (paramJSONObject.optJSONObject("credit") != null)
      {
        localObject1 = bxl.a(bxn.e);
        localObject2 = Double.valueOf(0.0D);
        localObject3 = paramJSONObject.optJSONObject("amount");
        if (localObject3 != null)
        {
          localObject2 = ((JSONObject)localObject3).getString("value");
          localObject1 = a((String)localObject2, ((JSONObject)localObject3).getString("currency"));
          localObject2 = Double.valueOf(Double.parseDouble((String)localObject2));
        }
        paramJSONObject = paramJSONObject.optString("funding_mode");
        return new bxs(bxl.a(bxn.az), "", (String)localObject1, (Double)localObject2, "", paramJSONObject);
      }
      return null;
    }
    return null;
  ...
  {
    bxb localbxb = bxb.a();
    return bwa.a(Locale.getDefault(), localbxb.c().a(), Double.parseDouble(paramString1), paramString2);
  }
