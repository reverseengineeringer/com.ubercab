...
public final class awn
{
  ...
  public awn(Context paramContext, String paramString) {}
  
  @SuppressLint({"UnwrappedWakeLock"})
  private awn(Context paramContext, String paramString1, String paramString2)
  {
    abs.a(paramString1, "Wake lock name can NOT be empty");
    f = 1;
    h = null;
    i = paramContext.getApplicationContext();
    if ((!aux.a(paramString2)) && ("com.google.android.gms" != paramString2))
    {
      g = (b + paramString1);
    ...
    {
      e = auy.a(paramContext, paramString1);
      a(e);
      return;
      g = paramString1;
      break;
  ...
  {
    if ((auy.a(i)) && (paramWorkSource != null))
    {
      if (e == null) {
        break label42;
      }
  ...
  private void e()
  {
    ...
    try
    {
      ...
      acp.a();
      acp.a(i, acn.a(d, str), 7, g, str, f, auy.a(e), 1000L);
      l += 1;
      label204:
      return;
    }
  ...
  private void f()
  {
    ...
    try
    {
      ...
      acp.a();
      acp.a(i, acn.a(d, str), g, str, f, auy.a(e));
      l -= 1;
      label195:
      return;
    }
