...
public abstract class ayi
  ...
  implements ayh
{
  public static ayh a(IBinder paramIBinder)
  {
    ...
    if ((localIInterface != null) && ((localIInterface instanceof ayh))) {
      return (ayh)localIInterface;
    }
    return new ayj(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    if (paramParcel1.readInt() != 0) {
      bam localbam = StreetViewPanoramaCamera.CREATOR;
    }
    for (paramParcel1 = bam.a(paramParcel1);; paramParcel1 = null)
    {
      a(paramParcel1);
