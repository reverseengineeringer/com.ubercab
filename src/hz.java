  ...
  implements SupportMenuItem
{
  ...
  hz(hv paramhv, int paramInt1, int paramInt2, int paramInt3, int paramInt4, CharSequence paramCharSequence, int paramInt5)
  {
    l = paramhv;
    a = paramInt2;
    b = paramInt1;
  ...
  public final CharSequence a(im paramim)
  {
    if ((paramim != null) && (paramim.b())) {
  ...
  {
    m = paramip;
    paramip.setHeaderTitle(getTitle());
  }
  ...
  public final Drawable getIcon()
  {
    ...
    if (k != 0)
    {
      Drawable localDrawable = jt.a().a(l.e(), k);
      k = 0;
      j = localDrawable;
  ...
  public final SupportMenuItem setSupportActionProvider(android.support.v4.view.ActionProvider paramActionProvider)
  {
    ...
    l.a(true);
    if (s != null) {
      s.setVisibilityListener(new hz.1(this));
    }
    return this;
  }
