  ...
  implements cav
{
  ...
  public cfz()
  {
    ...
    a.put(bxn.x, "Cheques");
    a.put(bxn.y, "Comprobando el dispositivo…");
    a.put(bxn.z, "Borrar los datos de la tarjeta");
    a.put(bxn.A, "Confirmar");
    a.put(bxn.B, "¿Seguro que desea borrar los datos de su tarjeta?");
    a.put(bxn.C, "Cargar en tarjeta");
    a.put(bxn.D, "¿Está seguro que desea cerrar la sesión de PayPal?");
    a.put(bxn.E, "Pagar");
    a.put(bxn.F, "Aceptar");
    a.put(bxn.G, "Fecha de apertura de la cuenta");
    a.put(bxn.H, "Estado de la cuenta");
    a.put(bxn.I, "Tipo de cuenta");
    a.put(bxn.J, "Dirección");
    a.put(bxn.K, "Rango de edad");
    a.put(bxn.L, "Fecha de nacimiento");
    a.put(bxn.M, "Dirección de correo electrónico");
    a.put(bxn.N, "Nombre completo");
    a.put(bxn.O, "Sexo");
    a.put(bxn.P, "Idioma");
    a.put(bxn.Q, "Configuración regional");
    a.put(bxn.R, "Teléfono");
    a.put(bxn.S, "Zona horaria");
    a.put(bxn.T, "Compartir lo siguiente: %s.");
    a.put(bxn.U, "Utilizar pago integrado");
    a.put(bxn.V, "%s le solicita que usted:");
    a.put(bxn.W, "Comparta las <a href='%1$s'>formas de pago</a> asociadas a su cuenta PayPal.");
    a.put(bxn.X, "Active la visualización de sus opciones de pago para que usted pueda elegir.");
    a.put(bxn.Y, "<a href='%1$s'>Autorizar cargos</a> correspondientes a futuras compras en %2$s pagadas con PayPal. Le instruye a PayPal de pagar todos los importes solicitados por %3$s.");
    a.put(bxn.Z, "Le permita agregar y administrar su tarjeta de lealtad en su cartera de PayPal.");
    a.put(bxn.aa, "Acepte la <a href='%2$s'>Política de privacidad</a> y las <a href='%3$s'>Condiciones de uso</a> de %1$s.");
    a.put(bxn.ab, "Le permita <a href='%1$s'>solicitar pagos</a> en su nombre hasta que usted retire dicho permiso.");
    a.put(bxn.ac, "Le permita <a href='%1$s'>enviar pagos</a> en su nombre hasta que usted retire dicho permiso.");
    a.put(bxn.ad, "Permiso");
    a.put(bxn.ae, "Correo electrónico");
    a.put(bxn.af, "Datos de prueba");
    a.put(bxn.ag, "Sandbox");
    a.put(bxn.ah, "Caduca");
    a.put(bxn.ai, "<h1><strong>Formas de pago</strong></h1><p>PayPal solo comparte las formas de pago que están disponibles para su utilización.</p>");
    a.put(bxn.aj, "¿Olvidó su contraseña?");
    a.put(bxn.ak, "De");
    a.put(bxn.al, "¿Cómo le gustaría respaldar sus pagos futuros %1$s?");
    a.put(bxn.am, "<h1><strong>Acuerdo de pago futuro</strong></h1><p>Su forma de pago predeterminada se utilizará para realizar futuros pagos con PayPal de este vendedor.</p><p>Para cancelar este acuerdo, inicie sesión en su cuenta PayPal, vaya a <strong>Perfil</strong> &gt; <strong>Mi configuración</strong> &gt; <strong>Iniciar sesión con PayPal</strong> y eliminar a este comercio de la lista.</p><p>Aplicará el artículo Pagos recurrentes de las <a href='%s'>Condiciones de uso de PayPal</a>.</p><p>Para asegurarse de que los pagos con tu cuenta PayPal funcionen correctamente, esta aplicación puede simular una pequeña transacción de prueba, pero no se transferirá dinero.</p>");
    a.put(bxn.an, "Error interno");
    a.put(bxn.ao, "<p>Al hacer clic en el botón a continuación, por el presente documento acepto los términos de las <a href='%1$s'>Condiciones de uso de PayPal</a> y declaro que cumplo las leyes y normas japonesas, incluidas las sanciones contra pagos a Corea del Norte e Irán de conformidad con la <a href='%2$s'>Ley de divisas y comercio exterior</a> para realizar la transacción.</p>");
    ...
    a.put(bxn.av, "Pagar después de la entrega");
    a.put(bxn.aw, "Pagar con");
    a.put(bxn.ax, "Pagar con tarjeta");
    a.put(bxn.ay, "Saldo de la cuenta PayPal");
    a.put(bxn.az, "PayPal Credit");
    a.put(bxn.aA, "Teléfono");
    a.put(bxn.aB, "NIP");
    a.put(bxn.aC, "Forma de pago preferida");
    a.put(bxn.aD, "PayPal protege su <a href='%s'>privacidad</a> e información financiera.");
    a.put(bxn.aE, "Proceso en curso");
    a.put(bxn.aF, "Recordar tarjeta");
    a.put(bxn.aG, "Solicitar pago");
    a.put(bxn.aH, "<h1><strong>%s</strong></h1><p>Todos los detalles relevantes de la transacción se compartirán con el comercio.</p><p>Para retirar el permiso, inicie sesión en paypal.com y luego vaya a las opciones <strong>Iniciar sesión con PayPal</strong> en la sección de configuración del <strong>Perfil</strong> y elimine a este comercio.</p><p>PayPal no se responsabiliza de ninguna acción o error cometido por el partner.</p>");
    a.put(bxn.aI, "Ahorros");
    a.put(bxn.aJ, "Enviar un pago");
    a.put(bxn.aK, "Se ha producido un problema en la comunicación con los servidores de PayPal. Inténtelo de nuevo.");
    a.put(bxn.aL, "Inicie sesión de nuevo en PayPal.");
    a.put(bxn.aM, "Sesión caducada");
    a.put(bxn.aN, "Dirección de envío");
    a.put(bxn.aO, "¿Nuevo usuario de PayPal? Registrarse");
    a.put(bxn.aP, "Mantener la sesión activa");
    a.put(bxn.aQ, "Error de sistema (%s). Inténtelo de nuevo más tarde.");
    a.put(bxn.aR, "Inténtelo de nuevo");
    a.put(bxn.aS, "No logra iniciar sesión, porque la autenticación de dos factores fue activada para su cuenta.");
    a.put(bxn.aT, "Código de seguridad");
    a.put(bxn.aU, "Envíe un mensaje de texto a su teléfono. El código de 6 dígitos que reciba será válido durante 5 minutos.");
    a.put(bxn.aV, "Enviando mensaje de texto");
    a.put(bxn.aW, "Ingrese el código de seguridad de 6 dígitos.");
    a.put(bxn.aX, "Su teléfono móvil");
    a.put(bxn.aY, "Enviar mensaje de texto");
    a.put(bxn.aZ, "Enviar mensaje de texto de nuevo");
    a.put(bxn.ba, "No es posible iniciar sesión porque se ha activado la autenticación de dos factores para la cuenta. Visite el sitio web de PayPal para activar su clave de seguridad.");
    a.put(bxn.bb, "No se permiten los pagos desde este dispositivo.");
    a.put(bxn.bc, "Dispositivo no autorizado");
    a.put(bxn.bd, "Los pagos a este comercio no se permiten (id. de cliente no válida).");
    a.put(bxn.be, "Comercio no válido");
    a.put(bxn.bf, "Hubo un problema al procesar su pago. Inténtelo de nuevo.");
    a.put(bxn.bg, "Origen no reconocido");
    a.put(bxn.bh, "Lo sentimos");
    a.put(bxn.bi, "Su pedido");
    a.put(bxn.bj, "¿Eliminar tarjeta?");
    a.put(bxn.bk, "Error en el permiso");
    a.put(bxn.bl, "Error de conexión");
    a.put(bxn.bm, "Error de inicio de sesión");
    a.put(bxn.bn, "Iniciar sesión con contraseña");
    a.put(bxn.bo, "Iniciar sesión con NIP");
    a.put(bxn.bp, "Un momento…");
    a.put(bxn.bq, "Error de pago");
    a.put(bxn.br, "Escanear");
    a.put(bxn.bs, "Código de seguridad incorrecto. Inténtelo de nuevo.");
    a.put(bxn.bt, "Vía");
    a.put(bxn.bu, "Error del sistema. Inténtelo de nuevo más tarde.");
