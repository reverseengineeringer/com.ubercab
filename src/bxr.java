  ...
  extends ArrayAdapter
{
  ...
  public bxr(Context paramContext, ArrayList paramArrayList, int paramInt)
  {
    super(paramContext, 0, paramArrayList);
    a = paramInt;
  }
  
  private static void a(Context paramContext, RelativeLayout paramRelativeLayout, bxq parambxq)
  {
    Object localObject2 = new LinearLayout(paramContext);
    ((LinearLayout)localObject2).setId(2304);
    int i = 2304;
    ((LinearLayout)localObject2).setOrientation(0);
    Object localObject1 = bxa.a(1, 2301);
    ...
    bxa.b((TextView)localObject1, 83);
    ((LinearLayout)localObject2).addView((View)localObject1);
    bxa.b((View)localObject1, "6dip", null, null, null);
    TextView localTextView1 = new TextView(paramContext);
    bxa.c(localTextView1, 83);
    ((LinearLayout)localObject2).addView(localTextView1);
    bxa.b(localTextView1, "6dip", null, "6dip", null);
    Object localObject3;
    if (parambxq.e())
    {
      ...
      i = 2306;
      bxa.c((TextView)localObject2);
      localObject3 = bxa.a(1, 2301);
      ...
      bxa.b((View)localObject2, "6dip", null, null, null);
      ((TextView)localObject2).setText(bxl.a(bxn.av));
    }
    localObject2 = parambxq.f().iterator();
    int k = 2400;
    int j = 2500;
    if (((Iterator)localObject2).hasNext())
    {
      localObject3 = (bxs)((Iterator)localObject2).next();
      TextView localTextView2 = new TextView(paramContext);
      localTextView2.setId(k);
      localTextView2.setText(((bxs)localObject3).a() + " " + ((bxs)localObject3).b());
      ...
      for (;;)
      {
        ...
        bxa.d(localTextView2);
        bxa.b(localTextView2, "6dip", null, null, null);
        localTextView2.setEllipsize(TextUtils.TruncateAt.END);
        localTextView2 = new TextView(paramContext);
        localTextView2.setId(j);
        localTextView2.setText(((bxs)localObject3).c());
        localObject3 = bxa.a(0, 2303);
        ...
        bxa.c(localTextView2, 85);
        bxa.b(localTextView2, "6dip", null, "6dip", null);
        k += 1;
        j += 1;
        break;
    ...
    ((TextView)localObject1).setText(parambxq.c());
    ((TextView)localObject1).setEllipsize(TextUtils.TruncateAt.END);
    localTextView1.setText(parambxq.d());
  ...
  {
    paramView = (bxq)getItem(paramInt);
    ...
    if (paramView.g())
    {
      ...
      bxa.b(paramViewGroup, "6dip", null, null, null);
      if (paramView.e())
      {
        ...
        paramInt = 2306;
        bxa.c((TextView)localObject2);
        localLayoutParams = bxa.a(1, 2301);
