...
final class chm
{
  ...
  static Map<Class<?>, chr> a(Object paramObject)
  {
    ...
    if (!((Map)localObject).isEmpty())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        chr localchr = new chr(paramObject, (Method)localEntry.getValue());
        localHashMap.put(localEntry.getKey(), localchr);
      }
    }
    return localHashMap;
  }
  ...
  private static void a(Class<?> paramClass)
  {
    ...
    if (i < j)
    {
      ...
      {
        if (!localMethod.isAnnotationPresent(chu.class)) {
          break label271;
        }
      ...
      for (;;)
      {
        ...
        break;
        label271:
        if (localMethod.isAnnotationPresent(cht.class))
        {
          localObject1 = localMethod.getParameterTypes();
  ...
  static Map<Class<?>, Set<chq>> b(Object paramObject)
  {
    Object localObject = paramObject.getClass();
    HashMap localHashMap = new HashMap();
    ...
    if (!((Map)localObject).isEmpty())
    {
      ...
      while (((Iterator)localObject).hasNext())
      {
        ...
        while (localIterator.hasNext()) {
          localHashSet.add(new chq(paramObject, (Method)localIterator.next()));
        }
