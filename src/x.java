...
final class x
{
  ...
  private static long a(RandomAccessFile paramRandomAccessFile, y paramy)
  {
    ...
    paramy = new byte['䀀'];
    for (i = paramRandomAccessFile.read(paramy, 0, i); i != -1; i = paramRandomAccessFile.read(paramy, 0, (int)Math.min(16384L, l)))
    {
      localCRC32.update(paramy, 0, i);
      l -= i;
      if (l == 0L) {
        break;
      }
  ...
  private static y a(RandomAccessFile paramRandomAccessFile)
  {
    long l1 = 0L;
