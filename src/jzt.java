...
{
  private static final int a = jzd.ub__uber_blue_100;
  private final int b;
  ...
  public jzt(Context paramContext)
  {
    this(paramContext, (byte)0);
  }
  
  private jzt(Context paramContext, byte paramByte)
  {
  ...
  protected final void onDraw(Canvas paramCanvas)
  {
    ...
    if (h != null)
    {
      ...
      if (j > 0)
      {
        ...
        k = ((jzs)localObject).a(f);
        if ((g <= 0.0F) || (f >= getChildCount() - 1)) {
          break label275;
        }
        int i2 = ((jzs)localObject).a(f + 1);
        j = k;
        if (k != i2) {
          j = a(i2, k, g);
        }
