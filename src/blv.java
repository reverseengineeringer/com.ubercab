...
public abstract class blv
  ...
  implements blu
{
  public static blu a(IBinder paramIBinder)
  {
    if (paramIBinder == null) {
      return null;
    }
    IInterface localIInterface = paramIBinder.queryLocalInterface("com.google.android.gms.plus.internal.IPlusCallbacks");
    if ((localIInterface != null) && ((localIInterface instanceof blu))) {
      return (blu)localIInterface;
    }
    return new blw(paramIBinder);
  }
  ...
  public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
  {
    ...
    case 4: 
      ...
      if (paramParcel1.readInt() != 0)
      {
        ...
        localObject1 = zd.a(paramParcel1);
      }
    ...
    case 5: 
      ...
      for (localObject1 = (Bundle)Bundle.CREATOR.createFromParcel(paramParcel1);; localObject1 = null)
      {
        if (paramParcel1.readInt() != 0)
        {
          ...
          localObject2 = acd.a(paramParcel1);
        }
    ...
    case 9: 
      ...
      if (paramParcel1.readInt() != 0)
      {
        ...
        localObject1 = blk.a(paramParcel1);
      }
