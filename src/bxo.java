...
public final class bxo
{
  ...
  public bxo(Context paramContext)
  {
    ...
    while (m < 10)
    {
      ...
      localTextView.setTextColor(bwz.k);
      localTextView.setLinkTextColor(bwz.t);
      localTextView.setTypeface(bwz.s);
      localTextView.setTextSize(18.0F);
      localTextView.setSingleLine(false);
      localTextView.setMovementMethod(LinkMovementMethod.getInstance());
      localLinearLayout.addView(localTextView);
      bxa.a(localTextView, -1, -2);
      bxa.a(localTextView, null, "10dip");
    ...
    bxa.a(e, -1, -2);
    bxa.b(e, null, "20dip", null, "10dip");
    e.setVisibility(8);
    h = bxa.a(paramContext, true, 1, localLinearLayout);
    ...
    bxa.b(g, null, null, null, "16dip");
    bxa.a(g, -2, -2);
    bxa.a(g, 17, 1.0F);
    g.setNextFocusLeftId(1);
    f = new bxp(paramContext);
    k.addView(f.a);
    bxa.a(f.a, -2, -2);
    bxa.a(f.a, 17, 1.0F);
    a = j;
