...
public final class agp
{
  ...
  {
    long l = (agn.a(paramArrayOfString[0]) + 2147483647L) % 1073807359L;
    int i = 1;
    while (i < paramInt + 0)
    {
      l = (l * 16785407L % 1073807359L + (agn.a(paramArrayOfString[i]) + 2147483647L) % 1073807359L) % 1073807359L;
      i += 1;
    }
    return l;
  }
  ...
  private static String a(String[] paramArrayOfString, int paramInt1, int paramInt2)
  {
    ...
    {
      aqt.b("Unable to construct shingle");
      return "";
    }
  ...
  private static void a(int paramInt1, long paramLong, String paramString, int paramInt2, PriorityQueue<agq> paramPriorityQueue)
  {
    paramString = new agq(paramLong, paramString, paramInt2);
  ...
  public static void a(String[] paramArrayOfString, int paramInt1, int paramInt2, PriorityQueue<agq> paramPriorityQueue)
  {
    ...
    for (;;)
    {
      ...
      {
        l1 = a(agn.a(paramArrayOfString[(i - 1)]), agn.a(paramArrayOfString[(i + paramInt2 - 1)]), l1, l2);
