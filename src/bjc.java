  ...
  extends bkr
{
  ...
  private static void a(StringBuilder paramStringBuilder, avy paramavy)
  {
    if (paramavy == null) {
      return;
    }
  ...
  private static void a(StringBuilder paramStringBuilder, String paramString, avz paramavz)
  {
    int k = 0;
    if (paramavz == null) {
      return;
  ...
  private static void a(StringBuilder paramStringBuilder, avu[] paramArrayOfavu)
  {
    if (paramArrayOfavu == null) {}
    for (;;)
    {
      return;
      int j = paramArrayOfavu.length;
      int i = 0;
      while (i < j)
      {
        avu localavu = paramArrayOfavu[i];
        if (localavu != null)
        {
  ...
  private static void a(StringBuilder paramStringBuilder, avv[] paramArrayOfavv)
  {
    if (paramArrayOfavv == null) {}
    for (;;)
    {
      return;
      int j = paramArrayOfavv.length;
      int i = 0;
      while (i < j)
      {
        avv localavv = paramArrayOfavv[i];
        if (localavv != null)
        {
          a(paramStringBuilder, 2);
  ...
  private static void a(StringBuilder paramStringBuilder, avw[] paramArrayOfavw)
  {
    if (paramArrayOfavw == null) {}
    for (;;)
    {
      return;
      int j = paramArrayOfavw.length;
      int i = 0;
      while (i < j)
      {
        avw localavw = paramArrayOfavw[i];
        if (localavw != null)
        {
          a(paramStringBuilder, 3);
          paramStringBuilder.append("event {\n");
  ...
  private static void a(StringBuilder paramStringBuilder, awa[] paramArrayOfawa)
  {
    if (paramArrayOfawa == null) {}
    for (;;)
    {
      return;
      int j = paramArrayOfawa.length;
      int i = 0;
      while (i < j)
      {
        awa localawa = paramArrayOfawa[i];
        if (localawa != null)
        {
          a(paramStringBuilder, 2);
  ...
  public static String b(avx paramavx)
  {
    ...
    {
      paramavx = a;
      int j = paramavx.length;
      int i = 0;
      while (i < j)
      {
        avy localavy = paramavx[i];
        if (localavy != null) {
          a(localStringBuilder, localavy);
        }
        i += 1;
      }
    }
  ...
  {
    a("user attribute", bjf.v(), paramString);
  }
  
  public static void d(String paramString)
  {
    a("event param", bjf.v(), paramString);
  }
  ...
  public final void a(avw paramavw, Object paramObject)
  {
    abs.a(paramObject);
    b = null;
    c = null;
  ...
  public final void a(awa paramawa, Object paramObject)
  {
    abs.a(paramObject);
    c = null;
    d = null;
  ...
  public final byte[] a(avx paramavx)
  {
    try
    {
      byte[] arrayOfByte = new byte[paramavx.d()];
      axi localaxi = axi.a(arrayOfByte);
      paramavx.a(localaxi);
      localaxi.a();
      return arrayOfByte;
    }
    ...
    {
      s().b().a("Data loss. Failed to serialize batch", paramavx);
    }
    return null;
  }
