...
public final class bmy
{
  ...
  {
    return new bna(paramType1, paramType2, paramVarArgs);
  }
  ...
  public static Type a(Type paramType)
  {
    if ((paramType instanceof Class))
    {
      ...
      if (paramType.isArray()) {
        paramType = new bmz(a(paramType.getComponentType()));
      }
      for (;;)
      {
    ...
    if ((paramType instanceof ParameterizedType))
    {
      ...
      return new bna(paramType.getOwnerType(), paramType.getRawType(), paramType.getActualTypeArguments());
    }
    if ((paramType instanceof GenericArrayType)) {
      return new bmz(((GenericArrayType)paramType).getGenericComponentType());
    }
    if ((paramType instanceof WildcardType))
    {
      paramType = (WildcardType)paramType;
      return new bnb(paramType.getUpperBounds(), paramType.getLowerBounds());
    }
    return paramType;
  }
  ...
  public static Class<?> b(Type paramType)
  {
    ...
    if ((paramType instanceof ParameterizedType))
    {
      ...
      bmx.a(paramType instanceof Class);
      return (Class)paramType;
    }
    if ((paramType instanceof GenericArrayType)) {
  ...
  {
    bmx.a(paramClass2.isAssignableFrom(paramClass1));
  ...
  {
    return new bmz(paramType);
  }
  
  private static WildcardType g(Type paramType)
  {
    Type[] arrayOfType = a;
    return new bnb(new Type[] { paramType }, arrayOfType);
  }
  
  private static WildcardType h(Type paramType)
  {
    return new bnb(new Type[] { Object.class }, new Type[] { paramType });
  }
